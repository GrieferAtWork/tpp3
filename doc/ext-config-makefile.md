...
The following configuration options are available and can be used to customize the behavior of a makefile.
...
Provide an API [`tpp_makefile_setoutput_io()`](../src/tpp-makefile-amalgamation.h#L717) that can be used to override
...
Provide an API [`tpp_makefile_setoutput_io_ex()`](../src/tpp-makefile-amalgamation.h#L747) that can also be used to
...
Provide an API [`tpp_makefile_setoutput_file()`](../src/tpp-makefile-amalgamation.h#L779) that is a concenience
wrapper around [`tpp_makefile_setoutput_io()`](../src/tpp-makefile-amalgamation.h#L717) by automatically opening
...
argument passed to [`tpp_makefile_cli_loader_flush()`](../src/tpp-makefile-amalgamation.h#L1135) or `__BASE_FILE__`:
