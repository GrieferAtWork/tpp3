...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L17262)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L17266)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18473) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18478) (fail
immediately)
...
**Getter**: [`tpp_lexer_geterrorlimit(lexer)`](../src/tpp-amalgamation.h#L19924)<br/>
**Setter**: [`tpp_lexer_seterrorlimit(lexer, v)`](../src/tpp-amalgamation.h#L19925)
...
appear on the `#include`-stack before a warning [`TPP_W_INCLUDE_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L3953)
...
**Getter**: [`tpp_lexer_getinclusionlimit(lexer)`](../src/tpp-amalgamation.h#L19946)<br/>
**Setter**: [`tpp_lexer_setinclusionlimit(lexer, v)`](../src/tpp-amalgamation.h#L19947)
...
that this limit is reached, a warning [`TPP_W_MACRO_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L3959)
will be emitted.
...
**Getter**: [`tpp_lexer_getrecursivemacrolimit(lexer)`](../src/tpp-amalgamation.h#L19962)<br/>
**Setter**: [`tpp_lexer_setrecursivemacrolimit(lexer, v)`](../src/tpp-amalgamation.h#L19963)
