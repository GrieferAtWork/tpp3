...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L20016)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L20020)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21346) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21351) (fail
immediately)
...
appear on the `#include`-stack before a warning [`TPP_W_INCLUDE_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L4885)
...
that this limit is reached, a warning [`TPP_W_MACRO_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L4891)
will be emitted.
