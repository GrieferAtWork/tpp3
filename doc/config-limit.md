...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L16051)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L16055)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17204) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17209) (fail
immediately)
...
**Getter**: [`tpp_lexer_geterrorlimit(lexer)`](../src/tpp-amalgamation.h#L18649)<br/>
**Setter**: [`tpp_lexer_seterrorlimit(lexer, v)`](../src/tpp-amalgamation.h#L18650)
...
appear on the `#include`-stack before a warning [`TPP_W_INCLUDE_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L3778)
...
**Getter**: [`tpp_lexer_getinclusionlimit(lexer)`](../src/tpp-amalgamation.h#L18671)<br/>
**Setter**: [`tpp_lexer_setinclusionlimit(lexer, v)`](../src/tpp-amalgamation.h#L18672)
...
that this limit is reached, a warning [`TPP_W_MACRO_RECURSION_LIMIT_EXCEEDED`](../src/tpp-amalgamation.h#L3784)
will be emitted.
...
**Getter**: [`tpp_lexer_getrecursivemacrolimit(lexer)`](../src/tpp-amalgamation.h#L18687)<br/>
**Setter**: [`tpp_lexer_setrecursivemacrolimit(lexer, v)`](../src/tpp-amalgamation.h#L18688)
