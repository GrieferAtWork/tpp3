...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L20369)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L20373)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21712) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21717) (fail
immediately)
...
**Getter**: [`tpp_lexer_geterrorlimit(lexer)`](../src/tpp-amalgamation.h#L23590)<br/>
**Setter**: [`tpp_lexer_seterrorlimit(lexer, v)`](../src/tpp-amalgamation.h#L23591)
...
**Getter**: [`tpp_lexer_getinclusionlimit(lexer)`](../src/tpp-amalgamation.h#L23612)<br/>
**Setter**: [`tpp_lexer_setinclusionlimit(lexer, v)`](../src/tpp-amalgamation.h#L23613)
...
**Getter**: [`tpp_lexer_getrecursivemacrolimit(lexer)`](../src/tpp-amalgamation.h#L23628)<br/>
**Setter**: [`tpp_lexer_setrecursivemacrolimit(lexer, v)`](../src/tpp-amalgamation.h#L23629)
