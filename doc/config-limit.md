...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L22636)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L22642)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24158) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24163) (fail
immediately)
