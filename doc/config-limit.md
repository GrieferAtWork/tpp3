...
**Getter**: [`tpp_gettabsize()`](../src/tpp-amalgamation.h#L22490)<br/>
**Setter**: [`tpp_settabsize(v)`](../src/tpp-amalgamation.h#L22496)
...
Max # of [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24012) (continue compilation and fail later) warnings that
can be emitted before the next one will be treated as [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24017) (fail
immediately)
...
**Getter**: [`tpp_lexer_geterrorlimit(lexer)`](../src/tpp-amalgamation.h#L27218)<br/>
**Setter**: [`tpp_lexer_seterrorlimit(lexer, v)`](../src/tpp-amalgamation.h#L27219)
...
**Getter**: [`tpp_lexer_getinclusionlimit(lexer)`](../src/tpp-amalgamation.h#L27249)<br/>
**Setter**: [`tpp_lexer_setinclusionlimit(lexer, v)`](../src/tpp-amalgamation.h#L27250)
...
**Getter**: [`tpp_lexer_getrecursivemacrolimit(lexer)`](../src/tpp-amalgamation.h#L27269)<br/>
**Setter**: [`tpp_lexer_setrecursivemacrolimit(lexer, v)`](../src/tpp-amalgamation.h#L27270)
