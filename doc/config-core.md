...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L17039) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L21940) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11178) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12325))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4790)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11249) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L13843) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L18695)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L18701)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L18687) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L11686), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L18609).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6050)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6049)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L19313) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L19319)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L19213) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L19218) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L19222)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L19227)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L17042)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L17045)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L17789) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L21202) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L20677)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22513)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4338)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L11666), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L11612) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L11612)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11633) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L11633) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11633):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L22096)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L22024)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21990) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21500)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L17836)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L18609) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18990) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L18609) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L22423)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22513)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L22552)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L22568)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22592)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L22523)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22592) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20762)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20763)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L11558)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17051)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16991)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16997), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L17054)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19686) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19686) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17051)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19686) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L11686) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22270) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L22261) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22270), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L17146) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L17088) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L17324))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L17852)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L17865)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L22188) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L17923)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L17013) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L21591) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17878) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17888) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17878),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11930).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11958).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L21512), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21500) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L21265) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L21263)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L21277), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L21313)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L11745) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L11686)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L11784)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L22118) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L22132)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L20609)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L22170), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L22143)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22816) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L13852) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22816) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L20590) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L21915) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L22321) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22337) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22337) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
for keywords where this property hasn't been explicitly defined by [`TPP_KWD_IS_IDENTIFIER()`](../src/tpp-amalgamation.h#L235),
and also don't have macro expansions as per [`tpp_macro_getbuiltin()`](../src/tpp-amalgamation.h#L18269).
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L21876)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L21878)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L21879)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L21882)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L21883)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L21884)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L21888)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21891)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L21894)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L18197) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4751) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12248) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L22827) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L22863) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L22868) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13928) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L21718) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22513) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L21605) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L22387) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12042)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L22376) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L22414) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12042)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L22403) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L22610) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L22632) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12042)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L22660) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12042)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L11542) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L19180) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L19282) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L11574) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L21527) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L21535)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L21551) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L21560) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L21567)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L19030) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L21541)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L19041) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L21573)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L19052) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L20937)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L19064) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L20943) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L21482)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L18330) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L18344) that can be used to easily skip an arbitrary
