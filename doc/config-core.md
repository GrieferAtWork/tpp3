...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19464) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25645) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12672) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14648))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12758) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16163) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21210)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21231)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21203) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13195), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21119).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21937) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21943)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21836) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21841) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21845)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21850)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19467)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19470)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20267) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24893) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24097)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21119) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25857)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25873)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25785)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25751) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25014)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20314)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21119) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21603) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21119) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26238)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26328)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26367)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26383)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26407)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26338)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26407) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26328)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13175), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13121) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13121)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13142) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13142) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13142):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19399)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19405), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24181)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24182)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13067)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19476)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19479)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22315) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22315) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19476)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22315) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13195) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26047) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26038) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26047), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19571) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19513) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19750))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20341)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20355)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25965) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20413)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19421) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25296) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20368) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20378) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20368),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13451).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13500).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25217), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25014) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L25081) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25079)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25093), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25134)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13266) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13195)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13305)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25897) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25911)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24029)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25944), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25920)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26612) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16172) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26612) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24010) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25620) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26120) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26144) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26160) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26160) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25581)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25583)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25584)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25587)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25588)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25589)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25593)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25596)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25599)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20680) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20613) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21119) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13790) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26623) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26664) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26669) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16248) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25423) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26328) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25310) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26202) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13584)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25718) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26191) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26229) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13584)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26218) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26425) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26444) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13584)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26466) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13584)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13051) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21803) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21905) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13083) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25232) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25240)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25256) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25265) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25272)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21643) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25246)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21654) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25278)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21665) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24358)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21676) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24363)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21687) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24369) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24996)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20789) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20803) that can be used to easily skip an arbitrary
