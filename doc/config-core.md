...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20290) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27785) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13371) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15424))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13457) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16939) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22154)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22175)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22146) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13894), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22060).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22924) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22930)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22823) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22828) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22832)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22837)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20293)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20296)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21095) by caching the last-read
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26035)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22060) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27997)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28013)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27925)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27891) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27152)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21142)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22060) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22587) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22060) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28385)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28475)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28514)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28530)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28554)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28485)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28554) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28475)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13871), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13798) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13798)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13830) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13830) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13830):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20188)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20194), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26119)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26120)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13768)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14277)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20302)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20305)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23305) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11634).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23305) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23305) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20302)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23305) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13894) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28187) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28178) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28187), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20397) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20339) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20576))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21169)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21183)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28105) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21241)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20210) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27436) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21196) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21206) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21196),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14191).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14240).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14256) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L27340), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27152) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13969) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13894)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14008)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28037) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28051)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25961)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28084), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28060)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28765) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16948) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28765) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25942) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27760) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28260) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28284) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28300) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28300) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27721)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27723)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27724)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27727)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27728)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27729)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27733)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27736)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27739)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21512) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21444) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22060) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14565) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28776) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28817) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28822) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17024) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27563) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28475) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27450) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28346) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14360)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27858) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28331) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28375) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14360)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28363) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28572) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28591) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14360)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28613) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14360)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13752) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22790) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22892) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22627) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27385)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22638) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27418)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22649) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26304)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22660) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26309)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22671) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26315) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27134)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21621) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21635) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13813) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13842) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13884) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13785) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27207), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27232) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27234)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14089) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27248) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27260) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27036) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27285) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27297)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27299)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27302)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27366) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27378)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27396) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27405) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27412)
