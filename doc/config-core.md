...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14876) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19612) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9443)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10394))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9514) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11859) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16425) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9764)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17069) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17075)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16969) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16974) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16978)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16983)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14879)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14882)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15614) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18889) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18381)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19768)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19696)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19662) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19183)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19165)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15661)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16347) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16746) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16347) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9740)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14888)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14828)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14834), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14891)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17436) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17436) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14888)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17436) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9764) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14983) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14925) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15151))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15677)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15690)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19860) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15748)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14850) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15703) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15713) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15703),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9999).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10027).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19195), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19183) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18950) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18948)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18962), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18998)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L9822) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L9764)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L9858)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19790) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19804)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18313)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19842), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19815)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20466) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11868) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20466) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18294) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19587) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19993) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19548)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19550)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19551)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19554)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19555)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19556)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19560)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19563)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19566)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19942) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19933) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19942), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16018) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20160) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20172)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20242) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10317) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11944) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11953) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20061) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10111)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20049) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20137) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10111)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20125) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20259) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20282) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10111)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20310) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10111)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9724) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16936)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17038)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9756) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19210) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19218)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19234) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19243) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19250)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16786) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19224)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16797) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19256)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16808) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18641)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16820) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18647) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20477) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20508) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20513) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18466)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18467)
