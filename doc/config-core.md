...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19326) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L24931) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12546) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14509))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12619) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16027) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L20994)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21011)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L20987) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13056), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20903).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21716) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21722)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21615) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21620) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21624)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21629)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19329)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19332)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20072) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24179) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23506)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20903) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25143)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25159)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25071)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25037) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24300)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20119)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20903) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21382) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20903) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25526)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25616)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25655)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25671)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25695)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25626)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25695) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25616)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13036), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L12982) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L12982)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13003) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13003) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13003):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19263)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19269), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23590)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23591)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12928)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19338)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19341)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22094) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22094) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19338)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22094) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13056) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25335) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25326) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25335), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19433) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19375) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19611))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20135)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20148)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25253) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20206)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19285) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24582) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20161) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20171) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20161),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13312).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13361).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24503), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24300) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24367) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24365)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24379), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24420)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13127) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13056)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13166)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25183) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25197)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23438)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25232), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25208)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25907) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16036) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25907) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23419) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24906) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25408) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25432) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25448) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25448) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24867)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24869)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24870)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24873)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24874)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24875)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24879)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24882)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24885)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20467) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13651) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L25918) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L25959) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L25964) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16112) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24709) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25616) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24596) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25490) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13445)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25004) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25479) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25517) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13445)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25506) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25713) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25732) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13445)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25754) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13445)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12912) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21582) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21684) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12944) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24518) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24526)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24542) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24551) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24558)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21422) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24532)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21433) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24564)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21444) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23767)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21455) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23772)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21466) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23778) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24282)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20573) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20587) that can be used to easily skip an arbitrary
