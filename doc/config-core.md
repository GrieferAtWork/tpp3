...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16148) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L21049) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10362) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11434))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4034)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L10433) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12952) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17804)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17810)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17796) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10795), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17718).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L5293)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L5292)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18422) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18428)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18322) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18327) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18331)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18336)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16151)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16154)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16898) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20311) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19786)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21598)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10775), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10721) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10721)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10742) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10742) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10742):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21205)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21133)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21099) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20609)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16945)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17718) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18099) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17718) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21508)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21598)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21637)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21653)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21677)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21608)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21677) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19871)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19872)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10667)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16160)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16100)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16106), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16163)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18795) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18795) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16160)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18795) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10795) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21379) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21370) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21379), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16255) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16197) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16433))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16961)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16974)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21297) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L17032)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16122) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20700) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16987) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16997) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16987),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11039).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11067).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20621), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20609) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20374) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20372)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20386), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20422)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10854) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10795)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10893)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21227) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21241)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19718)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21279), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21252)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21901) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12961) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21901) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19699) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L21024) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21430) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20985)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20987)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20988)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20991)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20992)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20993)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20997)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21000)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L21003)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17306) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L3995) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11357) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21912) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21948) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21953) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13037) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20827) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21598) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20714) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21472) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11151)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21461) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21499) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11151)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21488) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21695) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21717) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11151)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21745) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11151)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10651) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18289) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18391) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10683) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20636) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20644)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20660) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20669) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20676)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18139) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20650)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18150) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20682)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18161) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L20046)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18173) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L20052) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20591)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L17439) that can be used to easily skip an arbitrary
