...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20595) & friends can be used to force calls to become
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17968) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17974)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17868) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17873) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17877)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17882)
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19857) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19332)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21144)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20751)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20679)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20645) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20155)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20137)
...
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17645) is used to give
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18341) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18341) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15747)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18341) contains a 4th path-list that is searched after all other paths
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20843) used during macro invocation,
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20167), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20155) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19920) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19918)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19932), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L19968)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20773) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20787)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19264)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20825), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20798)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21447) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21447) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19245) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20570) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L20976) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20531)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20533)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20534)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20537)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20538)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20539)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20543)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20546)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20549)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20925) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20916) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20925), but is also able to deal with
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21144) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21154)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21223) to speed up decoding of certain kinds
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20260) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21018) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10738)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21007) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21045) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10738)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21034) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21240) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21263) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10738)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21291) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10738)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17835)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17937)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20182) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20190)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20206) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20215) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20222)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17685) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20196)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17696) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20228)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17707) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19592)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17719) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19598) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21458) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21489) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21494) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19417)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19418)
