...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L15476) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20319) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9766)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10787))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9837) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12305) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17036) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10157)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17703) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17709)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17603) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17608) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17612)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17617)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L15479)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L15482)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16216) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19592) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19067)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20868)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L3606)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10119), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10142) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10142)
will return `0x00C0`.
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20475)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20403)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20369) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19890)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19872)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16263)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16958) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17380) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16958) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10069)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15488)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L15428)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L15434), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L15491)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18076) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18076) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15488)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18076) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10157) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L15583) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15525) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15751))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16279)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16292)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20567) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16350)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L15450) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16305) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16315) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16305),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10392).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10420).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19902), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19890) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19655) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19653)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19667), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L19703)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10215) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L10157)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10251)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20497) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20511)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18999)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20549), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20522)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21171) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12314) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21171) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18980) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20294) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L20700) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20255)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20257)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20258)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20261)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20262)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20263)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20267)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20270)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20273)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20649) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20640) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20649), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16624) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L3938) if exactly
that happened.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20868) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20878)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20947) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10710) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12390) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L12399) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20742) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10504)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20731) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20769) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10504)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20758) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20964) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20987) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10504)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21015) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10504)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10053) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17570)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17672)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10085) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19917) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19925)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19941) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19950) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19957)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17420) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19931)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17431) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19963)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17442) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19327)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17454) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19333) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21182) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21213) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21218) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19152)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19153)
