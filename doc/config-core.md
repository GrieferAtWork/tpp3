...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19355) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25028) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12573) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14536))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12646) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16054) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21086)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21107)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21079) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13083), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20995).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6292)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6291)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21813) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21819)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21712) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21717) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21721)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21726)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19358)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19361)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20143) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24276) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23603)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20995) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6290)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25240)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25256)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25168)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25134) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24397)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20190)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20995) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21479) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20995) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25623)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25713)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25752)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25768)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25792)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25723)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25792) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25713)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13063), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13009) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13009)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13030) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13030) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13030):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19290)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19296), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23687)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23688)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12955)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19367)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19370)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22191) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22191) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19367)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22191) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13083) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25432) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25423) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25432), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19462) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19404) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19641))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20217)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20231)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25350) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20289)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19312) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24679) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20244) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20254) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20244),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13339).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13388).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24600), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24397) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24464) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24462)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24476), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24517)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13154) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13083)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13193)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25280) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25294)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23535)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25329), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25305)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26004) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16063) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26004) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23516) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25003) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25505) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25529) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25545) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25545) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24964)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24966)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24967)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24970)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24971)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24972)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24976)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24979)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24982)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20556) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20489) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L20995) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13678) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26015) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26056) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26061) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16139) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24806) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25713) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24693) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25587) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13472)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25101) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25576) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25614) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13472)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25603) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25810) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25829) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13472)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25851) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13472)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12939) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21679) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21781) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12971) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24615) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24623)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24639) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24648) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24655)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21519) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24629)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21530) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24661)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21541) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23864)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21552) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23869)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21563) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23875) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24379)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20665) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20679) that can be used to easily skip an arbitrary
