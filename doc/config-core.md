...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20633) & friends can be used to force calls to become
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17333) that allows
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18006) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18012)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17906) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17911) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17915)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17920)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16513) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19895) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19370)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21182)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20789)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20717)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20683) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20193)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20175)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16560)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17255) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17683) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17255) structure). This is also needed
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18379) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18379) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15775)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18379) contains a 4th path-list that is searched after all other paths
...
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15812) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16048))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16576)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16589)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20881) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16647)'s `tlcix_proj*` return values,
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16602) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16612) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16602),
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20205), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20193) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19958) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19956)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19970), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20006)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20811) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20825)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19302)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20863), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20836)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21485) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21485) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19283) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20608) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21014) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20569)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20571)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20572)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20575)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20576)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20577)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20581)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20584)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20587)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20963) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20954) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20963), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16921) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21182) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21192)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21261) to speed up decoding of certain kinds
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20298) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21056) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10766)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21045) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21083) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10766)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21072) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21278) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21301) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10766)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21329) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10766)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17873)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17975)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20220) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20228)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20244) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20253) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20260)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17723) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20234)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17734) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20266)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17745) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19630)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17757) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19636) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21496) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21527) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21532) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19455)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19456)
