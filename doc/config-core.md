...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L21421) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29282) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13925) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L16438))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5133)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L14011) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17974) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L23475)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L23496)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L23467) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14472), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L23376).
...
```c
(TPP_PROFILE == TPP_PROFILE_ALL) && TPP_REFCNT_ATOMIC_IS_ATOMIC
```
</details>
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6867)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6866)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L24259) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L24265)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24158) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24163) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L24167)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L24172)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L21430)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L21441)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L22380) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27843) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L27382)
...
## TPP_HAVE_LEXER_USERPWD

Extension to [`TPP_HAVE_CPP_DIGIT_LINE`](config-conf.md#tpp_have_cpp_digit_line): if the filename being assigned ends with 2
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L27494)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L27504), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L27499)
...
```c
TPP_HAVE_CPP_DIGIT_LINE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)
```
</details>

## TPP_HAVE_KEYWORD_FEATURE_HAS_ATTRIBUTE

Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L23376) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6865)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29494)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29510)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29422)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29388) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27967)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L22451)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L23376) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23911) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L23376) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29914)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L30030)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L30069)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L30085)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30109)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L30040)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30109) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L30030)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4649)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14425), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L14352) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L14352)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14384) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L14384) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14384):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L21317)
...
```c
TPP_HAVE_CPP_MACROS || TPP_HAVE_CPP_EMBED || TPP_HAVE_MACRO__Pragma || TPP_HAVE_MACRO___pragma || TPP_HAVE_MACRO___TPP_IDENTIFIER || TPP_HAVE_MACRO___TPP_STR_DECOMPILE || TPP_HAVE_MACRO___TPP_STR_PACK || TPP_HAVE_MACRO___TPP_COUNT_TOKENS || TPP_HAVE_PRAGMA_TPP_EXEC || TPP_HAVE_PRAGMA_TPP_TPP_EXEC || TPP_HAVE_STRING_FORMAT
```
</details>

## TPP_HAVE_FILE_DUMMY

Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L21323), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L27481)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L27482)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L14322)
...
When enabled, environment variables specified by [`TPP_CONFIG_TIME_ENVIRON`](config-value.md#tpp_config_time_environ) are
first scanned (in the order they are specified by [`TPP_CONFIG_TIME_ENVIRON`](config-value.md#tpp_config_time_environ),
stopping once some non-empty environment variable is encountered).

Only when none of the variables specified by [`TPP_CONFIG_TIME_ENVIRON`](config-value.md#tpp_config_time_environ) are
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14863)) be queried and
...
```c
TPP_HAVE_TIME_API && TPP_COMMON_HAVE_ENVIRON
```
</details>

## TPP_HAVE_FILE_SYSHDR

Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21458)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21467)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L24640) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L12046).
...
```c
TPP_HAVE_INCLUDE_STACK && TPP_COMMON_HAVE_ENVIRON
```
</details>

## TPP_HAVE_INCLUDE_PATH_QUOTE

[`tpp_include_paths`](../src/tpp-amalgamation.h#L24640) contains a 2nd path-list that is only searched during `"`-strings
...
```c
TPP_HAVE_INCLUDE_PATH && (TPP_PROFILE != TPP_PROFILE_MINIMAL)
```
</details>

## TPP_HAVE_INCLUDE_PATH_SYSHDR

[`tpp_include_paths`](../src/tpp-amalgamation.h#L24640) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21458)
...
```c
TPP_HAVE_INCLUDE_PATH && TPP_HAVE_FILE_SYSHDR && (TPP_PROFILE != TPP_PROFILE_MINIMAL)
```
</details>

## TPP_HAVE_INCLUDE_PATH_AFTER

[`tpp_include_paths`](../src/tpp-amalgamation.h#L24640) contains a 4th path-list that is searched after all other paths
...
```c
TPP_HAVE_INCLUDE_PATH && ((TPP_PROFILE == TPP_PROFILE_ALL) || ((TPP_PROFILE != TPP_PROFILE_MINIMAL) && TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH))
```
</details>
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14472) can be incref'd, whereas `char`
must be hard-copied.
...
## TPP_HAVE_FILE_GETLCINFO_EX_PROJPOS

Provide extra information `tlcix_projpos` and `tlcix_projfile`
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L22519), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22551).
...
```c
TPP_HAVE_CPP_MACROS && ((TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_BUILTIN_WARNHANDLER_HOOK)
```
</details>

## TPP_HAVE_LEXER_READUNICHAR

Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28967) that can be used
...
```c
TPP_HAVE_UNICODE && ((TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_LEXER_YIELD_INCLUDE_STRING)
```
</details>

## TPP_HAVE_LEXER_SEEKPP_RPAREN

Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29721) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29712) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29721), but is also able to deal with
...
## TPP_HAVE_LEXER_SEEKPP_RPAREN_EXACT

Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29743) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29737) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29721) whilst ensuring that
the number of arguments given is as expected (raising [`TPP_W_EXPECTED_STRING`](../src/tpp-amalgamation.h#L4206)
...
```c
TPP_HAVE_LEXER_SEEKPP_RPAREN && ((TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_MACRO___pragma || TPP_HAVE_MACRO___TPP_IDENTIFIER || TPP_HAVE_MACRO___TPP_STR_DECOMPILE || TPP_HAVE_MACRO___TPP_EXEC || TPP_HAVE_CPP_EMBED || TPP_HAVE_MACRO___has_embed)
```
</details>

## TPP_HAVE_IFDEF_STACK

Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L21587) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L21530) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21771))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L22478)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L22492)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29639) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22551)'s `tlcix_proj*` return values,
...
```c
TPP_HAVE_FILE_GETLCINFO_EX_PROJPOS && TPP_HAVE_LEXER_SEEKPP_RPAREN && (TPP_PROFILE != TPP_PROFILE_MINIMAL)
```
</details>

## TPP_HAVE_FILE_ENCODING_EMBED

Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L21339) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28923) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22506) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L22516) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22506),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14777).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14826).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14842) that can be used to
...
- [`TPP_HAVE_INCLUDE_PATH_ENVIRON`](#tpp_have_include_path_environ) (aka: `$CPATH`)
- [`TPP_HAVE_TIME_ENVIRON`](#tpp_have_time_environ) (aka: `$SOURCE_DATE_EPOCH`)
...
```c
(TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_INCLUDE_PATH_ENVIRON || TPP_HAVE_TIME_ENVIRON
```
</details>

## TPP_HAVE_JOINPATH

Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24007), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27967) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14551) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14472)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14591)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29534) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29548)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L27302)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29581), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29557)
...
## TPP_HAVE_LEXER_PEEK_RAW

Enable support for [`tpp_lexer_peek_raw()`](../src/tpp-amalgamation.h#L29618), which is a convenience wrapper
around [`tpp_lexer_seek_backup`](../src/tpp-amalgamation.h#L29082) and [`tpp_lexer_manualpopfile_start(self)`](../src/tpp-amalgamation.h#L29218) to
get a peek at the next upcoming token, as returned by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L29049)

With this in mind, this function behaves very similar to [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29581),
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30318) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17983) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30318) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L27283) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29257) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29796) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29820) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29836) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29836) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L29218)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29220)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29221)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29224)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29225)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29226)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29230)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29233)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29236)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22828) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L5100) if exactly
that happened.
...
```c
(TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_TPP_W_REDEFINE_MACRO
```
</details>

## TPP_HAVE_MACRO_NAME

Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22760) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L23376) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15588) to construct the result
...
Provide a function [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15598) to construct what
should be inserted in format-string expressions when the builtin
[`TPP_HAVE_FORMAT_STRING_BUILTIN_EXPR`](config-conf.md#tpp_have_format_string_builtin_expr) is used.
...
```c
TPP_HAVE_FORMAT_STRING_BUILTIN_EXPR
```
</details>

## TPP_HAVE_INTVALUE_PRINTREPR

Provide a function [`tpp_intvalue_printrepr()`](../src/tpp-amalgamation.h#L15276) used to implement:

- [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15588) (see [`TPP_HAVE_EXPR_VALUE_PRINTREPR`](#tpp_have_expr_value_printrepr))
- [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15598) (see [`TPP_HAVE_EXPR_VALUE_PRINTSTR`](#tpp_have_expr_value_printstr))
...
```c
TPP_HAVE_EXPR_VALUE_PRINTREPR || TPP_HAVE_EXPR_VALUE_PRINTSTR
```
</details>

## TPP_HAVE_LEXER_DUMP_DEFINITIONS

Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30329) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30370) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30375) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L18076) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L29049) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L30030) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28937) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29878) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15376)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29355) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29867) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29905) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15376)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29894) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L30127) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L30146) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15376)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L30167) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15376)
...
## TPP_INTVALUE_MATH_CANOVERFLOW

Define to `1` if `tpp_intvalue_*` operations may return
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13908) to indicate integer overflow/underflow.
...
## TPP_INTVALUE_ASINTMAX_CANOVERFLOW

Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14950) can overflow/underflow.
...
```c
defined(tpp_intvalue) ? (!TPP_INTVALUE_MATH_CANOVERFLOW) : 0
```
</details>

## TPP_HAVE_FTOA

Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L14306) to convert a float into a string
...
```c
TPP_HAVE_BUILTIN_EXPR_FLOATS && (TPP_HAVE_EXPR_VALUE_PRINTREPR || TPP_HAVE_EXPR_VALUE_PRINTSTR)
```
</details>

## TPP_HAVE_TPP_EXTENSION_NEAREST

Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L24125) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L24227) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23951) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28872)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23962) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28905)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23973) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27766)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23984) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27773)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23995) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27781) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27944)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22937) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22951) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L14367) that can be used to
...
```c
TPP_HAVE_XML_ENTITY_LOOKUP && ((TPP_PROFILE == TPP_PROFILE_ALL) || (TPP_HAVE_TPP_W_UNKNOWN_NAMED_ESCAPE_SEQUENCE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)))
```
</details>

## TPP_HAVE_UNICODE_BYNAME_PRINTNEAREST

Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L14396) that can be used to
...
```c
TPP_HAVE_UNICODE_BYNAME_LOOKUP && ((TPP_PROFILE == TPP_PROFILE_ALL) || (TPP_HAVE_TPP_W_UNKNOWN_NAMED_ESCAPE_SEQUENCE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)))
```
</details>

## TPP_HAVE_DECODE_NAMED_PRINTNEAREST

Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14438) that can be used to
...
If available, used by [`TPP_HAVE_TPP_W_UNKNOWN_NAMED_ESCAPE_SEQUENCE`](config-warn.md#tpp_have_tpp_w_unknown_named_escape_sequence)
...
```c
TPP_HAVE_DECODE_NAMED_ESCAPE && ((TPP_HAVE_ESCAPE_NAMED_XML && TPP_HAVE_XML_ENTITY_PRINTNEAREST) || (TPP_HAVE_ESCAPE_NAMED_UNICODE_NAMES && TPP_HAVE_UNICODE_BYNAME_PRINTNEAREST)) && ((TPP_PROFILE == TPP_PROFILE_ALL) || (TPP_HAVE_TPP_W_UNKNOWN_NAMED_ESCAPE_SEQUENCE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)))
```
</details>

## TPP_HAVE_TPP_FUZZY_MEMCMP

Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L14339) to quantify the
...
```c
TPP_HAVE_TPP_EXTENSION_NEAREST || TPP_HAVE_TPP_WARNING_GROUP_NEAREST || TPP_HAVE_XML_ENTITY_PRINTNEAREST || TPP_HAVE_UNICODE_BYNAME_PRINTNEAREST
```
</details>

## TPP_HAVE_LEXER_INIT_OPEN

Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L28026), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L28056) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L28054)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14672) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L28084) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L28096) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27850) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L28121) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L28133)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L28135)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L28138)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28853) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28865)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28883) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28892) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28899)
...
## TPP_HAVE_STATIC_EMPTY_STRING

[`tpp_string_newempty()`](../src/tpp-amalgamation.h#L14538) is implemented in terms of a single, global "empty" string object.
...
- When this (and [`TPP_HAVE_KEYWORD_ASSTRING`](#tpp_have_keyword_asstring)) is disabled, then [`tpp_refcnt`](../src/tpp-amalgamation.h#L6127) can be used
  by the implementation of [`tpp_string`](../src/tpp-amalgamation.h#L14472), rather than [`tpp_refcnt_atomic`](../src/tpp-amalgamation.h#L6245).
- If you intend to use TPP in a heavily parallelized environment, you should be aware
  ...
  [`TPP_HAVE_KEYWORD_ASSTRING`](#tpp_have_keyword_asstring) if you have bus locking problems)
...
```c
TPP_HAVE_KEYWORD_ASSTRING || !TPP_REFCNT_ATOMIC_IS_ATOMIC || TPP_SINGLE_THREADED
```
</details>

## TPP_HAVE_TOKEN_NUMBER

Provide an extra *running number* field in [`tpp_token`](../src/tpp-amalgamation.h#L17989) that can is incremented every
time a token is returned by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L29049) and [`tpp_lexer_yieldraw_at()`](../src/tpp-amalgamation.h#L29079).

NOTE: The token number is *NOT* incremented when [`TPP_TOK_EOF`](../src/tpp-amalgamation.h#L16512) is reached, or
      when [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L29049) returns an error.
