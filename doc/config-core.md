...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16087) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20959) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10303) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11373))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L10374) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12891) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17665)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17671)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17657) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10734), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17579).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18332) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18338)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18232) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18237) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18241)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18246)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16090)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16093)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16837) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20221) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19696)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21508)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10714), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10660) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10660)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10681) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10681) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10681):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21115)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21043)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21009) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20519)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20501)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16884)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17579) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18009) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17579) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21418)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21508)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21547)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21563)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21587)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21518)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21587) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19781)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19782)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10606)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16099)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16039)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16045), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16102)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18705) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18705) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16099)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18705) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10734) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21289) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21280) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21289), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16194) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16136) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16372))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16900)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16913)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21207) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16971)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16061) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20610) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16926) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16936) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16926),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10978).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11006).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20531), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20519) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20284) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20282)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20296), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20332)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10793) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10734)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10832)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21137) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21151)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19628)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21189), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21162)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21811) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12900) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21811) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19609) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20934) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21340) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20895)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20897)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20898)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20901)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20902)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20903)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20907)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20910)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20913)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17245) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11296) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21822) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21858) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21863) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12976) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20737) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21508) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20624) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21382) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11090)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21371) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21409) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11090)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21398) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21605) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21627) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11090)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21655) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11090)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10590) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18199) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18301) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10622) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20546) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20554)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20570) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20579) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20586)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18049) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20560)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18060) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20592)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18071) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19956)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18083) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19962) that can be used to
