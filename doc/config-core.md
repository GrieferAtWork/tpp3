...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29163) & friends can be used to force calls to become
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27755) that can be used to duplicate a lexer.
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29375)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29391)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29303)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29269) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27879)
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29795)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29911)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29950)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29966)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29990)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29921)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29990) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29911)
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28859) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29602) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29593) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29602), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29624) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29618) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29602) whilst ensuring that
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29520) used during macro invocation,
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28815) that can be used to generate random
...
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27879) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29415) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29429)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29462), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29438)
...
Enable support for [`tpp_lexer_peek_raw()`](../src/tpp-amalgamation.h#L29499), which is a convenience wrapper
around [`tpp_lexer_seek_backup`](../src/tpp-amalgamation.h#L28974) and [`tpp_lexer_manualpopfile_start(self)`](../src/tpp-amalgamation.h#L29099) to
get a peek at the next upcoming token, as returned by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28941)

With this in mind, this function behaves very similar to [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29462),
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30199) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30199) (and is also used to
...
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29138) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29677) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29701) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29717) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29717) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L29099)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29101)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29102)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29105)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29106)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29107)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29111)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29114)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29117)
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30210) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30251) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30256) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28941) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29911) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28829) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29759) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29236) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29748) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29786) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29775) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L30008) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L30027) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L30048) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23900) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28764)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23911) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28797)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23922) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27680)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23933) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27687)
...
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27695) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27856)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27935), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27960) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27962)
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27976) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27988) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27762) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L28013) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L28025)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L28027)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L28030)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28745) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28757)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28775) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28784) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28791)
