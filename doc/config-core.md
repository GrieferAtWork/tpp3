...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19664) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25843) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12835) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14846))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12921) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16361) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21412)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21433)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21405) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13364), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21321).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6357)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6356)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22152) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22158)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22051) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22056) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22060)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22065)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19667)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19670)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20467) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25106) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24310)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21321) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6355)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26055)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26071)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25983)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25949) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25227)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20514)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21321) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21815) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21321) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26436)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26526)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26565)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26581)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26605)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26536)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26605) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26526)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13344), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13290) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13290)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13311) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13311) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13311):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19599)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19605), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24394)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24395)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13236)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19676)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19679)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22532) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22532) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19676)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22532) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13364) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26245) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26236) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26245), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19771) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19713) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19950))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20541)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20555)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26163) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20613)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19621) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25494) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20568) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20578) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20568),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13649).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13698).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25415), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25227) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13439) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13364)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13478)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26095) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26109)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24242)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26142), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26118)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26810) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16370) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26810) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24223) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25818) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26318) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26342) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26358) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26358) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25779)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25781)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25782)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25785)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25786)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25787)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25791)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25794)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25797)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20882) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20815) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21321) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13988) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26821) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26862) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26867) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16446) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25621) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26526) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25508) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26400) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13782)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25916) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26389) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26427) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13782)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26416) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26623) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26642) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13782)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26664) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13782)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13220) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22018) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22120) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13252) to quantify the
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21855) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25444)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21866) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25476)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21877) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24571)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21888) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24576)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21899) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24582) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25209)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20991) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21005) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L25270) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25268)
...
```c
(TPP_HAVE_FILE_NOKWD && (TPP_PROFILE == TPP_PROFILE_ALL)) || TPP_HAVE_CLI_SETINPUTS_DASH
```
</details>

## TPP_HAVE_LEXER_INIT_OPEN

Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25282), a function that lets you directly
...
```c
(TPP_HAVE_LEXER_OPENFILE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)) || (TPP_HAVE_CLI_DASH_INCLUDE || TPP_HAVE_CLI_SETINPUTS)
```
</details>

## TPP_HAVE_LEXER_PUSHFILE_IO

Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25307) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25309)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13547) onto the lexer's `#include`-stack.
...
```c
((TPP_PROFILE == TPP_PROFILE_ALL) && TPP_HAVE_INCLUDE_STACK && TPP_HAVE_LEXER_INIT_IO) || (TPP_HAVE_CLI_SETINPUTS_DASH && TPP_HAVE_INCLUDE_STACK)
```
</details>

## TPP_HAVE_LEXER_PUSHFILE_OPEN

Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25323) that can be used to quickly open
...
```c
((TPP_PROFILE == TPP_PROFILE_ALL) && TPP_HAVE_INCLUDE_STACK && TPP_HAVE_LEXER_INIT_OPEN) || (TPP_HAVE_CLI_SETINPUTS && TPP_HAVE_INCLUDE_STACK)
```
</details>

## TPP_HAVE_LEXER_PUSHFILE_TEXT

Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25360) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25372)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25374)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25377)
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25335) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25111) object onto the lexer's `#include`-stack.
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25430) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25438)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25454) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25463) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25470)
