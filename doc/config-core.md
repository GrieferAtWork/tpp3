...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L15771) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20641) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9988)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11057))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12575) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17341) that allows
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18014) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18020)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17914) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17919) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17923)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17928)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L15774)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L15777)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16521) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19903) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19378)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21190)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20797)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20725)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20691) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20201)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20183)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16568)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17263) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17691) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17263) structure). This is also needed
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15783)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L15723)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L15729), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L15786)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18387) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18387) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15783)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18387) contains a 4th path-list that is searched after all other paths
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L15878) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15820) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16056))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16584)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16597)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20889) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16655)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L15745) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16610) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16620) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16610),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10662).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10690).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20213), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20201) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19966) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19964)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19978), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20014)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10516)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20819) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20833)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19310)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20871), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20844)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21493) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12584) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21493) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19291) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20616) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21022) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20577)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20579)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20580)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20583)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20584)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20585)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20589)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20592)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20595)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20971) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20962) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20971), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16929) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21190) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21200)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21269) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10980) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12660) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20306) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21064) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10774)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21053) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21091) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10774)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21080) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21286) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21309) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10774)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21337) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10774)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17881)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17983)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20228) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20236)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20252) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20261) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20268)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17731) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20242)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17742) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20274)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17753) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19638)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17765) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19644) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21504) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21535) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21540) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19463)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19464)
