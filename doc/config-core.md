...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19999) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L26216) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13086) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15144))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13172) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16659) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21759)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21780)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21751) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13660), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21665).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6551)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6550)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22505) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22511)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22404) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22409) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22413)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22418)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20002)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20005)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20804) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25462) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24666)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21665) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6549)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26428)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26444)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26356)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26322) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25583)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20851)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21665) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22168) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21665) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26809)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26899)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26938)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26954)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26978)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26909)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26978) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26899)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13628), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13541) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13541)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13574) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13574) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13574):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19897)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19903), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24750)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24751)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13487)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20011)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20014)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22885) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22885) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20011)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22885) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13660) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26618) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26609) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26618), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20106) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20048) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20285))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20878)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20892)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26536) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20950)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19919) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25867) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20905) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20915) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20905),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13945).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13994).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25771), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25583) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13735) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13660)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13774)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26468) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26482)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24598)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26515), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26491)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27189) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16668) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27189) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24579) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L26191) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26691) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26715) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26731) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26731) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L26152)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L26154)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L26155)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L26158)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L26159)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L26160)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L26164)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L26167)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L26170)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21221) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21153) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21665) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14286) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L27200) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L27241) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L27246) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16744) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25994) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26899) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25881) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26773) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14080)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L26289) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26762) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26800) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14080)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26789) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26996) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L27015) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14080)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L27037) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14080)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13471) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22371) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22473) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22208) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25816)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22219) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25849)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22230) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24927)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22241) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24932)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22252) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24938) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25565)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21330) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21344) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13556) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13593) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13649) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13503) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25638), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25663) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25665)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13843) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25679) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25691) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25467) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25716) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25728)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25730)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25733)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25797) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25809)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25827) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25836) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25843)
