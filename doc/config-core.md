...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19332) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L24953) & friends can be used to force calls to become
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21016)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21033)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21009) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20925).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21738) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21744)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21637) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21642) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21646)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21651)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19335)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19338)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20079) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24201) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23528)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20925) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25165)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25181)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25093)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25059) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24322)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20126)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20925) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21404) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20925) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25548)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25638)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25677)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25693)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25717)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25648)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25717) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25638)
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23612)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23613)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19344)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19347)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22116) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22116) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19344)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22116) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25357) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25348) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25357), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19439) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19381) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19618))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20153)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20167)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25275) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20225)'s `tlcix_proj*` return values,
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24604) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20180) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20190) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20180),
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24525), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24322) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24389) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24387)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24401), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24442)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25205) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25219)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23460)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25254), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25230)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25929) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25929) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23441) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24928) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25430) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25454) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25470) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25470) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24889)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24891)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24892)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24895)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24896)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24897)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24901)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24904)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24907)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20489) to compare macro definitions.
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L25940) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L25981) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L25986) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24731) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25638) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24618) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25512) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13449)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25026) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25501) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25539) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13449)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25528) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25735) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25754) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13449)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25776) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13449)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21604) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21706) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24540) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24548)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24564) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24573) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24580)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21444) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24554)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21455) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24586)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21466) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23789)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21477) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23794)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21488) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23800) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24304)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20595) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20609) that can be used to easily skip an arbitrary
