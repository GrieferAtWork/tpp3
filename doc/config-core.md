...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L18859) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L23901) & friends can be used to force calls to become
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L20527)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L20544)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L20520) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20436).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21248) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21254)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21148) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21153) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21157)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21162)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L18862)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L18865)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L19605) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L23149) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L22617)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20436) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L24113)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L24041)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L24007) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L23270)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L19652)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20436) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L20915) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20436) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L24481)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24571)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L24610)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L24626)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24650)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L24581)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24650) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24571)
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L22702)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L22703)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18871)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L18874)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21626) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21626) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18871)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21626) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24290) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L24281) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24290), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L18966) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L18908) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19144))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L19668)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L19681)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L24208) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L19739)'s `tlcix_proj*` return values,
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L23552) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19694) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L19704) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19694),
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23473), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L23270) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L23337) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L23335)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L23349), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L23390)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L24135) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L24149)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L22549)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L24187), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L24160)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24874) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24874) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L22530) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L23876) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L24363) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L24387) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24403) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24403) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L23837)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L23839)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L23840)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L23843)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L23844)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L23845)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L23849)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L23852)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L23855)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20000) to compare macro definitions.
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L24885) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L24924) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L24929) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L23679) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24571) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L23566) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L24445) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12944)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L23974) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24434) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L24472) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12944)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L24461) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L24668) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L24690) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12944)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L24718) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12944)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21115) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21217) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L23488) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L23496)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L23512) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L23521) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L23528)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L20955) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L23502)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L20966) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L23534)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L20977) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L22879)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L20988) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L22884)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L20999) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L22890) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L23252)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20106) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20120) that can be used to easily skip an arbitrary
