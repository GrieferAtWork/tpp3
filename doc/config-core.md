...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20644) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28171) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13428) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15778))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13514) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17293) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22508)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22529)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22500) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13951), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22414).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6619)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6618)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23289) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23295)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23188) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23193) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23197)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23202)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20647)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20650)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21449) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26767) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26400)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26497)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26507), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26502)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22414) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6617)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28383)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28399)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28311)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28277) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26888)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21496)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22414) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22941) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22414) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28764)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28854)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28893)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28909)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28933)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28864)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28933) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28854)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13928), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13855) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13855)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13887) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13887) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13887):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20542)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20548), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26484)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26485)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13825)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14334)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20656)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20659)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23670) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11671).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23670) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23670) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20656)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23670) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13951) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28573) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28564) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28573), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20751) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20693) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20930))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21523)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21537)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28491) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21595)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20564) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27822) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21550) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21560) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21550),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14248).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14297).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14313) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23037), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26888) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14026) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13951)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14065)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28423) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28437)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26326)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28470), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28446)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29142) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17302) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29142) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26307) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28146) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28646) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28670) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28686) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28686) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28107)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28109)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28110)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28113)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28114)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28115)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28119)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28122)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28125)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21866) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21798) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22414) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14947) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29153) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29194) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29199) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17378) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27949) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28854) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27836) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28728) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14735)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28244) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28717) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28755) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14735)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28744) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28951) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28970) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14735)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28991) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14735)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13411) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14421) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13809) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23155) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23257) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22981) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27771)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22992) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27804)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23003) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26698)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23014) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26703)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23025) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26709) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26870)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21975) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21989) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13870) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13899) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13941) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13842) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26943), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26968) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L26970)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14146) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26984) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L26996) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26772) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27021) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27033)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27035)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27038)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27752) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27764)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27782) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27791) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27798)
