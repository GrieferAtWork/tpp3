...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19980) & friends can be used to force calls to become
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19253) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18728)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20529)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20136)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20064)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20030) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19551)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19533)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17737) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17737) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15176)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17737) contains a 4th path-list that is searched after all other paths
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20228) used during macro invocation,
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19563), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19551) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19316) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19314)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19328), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L19364)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20158) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20172)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18660)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20210), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20183)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20832) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20832) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18641) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19955) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L20361) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19916)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19918)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19919)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19922)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19923)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19924)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19928)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19931)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19934)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20310) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20301) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20310), but is also able to deal with
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20529) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20539)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20608) to speed up decoding of certain kinds
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20403) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10269)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20392) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20430) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10269)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20419) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20625) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20648) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10269)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20676) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10269)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19578) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19586)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19602) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19611) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19618)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17087) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19592)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17098) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19624)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17109) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18988)
...
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18994) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20843) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20874) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20879) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18813)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18814)
