...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20753) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28426) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13498) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15887))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5053)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13584) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17402) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22729)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22750)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22721) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14021), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22630).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6631)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6630)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23510) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23516)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23409) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23414) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23418)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23423)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20756)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20759)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21644) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27026) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26633)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26745)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26755), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26750)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22630) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6629)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28638)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28654)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28566)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28532) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27150)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21715)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22630) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23162) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22630) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29021)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29111)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29150)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29166)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29190)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29121)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29190) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29111)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4569)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13998), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13925) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13925)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13957) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13957) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13957):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20651)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20657), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26732)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26733)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13895)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14404)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20765)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20768)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23891) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11699).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23891) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23891) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20765)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23891) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14021) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L21782), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21814).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28125) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28828) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28819) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28828), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L28850) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L28844) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28828) whilst ensuring that
the number of arguments given is as expected (raising [`TPP_W_EXPECTED_STRING`](../src/tpp-amalgamation.h#L4132)
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20859) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20802) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21039))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21742)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21756)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28746) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21814)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20673) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28085) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21769) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21779) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21769),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14318).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14367).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14383) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23258), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27150) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14096) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14021)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14135)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28678) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28692)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26553)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28725), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28701)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29399) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17411) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29399) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26534) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28401) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28903) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28927) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28943) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28943) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28362)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28364)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28365)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28368)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28369)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28370)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28374)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28377)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28380)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22085) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L5020) if exactly
that happened.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22017) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22630) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15056) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29410) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29451) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29456) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17487) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28206) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29111) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28099) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28985) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14844)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28499) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28974) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29012) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14844)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29001) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29208) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29227) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14844)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29248) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14844)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13481) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14491) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13879) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23376) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23478) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23202) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28034)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23213) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28067)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23224) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L26951)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23235) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L26958)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23246) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L26966) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27127)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22194) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22208) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13940) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13969) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14011) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13912) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27206), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27231) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27233)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14216) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27247) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27259) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27033) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27284) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27296)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27298)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27301)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28015) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28027)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28045) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28054) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28061)
