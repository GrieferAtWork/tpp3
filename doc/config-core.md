...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14875) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19611) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9442)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10393))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9513) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11858) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16424) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9763)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17068) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17074)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16968) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16973) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16977)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16982)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14878)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14881)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15613) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18888) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18380)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19767)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19695)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19661) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19182)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19164)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15660)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16346) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16745) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16346) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9739)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14887)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14827)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14833), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14890)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17435) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17435) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14887)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17435) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9763) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14982) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14924) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15150))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15676)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15689)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19859) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15747)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14849) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15702) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15712) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15702),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9998).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10026).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19194), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19182) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18949) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18947)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18961), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18997)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L9821) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L9763)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L9857)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19789) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19803)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18312)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19841), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19814)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20465) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11867) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20465) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18293) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19586) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19992) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19547)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19549)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19550)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19553)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19554)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19555)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19559)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19562)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19565)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19941) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19932) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19941), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16017) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20159) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20171)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20241) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10316) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11943) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11952) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20060) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10110)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20048) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20136) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10110)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20124) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20258) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20281) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10110)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20309) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10110)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9723) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16935)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17037)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9755) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19209) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19217)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19233) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19242) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19249)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16785) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19223)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16796) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19255)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16807) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18640)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16819) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18646) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20476) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20507) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20512) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18465)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18466)
