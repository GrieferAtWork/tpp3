...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20760) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28534) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13503) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15892))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13589) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17407) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22801)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22822)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22793) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14026), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22702).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23585) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23591)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23484) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23489) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23493)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23498)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20769)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20780)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21709) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27126) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26708)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26820)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26830), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26825)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22702) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28746)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28762)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28674)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28640) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27250)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21780)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22702) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23237) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22702) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29129)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29219)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29258)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29274)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29298)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29229)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29298) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29219)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14003), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13930) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13930)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13962) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13962) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13962):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20656)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20662), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26807)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26808)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13900)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14409)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20797)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20806)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23966) containing an extra (hidden) path-list that
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23966) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23966) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20797)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23966) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14026) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L21847), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21879).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28230) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28936) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28927) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28936), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L28958) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L28952) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28936) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20926) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20869) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21106))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21807)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21821)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28854) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21879)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20678) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28186) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21834) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21844) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21834),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14323).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14372).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14388) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23333), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27250) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14101) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14026)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14140)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28786) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28800)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26628)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28833), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28809)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29507) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17416) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29507) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26609) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28509) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29011) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29035) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29051) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29051) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28470)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28472)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28473)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28476)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28477)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28478)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28482)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28485)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28488)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22154) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22086) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22702) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15061) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29518) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29559) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29564) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17492) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28312) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29219) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28200) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29093) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14849)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28607) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29082) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29120) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14849)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29109) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29316) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29335) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14849)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29356) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14849)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13486) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14496) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13884) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23451) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23553) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23277) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28135)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23288) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28168)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23299) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27051)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23310) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27058)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23321) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27066) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27227)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22263) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22277) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13945) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13974) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14016) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13917) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27306), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27331) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27333)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14221) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27347) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27359) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27133) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27384) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27396)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27398)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27401)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28116) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28128)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28146) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28155) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28162)
