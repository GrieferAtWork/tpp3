...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19364) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25037) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12582) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14545))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12655) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16063) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21095)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21116)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21088) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13092), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21004).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21822) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21828)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21721) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21726) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21730)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21735)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19367)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19370)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20152) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24285) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23612)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21004) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25249)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25265)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25177)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25143) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24406)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20199)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21004) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21488) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21004) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25632)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25722)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25761)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25777)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25801)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25732)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25801) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25722)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13072), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13018) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13018)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13039) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13039) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13039):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19299)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19305), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23696)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23697)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12964)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19376)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19379)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22200) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22200) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19376)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22200) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13092) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25441) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25432) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25441), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19471) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19413) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19650))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20226)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20240)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25359) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20298)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19321) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24688) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20253) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20263) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20253),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13348).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13397).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24609), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24406) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24473) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24471)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24485), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24526)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13163) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13092)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13202)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25289) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25303)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23544)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25338), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25314)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26013) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16072) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26013) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23525) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25012) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25514) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25538) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25554) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25554) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24973)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24975)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24976)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24979)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24980)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24981)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24985)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24988)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24991)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20565) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20498) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21004) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13687) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26024) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26065) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26070) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16148) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24815) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25722) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24702) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25596) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13481)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25110) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25585) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25623) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13481)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25612) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25819) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25838) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13481)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25860) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13481)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12948) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21688) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21790) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12980) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24624) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24632)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24648) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24657) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24664)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21528) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24638)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21539) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24670)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21550) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23873)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21561) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23878)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21572) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23884) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24388)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20674) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20688) that can be used to easily skip an arbitrary
