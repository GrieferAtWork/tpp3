...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19714) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25899) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12848) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14859))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16374) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21465)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21486)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21458) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21374).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22205) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22211)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22104) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22109) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22113)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22118)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19717)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19720)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20519) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25162) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24366)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21374) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26111)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26127)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26039)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26005) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25283)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20566)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21374) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21868) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21374) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26492)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26582)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26621)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26637)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26661)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26592)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26661) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26582)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19612)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19618), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24450)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24451)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19726)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19729)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22585) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22585) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19726)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22585) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26301) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26292) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26301), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19821) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19763) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20000))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20593)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20607)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26219) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20665)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19634) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25550) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20620) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20630) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20620),
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25471), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25283) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26151) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26165)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24298)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26198), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26174)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26866) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16383) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26866) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24279) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25874) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26374) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26398) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26414) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26414) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25835)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25837)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25838)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25841)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25842)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25843)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25847)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25850)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25853)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20935) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20868) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21374) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14001) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26877) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26918) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26923) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16459) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25677) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26582) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25564) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26456) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13795)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25972) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26445) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26483) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13795)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26472) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26679) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26698) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13795)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26720) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13795)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22071) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22173) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21908) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25500)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21919) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25532)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21930) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24627)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21941) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24632)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21952) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24638) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25265)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21044) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21058) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25338), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25363) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25365)
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25379) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25391) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25167) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25416) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25428)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25430)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25433)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25486) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25494)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25510) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25519) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25526)
