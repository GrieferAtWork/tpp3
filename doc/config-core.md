...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19361) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25049) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12579) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14542))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5003)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12652) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16060) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21107)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21128)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21100) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13089), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21016).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6298)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6297)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21834) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21840)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21733) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21738) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21742)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21747)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19364)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19367)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20164) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24297) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23624)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21016) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6296)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25261)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25277)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25189)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25155) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24418)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20211)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21016) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21500) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21016) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25644)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25734)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25773)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25789)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25813)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25744)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25813) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25734)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4542)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13069), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13015) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13015)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13036) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13036) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13036):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19296)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19302), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23708)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23709)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12961)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19373)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19376)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22212) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22212) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19373)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22212) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13089) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25453) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25444) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25453), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19468) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19410) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19647))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20238)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20252)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25371) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20310)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19318) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24700) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20265) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20275) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20265),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13345).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13394).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24621), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24418) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24485) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24483)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24497), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24538)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13160) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13089)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13199)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25301) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25315)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23556)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25350), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25326)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26025) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16069) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26025) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23537) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25024) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25526) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25550) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25566) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25566) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24985)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24987)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24988)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24991)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24992)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24993)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24997)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25000)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25003)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20577) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4970) if exactly
that happened.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20510) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21016) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13684) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26036) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26077) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26082) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16145) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24827) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25734) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24714) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25608) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13478)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25122) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25597) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25635) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13478)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25624) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25831) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25850) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13478)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25872) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13478)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12945) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21700) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21802) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12977) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24636) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24644)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24660) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24669) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24676)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21540) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24650)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21551) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24682)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21562) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23885)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21573) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23890)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21584) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23896) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24400)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20686) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20700) that can be used to easily skip an arbitrary
