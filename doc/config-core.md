...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14720) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19456) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9372)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10323))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9443) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11747) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16269) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9693)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L16913) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L16919)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16813) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16818) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16822)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16827)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14723)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14726)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15458) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18733) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18225)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19612)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19540)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19506) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19027)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19009)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15505)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16191) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16590) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16191) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9669)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14732)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14672)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14678), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14735)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17280) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17280) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14732)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17280) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9693) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14827) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14769) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L14995))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15521)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15534)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19704) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15592)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14694) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15547) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15557) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15547),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9928).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9956).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19039), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19027) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18794) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18792)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18806), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18842)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L9751) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L9693)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L9787)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19634) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19648)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18157)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19686), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19659)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20310) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11756) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20310) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18138) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19431) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19837) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19392)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19394)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19395)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19398)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19399)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19400)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19404)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19407)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19410)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19786) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19777) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19786), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15862) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20004) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20016)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20086) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10246) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11832) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11841) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L19905) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10040)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L19893) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L19981) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10040)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L19969) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20103) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20126) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10040)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20154) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10040)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9653) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16780)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L16882)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9685) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19054) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19062)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19078) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19087) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19094)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16630) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19068)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16641) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19100)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16652) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18485)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16664) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18491) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20321) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20352) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20357) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18310)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18311)
