...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19351) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25024) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12569) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14532))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12642) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16050) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21082)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21103)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21075) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13079), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20991).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21809) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21815)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21708) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21713) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21717)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21722)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19354)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19357)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20139) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24272) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L23599)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20991) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25236)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25252)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25164)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25130) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24393)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20186)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20991) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21475) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20991) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L25619)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25709)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25748)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L25764)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25788)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L25719)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25788) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25709)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13059), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13005) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13005)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13026) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13026) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13026):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19286)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19292), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L23683)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L23684)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12951)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19363)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19366)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22187) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22187) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19363)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22187) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13079) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25428) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L25419) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L25428), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19458) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19400) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19637))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20213)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20227)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L25346) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20285)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19308) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L24675) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20240) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20250) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20240),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13335).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13384).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L24596), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L24393) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L24460) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L24458)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L24472), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L24513)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13150) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13079)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13189)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25276) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25290)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L23531)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L25325), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25301)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26000) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16059) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26000) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L23512) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24999) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L25501) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L25525) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25541) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25541) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24960)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24962)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24963)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24966)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24967)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24968)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24972)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24975)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24978)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20552) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20485) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L20991) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13674) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26011) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26052) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26057) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16135) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24802) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25709) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L24689) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L25583) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13468)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25097) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25572) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L25610) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13468)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L25599) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L25806) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25825) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13468)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25847) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13468)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12935) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21675) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21777) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12967) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24611) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24619)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L24635) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L24644) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L24651)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21515) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L24625)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21526) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L24657)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21537) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23860)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21548) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23865)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21559) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23871) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L24375)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20661) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20675) that can be used to easily skip an arbitrary
