...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16299) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L21200) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10438) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11585))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4086)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L10509) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L13103) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17955)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17961)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17947) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10946), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17869).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L5345)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L5344)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18573) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18579)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18473) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18478) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18482)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18487)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16302)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16305)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L17049) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20462) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19937)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21749)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L3656)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10926), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10872) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10872)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10893) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10893) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10893):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21356)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21284)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21250) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20760)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L17096)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17869) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18250) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17869) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21659)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21749)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21788)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21804)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21828)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21759)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21828) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20022)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20023)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10818)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16311)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16251)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16257), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16314)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18946) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18946) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16311)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18946) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10946) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21530) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21521) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21530), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16406) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16348) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16584))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L17112)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L17125)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21448) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L17183)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16273) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20851) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17138) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17148) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17138),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11190).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11218).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20772), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20760) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20525) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20523)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20537), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20573)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L11005) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10946)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L11044)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21378) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21392)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19869)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21430), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21403)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22052) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L13112) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22052) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19850) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L21175) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21581) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L21136)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L21138)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L21139)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L21142)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L21143)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L21144)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L21148)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21151)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L21154)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17457) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4047) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11508) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L22063) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L22099) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L22104) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13188) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20978) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21749) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20865) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21623) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11302)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21612) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21650) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11302)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21639) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21846) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21868) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11302)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21896) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11302)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10802) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18440) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18542) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10834) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20787) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20795)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20811) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20820) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20827)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18290) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20801)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18301) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20833)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18312) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L20197)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18324) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L20203) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20742)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L17590) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L17604) that can be used to easily skip an arbitrary
