...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20655) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28318) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13439) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15789))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13525) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17304) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22634)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22655)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22626) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13962), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22535).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23415) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23421)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23314) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23319) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23323)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23328)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20658)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20661)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21546) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26922) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26538)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26650)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26660), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26655)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22535) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28530)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28546)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28458)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28424) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27043)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21617)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22535) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23067) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22535) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28911)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29001)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29040)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29056)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29080)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29011)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29080) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29001)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13939), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13866) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13866)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13898) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13898) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13898):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20553)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20559), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26637)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26638)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13836)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14345)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20667)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20670)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23796) containing an extra (hidden) path-list that
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23796) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23796) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20667)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23796) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13962) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28720) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28711) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28720), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20761) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20704) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20941))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21644)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21658)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28638) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21716)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20575) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27977) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21671) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21681) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21671),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14259).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14308).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14324) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23163), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27043) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14037) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13962)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14076)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28570) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28584)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26458)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28617), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28593)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29289) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17313) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29289) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26439) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28293) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28793) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28817) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28833) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28833) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28254)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28256)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28257)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28260)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28261)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28262)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28266)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28269)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28272)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21987) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21919) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22535) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14958) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29300) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29341) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29346) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17389) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28098) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29001) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27991) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28875) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14746)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28391) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28864) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28902) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14746)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28891) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29098) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29117) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14746)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29138) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14746)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13422) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14432) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13820) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23281) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23383) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23107) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27926)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23118) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27959)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23129) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26853)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23140) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26858)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23151) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26864) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27025)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22096) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22110) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13881) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13910) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13952) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13853) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27098), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27123) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27125)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14157) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27139) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27151) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26927) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27176) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27188)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27190)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27193)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27907) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27919)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27937) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27946) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27953)
