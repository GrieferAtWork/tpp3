...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L17262) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L22170) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11348) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12504))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4837)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11421) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L14022) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L18918)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L18924)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L18910) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L11858), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L18832).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6104)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6103)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L19536) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L19542)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L19436) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L19441) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L19445)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L19450)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L17265)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L17268)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L18012) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L21432) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L20905)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L22326)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L22254)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L22220) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21730)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L18059)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L18832) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L19213) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L18832) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L22653)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22743)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L22782)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L22798)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22822)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L22753)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22822) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22743)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4370)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L11838), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L11784) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L11784)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11805) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L11805) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11805):
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20990)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20991)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L11730)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17274)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L17214)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L17220), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L17277)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19914) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19914) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17274)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19914) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L11858) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22500) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L22491) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22500), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L17369) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L17311) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L17547))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L18075)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L18088)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L22418) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L18146)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L17236) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L21821) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L18101) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L18111) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L18101),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L12102).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L12137).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L21742), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21730) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L21495) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L21493)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L21507), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L21543)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L11917) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L11858)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L11956)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L22348) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L22362)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L20837)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L22400), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L22373)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L23046) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L14031) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L23046) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L20818) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L22145) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L22551) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22567) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22567) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
for keywords where this property hasn't been explicitly defined by [`TPP_KWD_IS_IDENTIFIER()`](../src/tpp-amalgamation.h#L235),
and also don't have macro expansions as per [`TPP_BUILTIN_MACRO()`](../src/tpp-amalgamation.h#L268).
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L22106)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L22108)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L22109)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L22112)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L22113)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L22114)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L22118)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L22121)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L22124)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L18420) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4804) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12427) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L23057) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L23093) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L23098) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L14107) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L21948) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22743) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L21835) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L22617) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12221)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L22606) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L22644) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12221)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L22633) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L22840) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L22862) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12221)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L22890) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12221)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L11714) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L19403) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L19505) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L11746) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L21757) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L21765)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L21781) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L21790) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L21797)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L19253) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L21771)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L19264) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L21803)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L19275) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L21167)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L19287) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L21173) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L21712)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L18553) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L18567) that can be used to easily skip an arbitrary
