...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L21281) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29062) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13878) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L16315))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13964) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17851) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L23329)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L23350)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L23321) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14425), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L23230).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L24113) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L24119)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24012) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24017) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L24021)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L24026)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L21290)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L21301)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L22234) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27654) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L27236)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L27348)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L27358), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L27353)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L23230) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29274)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29290)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29202)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29168) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27778)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L22305)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L23230) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23765) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L23230) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29657)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29773)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29812)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29828)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29852)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29783)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29852) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29773)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14378), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L14305) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L14305)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14337) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L14337) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14337):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L21177)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L21183), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L27335)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L27336)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L14275)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14813)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21318)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21327)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L24494) containing an extra (hidden) path-list that
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24494) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24494) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21318)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24494) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14425) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L22373), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22405).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28758) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29464) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29455) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29464), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29486) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29480) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29464) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L21447) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L21390) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21628))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L22332)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L22346)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29382) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22405)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L21199) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28714) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22360) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L22370) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22360),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14727).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14776).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14792) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23861), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27778) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14504) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14425)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14544)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29314) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29328)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L27156)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29361), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29337)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30061) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17860) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30061) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L27137) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29037) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29539) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29563) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29579) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29579) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28998)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29000)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29001)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29004)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29005)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29006)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29010)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29013)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29016)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22682) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22614) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L23230) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15465) to construct the result
...
Provide a function [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15475) to construct what
...
Provide a function [`tpp_intvalue_printrepr()`](../src/tpp-amalgamation.h#L15226) used to implement:

- [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15465) (see [`TPP_HAVE_EXPR_VALUE_PRINTREPR`](#tpp_have_expr_value_printrepr))
- [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15475) (see [`TPP_HAVE_EXPR_VALUE_PRINTSTR`](#tpp_have_expr_value_printstr))
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30072) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30113) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30118) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17936) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28840) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29773) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28728) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29621) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15253)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29135) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29610) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29648) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15253)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29637) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29870) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29889) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15253)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29910) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15253)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13861) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14900) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L14259) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23979) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L24081) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23805) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28663)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23816) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28696)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23827) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27579)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23838) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27586)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23849) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27594) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27755)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22791) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22805) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L14320) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L14349) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14391) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L14292) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27834), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27859) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27861)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14625) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27875) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27887) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27661) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27912) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27924)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27926)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27929)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28644) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28656)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28674) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28683) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28690)
...
[`tpp_string_newempty()`](../src/tpp-amalgamation.h#L14491) is implemented in terms of a single, global "empty" string object.
...
- When this (and [`TPP_HAVE_KEYWORD_ASSTRING`](#tpp_have_keyword_asstring)) is disabled, then [`tpp_refcnt`](../src/tpp-amalgamation.h#L6117) can be used
  by the implementation of [`tpp_string`](../src/tpp-amalgamation.h#L14425), rather than [`tpp_refcnt_atomic`](../src/tpp-amalgamation.h#L6235).
