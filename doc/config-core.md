...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19735) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25920) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12867) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14880))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12953) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16395) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21486)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21507)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21479) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13396), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21395).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6395)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6394)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22226) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22232)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22125) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22130) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22134)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22139)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19738)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19741)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20540) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25183) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24387)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21395) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6393)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26132)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26148)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26060)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26026) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25304)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20587)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21395) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21889) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21395) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26513)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26603)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26642)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26658)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26682)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26613)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26682) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26603)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13376), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13322) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13322)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13343) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13343) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13343):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19633)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19639), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24471)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24472)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13268)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19747)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19750)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22606) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22606) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19747)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22606) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13396) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26322) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26313) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26322), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19842) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19784) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20021))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20614)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20628)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26240) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20686)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19655) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25571) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20641) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20651) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20641),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13681).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13730).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25492), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25304) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13471) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13396)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13510)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26172) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26186)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24319)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26219), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26195)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26889) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16404) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26889) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24300) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25895) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26395) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26419) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26435) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26435) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25856)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25858)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25859)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25862)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25863)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25864)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25868)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25871)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25874)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20956) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20889) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21395) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14022) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26900) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26941) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26946) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16480) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25698) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26603) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25585) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26477) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13816)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25993) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26466) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26504) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13816)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26493) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26700) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26719) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13816)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26741) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13816)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13252) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22092) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22194) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13284) to quantify the
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21929) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25521)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21940) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25553)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21951) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24648)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21962) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24653)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21973) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24659) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25286)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21065) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21079) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25359), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25384) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25386)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13579) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25400) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25412) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25188) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25437) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25449)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25451)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25454)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25507) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25515)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25531) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25540) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25547)
