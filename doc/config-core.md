...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20969) & friends can be used to force calls to become
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17675)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17681)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17667) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17589).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18342) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18348)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18242) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18247) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18251)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18256)
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20231) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19706)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21518)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21125)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21053)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21019) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20529)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20511)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17589) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18019) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17589) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21428)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21518)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21557)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21573)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21597)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21528)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21597) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19791)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19792)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18715) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18715) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16109)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18715) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21299) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21290) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21299), but is also able to deal with
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21217) used during macro invocation,
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20620) that can be used to generate random
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20541), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20529) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20294) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20292)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20306), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20342)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21147) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21161)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19638)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21199), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21172)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21821) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21821) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19619) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20944) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21350) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20905)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20907)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20908)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20911)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20912)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20913)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20917)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20920)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20923)
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21832) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21868) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21873) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20747) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21518) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20634) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21392) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11100)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21381) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21419) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11100)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21408) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21615) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21637) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11100)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21665) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11100)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18209) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18311) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20556) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20564)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20580) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20589) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20596)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18059) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20570)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18070) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20602)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18081) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19966)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18093) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19972) that can be used to
