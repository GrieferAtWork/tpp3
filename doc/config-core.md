...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L21357) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29138) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13878) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L16391))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17927) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L23405)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L23426)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L23397) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L23306).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L24189) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L24195)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24088) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24093) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L24097)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L24102)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L21366)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L21377)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L22310) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27730) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L27312)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L27424)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L27434), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L27429)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L23306) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29350)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29366)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29278)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29244) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27854)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L22381)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L23306) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23841) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L23306) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29733)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29849)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29888)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29904)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29928)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29859)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29928) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29849)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L21253)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L21259), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L27411)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L27412)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14816)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21394)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21403)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L24570) containing an extra (hidden) path-list that
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24570) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24570) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21394)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24570) contains a 4th path-list that is searched after all other paths
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L22449), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22481).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28834) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29540) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29531) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29540), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29562) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29556) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29540) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L21523) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L21466) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21704))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L22408)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L22422)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29458) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22481)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L21275) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28790) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22436) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L22446) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22436),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14730).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14779).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14795) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23937), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27854) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29390) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29404)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L27232)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29437), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29413)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30137) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17936) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30137) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L27213) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29113) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29615) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29639) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29655) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29655) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L29074)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29076)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29077)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29080)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29081)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29082)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29086)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29089)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29092)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22758) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22690) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L23306) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15541) to construct the result
...
Provide a function [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15551) to construct what
...
Provide a function [`tpp_intvalue_printrepr()`](../src/tpp-amalgamation.h#L15229) used to implement:

- [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15541) (see [`TPP_HAVE_EXPR_VALUE_PRINTREPR`](#tpp_have_expr_value_printrepr))
- [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15551) (see [`TPP_HAVE_EXPR_VALUE_PRINTSTR`](#tpp_have_expr_value_printstr))
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30148) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30189) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30194) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L18012) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28916) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29849) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28804) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29697) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15329)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29211) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29686) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29724) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15329)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29713) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29946) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29965) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15329)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29986) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15329)
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14903) can overflow/underflow.
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L24055) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L24157) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23881) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28739)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23892) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28772)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23903) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27655)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23914) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27662)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23925) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27670) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27831)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22867) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22881) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27910), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27935) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27937)
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27951) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27963) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27737) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27988) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L28000)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L28002)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L28005)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28720) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28732)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28750) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28759) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28766)
