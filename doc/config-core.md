...
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29209) & friends can be used to force calls to become
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27781) that can be used to duplicate a lexer.
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29421)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29437)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29349)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29315) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27905)
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29841)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29957)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29996)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L30012)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30036)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29967)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30036) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29957)
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28905) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29648) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29639) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29648), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29670) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29664) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29648) whilst ensuring that
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29566) used during macro invocation,
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28861) that can be used to generate random
...
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27905) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29461) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29475)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29508), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29484)
...
Enable support for [`tpp_lexer_peek_raw()`](../src/tpp-amalgamation.h#L29545), which is a convenience wrapper
around [`tpp_lexer_seek_backup`](../src/tpp-amalgamation.h#L29020) and [`tpp_lexer_manualpopfile_start(self)`](../src/tpp-amalgamation.h#L29145) to
get a peek at the next upcoming token, as returned by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28987)

With this in mind, this function behaves very similar to [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29508),
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30245) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30245) (and is also used to
...
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29184) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29723) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29747) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29763) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29763) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L29145)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29147)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29148)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29151)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29152)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29153)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29157)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29160)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29163)
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30256) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30297) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30302) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28987) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29957) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28875) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29805) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29282) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29794) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29832) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29821) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L30054) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L30073) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L30094) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23906) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28810)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23917) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28843)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23928) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27704)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23939) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27711)
...
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27719) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27882)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27964), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27994) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27992)
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L28022) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L28034) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27788) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L28059) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L28071)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L28073)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L28076)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28791) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28803)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28821) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28830) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28837)
