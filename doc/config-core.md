...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20291) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27786) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13372) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15425))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13458) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16940) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22155)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22176)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22147) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13895), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22061).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6597)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6596)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22925) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22931)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22824) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22829) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22833)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22838)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20294)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20297)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21096) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27032) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26036)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22061) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6595)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27998)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28014)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27926)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27892) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27153)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21143)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22061) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22588) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22061) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28386)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28476)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28515)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28531)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28555)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28486)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28555) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28476)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13872), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13799) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13799)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13831) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13831) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13831):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20189)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20195), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26120)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26121)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13769)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14278)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20303)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20306)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23306) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11635).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23306) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23306) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20303)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23306) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13895) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28188) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28179) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28188), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20398) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20340) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20577))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21170)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21184)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28106) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21242)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20211) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27437) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21197) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21207) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21197),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14192).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14241).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14257) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L27341), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27153) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13970) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13895)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14009)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28038) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28052)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25962)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28085), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28061)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28766) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16949) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28766) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25943) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27761) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28261) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28285) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28301) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28301) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27722)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27724)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27725)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27728)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27729)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27730)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27734)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27737)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27740)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21513) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21445) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22061) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14566) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28777) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28818) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28823) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17025) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27564) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28476) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27451) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28347) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14361)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27859) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28332) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28376) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14361)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28364) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28573) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28592) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14361)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28614) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14361)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13753) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22791) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22893) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22628) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27386)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22639) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27419)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22650) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26305)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22661) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26310)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22672) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26316) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27135)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21622) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21636) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13814) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13885) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13786) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27208), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27233) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27235)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14090) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27249) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27261) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27037) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27286) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27298)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27300)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27303)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27367) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27379)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27397) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27406) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27413)
