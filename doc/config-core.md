...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19651) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25830) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12822) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14833))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12908) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16348) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21399)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21420)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21392) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13351), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21308).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22139) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22145)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22038) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22043) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22047)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22052)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19654)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19657)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20454) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25093) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24297)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21308) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26042)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26058)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25970)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25936) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25214)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20501)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21308) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21802) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21308) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26423)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26513)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26552)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26568)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26592)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26523)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26592) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26513)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13331), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13277) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13277)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13298) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13298) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13298):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19586)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19592), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24381)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24382)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13223)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19663)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19666)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22519) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22519) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19663)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22519) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13351) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26232) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26223) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26232), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19758) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19700) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19937))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20528)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20542)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26150) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20600)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19608) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25481) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20555) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20565) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20555),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13636).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13685).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25402), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25214) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13426) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13351)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13465)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26082) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26096)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24229)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26129), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26105)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26797) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16357) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26797) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24210) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25805) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26305) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26329) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26345) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26345) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25766)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25768)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25769)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25772)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25773)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25774)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25778)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25781)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25784)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20869) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20802) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21308) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13975) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26808) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26849) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26854) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16433) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25608) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26513) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25495) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26387) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13769)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25903) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26376) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26414) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13769)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26403) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26610) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26629) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13769)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26651) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13769)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13207) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22005) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22107) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13239) to quantify the
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21842) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25431)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21853) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25463)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21864) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24558)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21875) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24563)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21886) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24569) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25196)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20978) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20992) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25269), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25294) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25296)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13534) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25310) that can be used to quickly open
...
- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25359)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25361)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25364)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25417) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25425)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25441) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25450) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25457)
