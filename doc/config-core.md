...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14439) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L18829) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9139)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10076))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9210) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11488) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L15964) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9460)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L16536) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L16542)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16436) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16441) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16445)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16450)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14442)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14445)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15175) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18178) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L17759)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L18985)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L18913)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L18879) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18473)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L18455)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15222)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L15886) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16263) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L15886) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9436)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14451)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14391)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14397), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14454)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16899) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16899) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14451)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16899) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9460) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14546) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14488) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L14711))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15238)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15251)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19075) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15287)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14413) file encoding
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9681).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9709).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L18485), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18473) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18239) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18237)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18251), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18287)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19007) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19021)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L17681)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19057), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19030)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L19652) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11497) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L19652) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L17673) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L18804) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19208) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L18765)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L18767)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L18768)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L18771)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L18772)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L18773)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L18777)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L18780)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L18783)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19157) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19148) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19157), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15557) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19365) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L19377)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L19447) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L9999) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11573) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11582) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L19271) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9793)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L19259) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L19342) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9793)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L19330) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L19464) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L19487) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9793)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L19515) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9793)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9420) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16403)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L16505)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9452) to quantify the
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L19663) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L19694) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L19699) that causes every
