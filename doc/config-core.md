...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16086) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20956) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10303) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11372))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12890) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17664)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17670)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17656) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17578).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18329) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18335)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18229) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18234) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18238)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18243)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16089)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16092)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16836) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20218) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19693)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21505)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21112)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21040)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21006) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20516)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20498)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16883)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17578) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18006) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17578) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21415)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21505)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21544)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21560)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21584)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21515)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21584) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19778)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19779)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16098)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16038)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16044), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16101)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18702) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18702) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16098)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18702) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21286) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21277) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21286), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16193) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16135) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16371))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16899)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16912)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21204) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16970)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16060) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20607) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16925) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16935) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16925),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10977).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11005).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20528), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20516) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20281) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20279)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20293), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20329)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10792) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10734)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10831)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21134) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21148)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19625)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21186), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21159)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21808) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12899) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21808) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19606) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20931) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21337) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20892)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20894)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20895)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20898)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20899)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20900)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20904)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20907)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20910)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17244) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11295) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21819) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21855) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21860) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12975) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20734) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21505) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20621) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21379) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11089)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21368) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21406) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11089)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21395) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21602) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21624) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11089)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21652) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11089)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18196) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18298) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20543) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20551)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20567) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20576) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20583)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18046) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20557)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18057) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20589)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18068) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19953)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18080) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19959) that can be used to
