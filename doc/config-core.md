...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20031) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27337) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13118) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15176))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13204) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16691) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21791)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21812)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21783) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13692), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21697).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22537) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22543)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22436) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22441) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22445)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22450)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20034)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20037)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20836) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26583) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L25595)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21697) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27549)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L27565)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27477)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27443) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26704)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20883)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21697) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22200) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21697) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L27930)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28020)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28059)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28075)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28099)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28030)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28099) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28020)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13660), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13573) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13573)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13606) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13606) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13606):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19929)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19935), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L25679)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L25680)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13519)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20043)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20046)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22917) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22917) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20043)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22917) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13692) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27739) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L27730) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27739), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20138) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20080) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20317))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20910)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20924)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L27657) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20982)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19951) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L26988) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20937) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20947) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20937),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13977).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14026).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L26892), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26704) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13767) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13692)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13806)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L27589) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L27603)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25527)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L27636), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L27612)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28310) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16700) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28310) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25508) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27312) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L27812) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L27836) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27852) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27852) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27273)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27275)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27276)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27279)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27280)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27281)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27285)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27288)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27291)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21253) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21185) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21697) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14318) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28321) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28362) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28367) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16776) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27115) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28020) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27002) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L27894) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14112)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27410) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L27883) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L27921) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14112)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L27910) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28117) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28136) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14112)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28158) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14112)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13503) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22403) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22505) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22240) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L26937)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22251) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L26970)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22262) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L25856)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22273) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L25861)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22284) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L25867) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26686)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21362) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21376) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13588) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13625) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13681) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13535) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26759), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26784) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L26786)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13875) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26800) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L26812) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26588) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L26837) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L26849)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L26851)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L26854)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L26918) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L26930)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L26948) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L26957) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L26964)
