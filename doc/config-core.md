...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L17140) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L22048) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11237) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12393))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11310) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L13911) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L18796)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L18802)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L18788) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L11747), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L18710).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6089)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6088)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L19414) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L19420)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L19314) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L19319) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L19323)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L19328)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L17143)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L17146)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L17890) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L21310) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L20783)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22621)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L11727), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L11673) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L11673)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11694) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L11694) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11694):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L22204)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L22132)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L22098) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21608)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L17937)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L18710) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L19091) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L18710) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L22531)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22621)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L22660)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L22676)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22700)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L22631)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22700) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20868)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20869)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L11619)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17152)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L17092)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L17098), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L17155)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19792) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19792) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17152)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19792) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L11747) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22378) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L22369) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22378), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L17247) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L17189) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L17425))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L17953)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L17966)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L22296) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L18024)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L17114) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L21699) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17979) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17989) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17979),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11991).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L12026).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L21620), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21608) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L21373) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L21371)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L21385), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L21421)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L11806) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L11747)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L11845)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L22226) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L22240)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L20715)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L22278), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L22251)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22924) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L13920) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22924) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L20696) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L22023) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L22429) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22445) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22445) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
for keywords where this property hasn't been explicitly defined by [`TPP_KWD_IS_IDENTIFIER()`](../src/tpp-amalgamation.h#L235),
and also don't have macro expansions as per [`tpp_macro_getbuiltin()`](../src/tpp-amalgamation.h#L18370).
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L21984)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L21986)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L21987)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L21990)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L21991)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L21992)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L21996)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21999)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L22002)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L18298) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12316) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L22935) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L22971) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L22976) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13996) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L21826) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22621) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L21713) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L22495) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12110)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L22484) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L22522) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12110)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L22511) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L22718) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L22740) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12110)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L22768) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12110)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L11603) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L19281) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L19383) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L11635) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L21635) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L21643)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L21659) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L21668) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L21675)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L19131) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L21649)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L19142) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L21681)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L19153) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L21045)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L19165) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L21051) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L21590)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L18431) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L18445) that can be used to easily skip an arbitrary
