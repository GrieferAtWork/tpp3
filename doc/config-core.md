...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19572) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25751) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12760) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14754))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12846) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16269) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21320)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21341)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21313) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13289), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21229).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6345)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6344)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22060) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22066)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21959) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21964) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21968)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21973)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19575)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19578)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20375) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25014) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24218)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21229) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6343)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25963)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25979)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25891)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25857) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25135)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20422)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21229) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21723) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21229) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26344)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26434)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26473)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26489)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26513)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26444)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26513) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26434)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13269), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13215) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13215)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13236) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13236) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13236):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19507)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19513), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24302)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24303)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13161)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19584)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19587)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22440) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22440) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19584)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22440) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13289) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26153) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26144) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26153), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19679) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19621) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19858))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20449)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20463)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26071) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20521)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19529) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25402) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20476) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20486) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20476),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13557).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13606).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25323), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25135) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L25178) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25176)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25190), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25231)
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25215) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25217)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13472) onto the lexer's `#include`-stack.
...
```c
(TPP_PROFILE == TPP_PROFILE_ALL) && TPP_HAVE_INCLUDE_STACK && TPP_HAVE_LEXER_INIT_IO
```
</details>

## TPP_HAVE_LEXER_PUSHFILE_OPEN

Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25231) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25243) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25019) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25268) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25280)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25282)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25285)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13364) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13289)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13403)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26003) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26017)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24150)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26050), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26026)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26718) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16278) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26718) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24131) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25726) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26226) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26250) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26266) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26266) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25687)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25689)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25690)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25693)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25694)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25695)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25699)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25702)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25705)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20790) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20723) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21229) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13896) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26729) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26770) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26775) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16354) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25529) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26434) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25416) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26308) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13690)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25824) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26297) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26335) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13690)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26324) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26531) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26550) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13690)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26572) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13690)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13145) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21926) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22028) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13177) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25338) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25346)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25362) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25371) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25378)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21763) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25352)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21774) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25384)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21785) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24479)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21796) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24484)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21807) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24490) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25117)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20899) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20913) that can be used to easily skip an arbitrary
