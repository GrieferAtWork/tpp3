...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L18551) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L23606) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11752) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13760))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4884)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11825) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L15278) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L20232)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L20249)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L20225) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L12262), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20141).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6163)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6162)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L20953) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L20959)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L20853) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L20858) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L20862)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L20867)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L18554)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L18557)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L19297) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L22854) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L22322)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20141) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6161)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L23818)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L23746)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L23712) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L22975)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L19344)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20141) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L20620) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20141) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L24183)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24273)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L24312)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L24328)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24352)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L24283)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24352) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24273)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4423)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L12242), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L12188) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L12188)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L12209) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L12209) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L12209):
...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L24653), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L22822)), though whether or not the its initial
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L22407)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L22408)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12134)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18563)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L18503)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L18509), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L18566)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21331) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21331) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18563)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21331) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L12262) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L23992) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L23983) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L23992), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L18658) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L18600) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L18836))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L19360)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L19373)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L23910) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L19431)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L18525) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L23257) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19386) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L19396) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19386),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L12518).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L12567).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23178), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L22975) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L23042) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L23040)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L23054), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L23095)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L12333) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L12262)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L12372)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L23840) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L23854)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L22254)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L23892), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L23865)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24576) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L15287) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24576) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L22235) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L23581) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L24065) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L24089) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24105) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24105) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L23542)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L23544)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L23545)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L23548)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L23549)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L23550)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L23554)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L23557)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L23560)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L19705) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4851) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12857) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L24587) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L24626) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L24631) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L15363) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L23384) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24273) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L23271) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L24147) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12651)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L23679) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24136) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L24174) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12651)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L24163) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L24370) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L24392) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12651)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L24420) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12651)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12118) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L20820) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L20922) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12150) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L23193) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L23201)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L23217) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L23226) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L23233)
...
as `<name>` just the way you wrote them using [`TPP_KWD(<name>, "<repr>")`](../src/tpp-amalgamation.h#L264).
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L20660) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L23207)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L20671) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L23239)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L20682) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L22584)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L20693) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L22589)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L20704) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L22595) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L22957)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L19811) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L19825) that can be used to easily skip an arbitrary
