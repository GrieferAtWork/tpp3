...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20051) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27357) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13138) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15196))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13224) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16711) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21811)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21832)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21803) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13712), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21717).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6538)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6537)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22557) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22563)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22456) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22461) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22465)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22470)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20054)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20057)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20856) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26603) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L25615)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21717) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6536)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27569)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L27585)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27497)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27463) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26724)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20903)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21717) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22220) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21717) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L27950)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28040)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28079)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28095)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28119)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28050)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28119) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28040)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13680), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13593) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13593)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13626) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13626) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13626):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19949)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19955), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L25699)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L25700)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13539)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20063)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20066)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22937) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22937) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20063)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22937) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13712) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27759) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L27750) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27759), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20158) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20100) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20337))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20930)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20944)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L27677) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21002)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19971) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27008) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20957) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20967) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20957),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13997).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14046).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L26912), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26724) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13787) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13712)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13826)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L27609) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L27623)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25547)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L27656), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L27632)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28330) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16720) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28330) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25528) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27332) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L27832) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L27856) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27872) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27872) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27293)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27295)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27296)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27299)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27300)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27301)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27305)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27308)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27311)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21273) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21205) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21717) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14338) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28341) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28382) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28387) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16796) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27135) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28040) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27022) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L27914) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14132)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27430) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L27903) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L27941) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14132)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L27930) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28137) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28156) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14132)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28178) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14132)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13523) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22423) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22525) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22260) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L26957)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22271) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L26990)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22282) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L25876)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22293) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L25881)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22304) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L25887) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26706)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21382) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21396) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13608) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13645) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13701) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13555) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26779), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26804) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L26806)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13895) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26820) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L26832) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26608) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L26857) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L26869)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L26871)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L26874)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L26938) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L26950)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L26968) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L26977) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L26984)
