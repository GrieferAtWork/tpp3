...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19989) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L26206) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13076) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15134))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13162) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16649) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21749)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21770)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21741) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13650), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21655).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22495) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22501)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22394) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22399) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22403)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22408)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19992)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19995)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20794) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25452) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24656)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21655) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26418)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26434)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26346)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26312) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25573)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20841)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21655) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22158) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21655) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26799)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26889)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26928)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26944)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26968)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26899)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26968) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26889)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13618), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13531) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13531)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13564) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13564) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13564):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19887)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19893), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24740)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24741)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13477)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20001)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20004)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22875) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22875) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20001)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22875) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13650) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26608) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26599) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26608), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20096) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20038) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20275))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20868)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20882)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26526) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20940)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19909) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25857) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20895) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20905) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20895),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13935).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13984).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25761), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25573) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13725) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13650)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13764)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26458) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26472)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24588)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26505), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26481)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27179) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16658) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27179) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24569) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L26181) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26681) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26705) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26721) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26721) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L26142)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L26144)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L26145)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L26148)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L26149)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L26150)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L26154)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L26157)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L26160)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21211) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21143) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21655) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14276) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L27190) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L27231) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L27236) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16734) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25984) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26889) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25871) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26763) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14070)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L26279) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26752) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26790) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14070)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26779) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26986) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L27005) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14070)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L27027) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14070)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13461) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22361) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22463) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22198) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25806)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22209) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25839)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22220) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24917)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22231) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24922)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22242) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24928) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25555)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21320) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21334) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13546) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13583) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13639) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13493) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25628), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25653) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25655)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13833) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25669) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25681) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25457) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25706) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25718)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25720)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25723)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25787) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25799)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25817) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25826) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25833)
