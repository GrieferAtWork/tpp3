...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19523) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25709) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12711) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14705))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16220) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21271)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21292)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21264) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21180).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22003) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22009)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21902) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21907) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21911)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21916)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19526)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19529)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20326) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L24957) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24161)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21180) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25921)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25937)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25849)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25815) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25078)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20373)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21180) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21666) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21180) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26302)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26392)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26431)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26447)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26471)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26402)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26471) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26392)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19458)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19464), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24245)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24246)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19535)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19538)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22383) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22383) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19535)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22383) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26111) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26102) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26111), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19630) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19572) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19809))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20400)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20414)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26029) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20472)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19480) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25360) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20427) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20437) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20427),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13508).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13557).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25281), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25078) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L25145) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25143)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25157), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25198)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L25961) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L25975)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24093)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26008), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L25984)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26676) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16229) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26676) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24074) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25684) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26184) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26208) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26224) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26224) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25645)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25647)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25648)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25651)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25652)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25653)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25657)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25660)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25663)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20741) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20674) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21180) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13847) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26687) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26728) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26733) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16305) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25487) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26392) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25374) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26266) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13641)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25782) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26255) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26293) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13641)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26282) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26489) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26508) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13641)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26530) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13641)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21869) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21971) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25296) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25304)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25320) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25329) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25336)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21706) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25310)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21717) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25342)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21728) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24422)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21739) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24427)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21750) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24433) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25060)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20850) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20864) that can be used to easily skip an arbitrary
