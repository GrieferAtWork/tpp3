...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L17133) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L22041) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11237) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12386))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L13904) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L18789)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L18795)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L18781) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L18703).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L19407) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L19413)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L19307) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L19312) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L19316)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L19321)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L17136)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L17139)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L17883) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L21303) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L20776)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22614)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L22197)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L22125)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L22091) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21601)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L17930)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L18703) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L19084) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L18703) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L22524)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22614)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L22653)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L22669)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22693)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L22624)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22693) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20861)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20862)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17145)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L17085)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L17091), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L17148)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19785) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19785) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17145)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19785) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22371) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L22362) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22371), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L17240) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L17182) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L17418))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L17946)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L17959)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L22289) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L18017)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L17107) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L21692) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17972) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17982) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17972),
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L12019).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L21613), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21601) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L21366) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L21364)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L21378), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L21414)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L22219) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L22233)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L20708)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L22271), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L22244)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22917) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L13913) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22917) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L20689) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L22016) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L22422) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22438) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22438) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
for keywords where this property hasn't been explicitly defined by [`TPP_KWD_IS_IDENTIFIER()`](../src/tpp-amalgamation.h#L235),
and also don't have macro expansions as per [`tpp_macro_getbuiltin()`](../src/tpp-amalgamation.h#L18363).
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L21977)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L21979)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L21980)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L21983)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L21984)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L21985)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L21989)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21992)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L21995)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L18291) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12309) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L22928) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L22964) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L22969) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13989) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L21819) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22614) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L21706) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L22488) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12103)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L22477) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L22515) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12103)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L22504) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L22711) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L22733) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12103)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L22761) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12103)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L19274) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L19376) that does fuzzy matching to find
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L21628) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L21636)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L21652) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L21661) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L21668)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L19124) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L21642)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L19135) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L21674)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L19146) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L21038)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L19158) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L21044) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L21583)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L18424) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L18438) that can be used to easily skip an arbitrary
