...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20654) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28314) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13438) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15788))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13524) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17303) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22630)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22651)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22622) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13961), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22531).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23411) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23417)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23310) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23315) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23319)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23324)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20657)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20660)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21545) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26918) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26534)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26646)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26656), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26651)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22531) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28526)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28542)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28454)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28420) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27039)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21616)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22531) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23063) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22531) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28907)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28997)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29036)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29052)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29076)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29007)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29076) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28997)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13938), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13865) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13865)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13897) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13897) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13897):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20552)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20558), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26633)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26634)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13835)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14344)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20666)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20669)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23792) containing an extra (hidden) path-list that
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23792) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23792) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20666)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23792) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13961) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28716) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28707) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28716), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20760) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20703) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20940))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21643)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21657)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28634) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21715)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20574) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27973) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21670) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21680) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21670),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14258).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14307).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14323) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23159), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27039) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14036) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13961)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14075)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28566) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28580)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26454)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28613), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28589)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29285) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17312) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29285) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26435) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28289) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28789) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28813) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28829) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28829) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28250)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28252)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28253)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28256)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28257)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28258)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28262)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28265)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28268)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21986) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21918) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22531) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14957) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29296) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29337) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29342) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17388) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28094) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28997) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27987) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28871) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14745)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28387) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28860) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28898) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14745)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28887) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29094) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29113) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14745)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29134) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14745)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13421) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14431) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13819) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23277) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23379) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23103) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27922)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23114) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27955)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23125) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26849)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23136) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26854)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23147) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26860) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27021)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22095) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22109) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13880) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13909) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13951) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13852) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27094), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27119) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27121)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14156) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27135) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27147) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26923) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27172) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27184)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27186)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27189)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27903) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27915)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27933) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27942) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27949)
