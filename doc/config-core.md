...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19842) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L26027) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12929) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14987))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13015) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16502) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21593)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21614)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21586) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13503), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21502).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22333) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22339)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22232) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22237) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22241)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22246)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19845)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19848)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20647) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25290) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24494)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21502) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26239)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26255)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26167)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26133) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25411)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20694)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21502) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21996) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21502) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26620)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26710)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26749)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26765)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26789)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26720)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26789) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26710)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13471), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13384) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13384)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13417) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13417) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13417):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19740)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19746), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24578)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24579)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13330)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19854)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19857)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22713) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22713) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19854)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22713) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13503) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26429) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26420) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26429), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19949) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19891) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20128))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20721)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20735)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26347) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20793)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19762) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25678) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20748) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20758) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20748),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13788).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13837).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25599), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25411) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13578) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13503)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13617)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26279) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26293)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24426)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26326), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26302)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26996) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16511) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26996) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24407) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L26002) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26502) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26526) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26542) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26542) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25963)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25965)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25966)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25969)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25970)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25971)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25975)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25978)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25981)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21063) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20996) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21502) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14129) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L27007) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L27048) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L27053) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16587) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25805) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26710) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25692) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26584) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13923)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L26100) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26573) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26611) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13923)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26600) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26807) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26826) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13923)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26848) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13923)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13314) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22199) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22301) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22036) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25628)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22047) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25660)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22058) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24755)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22069) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24760)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22080) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24766) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25393)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21172) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21186) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13399) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13436) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13492) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13346) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25466), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25491) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25493)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13686) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25507) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25519) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25295) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25544) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25556)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25558)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25561)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25614) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25622)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25638) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25647) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25654)
