...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L15693) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20536) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9910)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10971))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9981) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12489) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17253) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10341)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17920) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17926)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17820) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17825) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17829)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17834)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L15696)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L15699)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16433) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19809) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19284)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21085)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10321), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10267) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10267)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10288) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10288) will return
`0x00A0`.
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20692)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20620)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20586) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20107)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20089)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16480)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17175) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17597) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17175) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10213)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15705)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L15645)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L15651), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L15708)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18293) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18293) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15705)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18293) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10341) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L15800) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15742) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15968))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16496)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16509)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20784) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16567)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L15667) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16522) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16532) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16522),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10576).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10604).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20119), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20107) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19872) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19870)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19884), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L19920)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10399) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L10341)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10435)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20714) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20728)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19216)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20766), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20739)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21388) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12498) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21388) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19197) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20511) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L20917) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20472)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20474)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20475)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20478)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20479)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20480)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20484)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20487)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20490)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20866) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20857) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20866), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16841) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21085) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21095)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21164) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10894) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12574) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L12583) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20959) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10688)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20948) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20986) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10688)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20975) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21181) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21204) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10688)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21232) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10688)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10197) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17787)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17889)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10229) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20134) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20142)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20158) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20167) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20174)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17637) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20148)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17648) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20180)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17659) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19544)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17671) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19550) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21399) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21430) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21435) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19369)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19370)
