...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19051) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L24196) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12271) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14234))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5027)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12344) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L15752) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L20719)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L20736)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L20712) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L12781), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20628).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6306)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6305)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21440) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21446)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21340) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21345) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21349)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21354)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19054)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19057)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L19797) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L23444) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L22895)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20628) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6304)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L24408)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L24424)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L24336)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L24302) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L23565)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L19844)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20628) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21107) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20628) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L24794)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24884)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L24923)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L24939)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24963)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L24894)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24963) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24884)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4566)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L12761), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L12707) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L12707)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L12728) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L12728) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L12728):
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L22980)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L22981)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L12653)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19063)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L18988)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L18994), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19066)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21818) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21818) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19063)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21818) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L12781) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24603) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L24594) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24603), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19158) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19100) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19336))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L19860)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L19873)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L24521) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L19931)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19010) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L23847) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19886) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L19896) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19886),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13037).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13086).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23768), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L23565) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L23632) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L23630)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L23644), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L23685)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L12852) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L12781)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L12891)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L24448) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L24462)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L22827)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L24500), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L24473)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25187) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L15761) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25187) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L22808) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24171) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L24676) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L24700) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24716) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24716) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L24132)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24134)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L24135)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L24138)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24139)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L24140)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L24144)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L24147)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L24150)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20192) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4994) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13376) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L25198) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L25237) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L25242) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L15837) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L23974) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24884) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L23861) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L24758) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13170)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L24269) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24747) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L24785) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13170)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L24774) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L24981) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25003) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13170)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25031) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13170)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L12637) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21307) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21409) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L12669) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L23783) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L23791)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L23807) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L23816) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L23823)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21147) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L23797)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21158) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L23829)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21169) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23157)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21180) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23162)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21191) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L23168) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L23547)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20298) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20312) that can be used to easily skip an arbitrary
