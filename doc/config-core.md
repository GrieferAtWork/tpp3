...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14579) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19315) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9279)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10216))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9350) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11628) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16128) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9600)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L16772) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L16778)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16672) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16677) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16681)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16686)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14582)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14585)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15317) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18592) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18084)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19471)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19399)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19365) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18886)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L18868)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15364)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16050) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16449) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16050) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9576)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14591)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14531)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14537), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14594)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17139) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17139) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14591)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17139) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9600) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14686) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14628) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L14854))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15380)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15393)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19561) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15451)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14553) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15406) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15416) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15406),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9821).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9849).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L18898), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18886) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18653) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18651)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18665), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18701)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19493) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19507)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18016)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19543), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19516)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20157) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11637) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20157) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L17997) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19290) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19694) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19251)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19253)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19254)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19257)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19258)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19259)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19263)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19266)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19269)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19643) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19634) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19643), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15721) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L3756) if exactly
that happened.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19851) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L19863)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L19933) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10139) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11713) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11722) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L19757) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9933)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L19745) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L19828) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9933)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L19816) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L19950) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L19973) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9933)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20001) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9933)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9560) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16639)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L16741)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9592) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L18913) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L18921)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L18937) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L18946) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L18953)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16489) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L18927)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16500) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L18959)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16511) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18344)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16523) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18350) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20168) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20199) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20204) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18169)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18170)
