...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20337) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27834) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13369) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15471))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13455) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16986) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22201)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22222)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22193) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13941), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22107).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6594)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6593)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22973) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22979)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22872) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22877) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22881)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22886)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20340)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20343)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21142) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27080) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26084)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22107) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6592)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28046)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28062)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27974)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27940) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27201)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21189)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22107) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22636) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22107) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28431)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28521)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28560)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28576)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28600)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28531)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28600) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28521)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13909), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13822) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13822)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13855) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13855) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13855):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20235)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20241), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26168)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26169)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13766)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14324)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20349)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20352)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23354) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11632).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23354) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23354) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20349)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23354) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13941) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28236) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28227) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28236), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20444) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20386) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20623))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21216)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21230)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28154) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21288)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20257) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27485) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21243) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21253) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21243),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14238).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14287).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14303) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L27389), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27201) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14016) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13941)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14055)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28086) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28100)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26010)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28133), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28109)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28811) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16995) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28811) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25991) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27809) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28309) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28333) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28349) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28349) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27770)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27772)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27773)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27776)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27777)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27778)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27782)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27785)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27788)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21559) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21491) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22107) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14613) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28822) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28863) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28868) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17071) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27612) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28521) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27499) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28392) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14407)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27907) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28380) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28421) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14407)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28409) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28618) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28637) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14407)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28659) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14407)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13750) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22839) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22941) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22676) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27434)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22687) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27467)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22698) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26353)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22709) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26358)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22720) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26364) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27183)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21668) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21682) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13837) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13874) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13930) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13783) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27256), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27281) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27283)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14136) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27297) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27309) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27085) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27334) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27346)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27348)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27351)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27415) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27427)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27445) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27454) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27461)
