...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L15709) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20552) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9926)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10987))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9997) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12505) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17269) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10357)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17936) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17942)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17836) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17841) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17845)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17850)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L15712)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L15715)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16449) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19825) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19300)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21101)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10337), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10283) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10283)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10304) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10304) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10304):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20708)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20636)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20602) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20123)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20105)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16496)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17191) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17613) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17191) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10229)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15721)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L15661)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L15667), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L15724)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18309) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18309) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15721)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18309) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10357) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L15816) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15758) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15984))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16512)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16525)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20800) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16583)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L15683) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16538) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16548) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16538),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10592).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10620).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20135), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20123) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L19888) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L19886)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L19900), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L19936)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10415) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L10357)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10451)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20730) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20744)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19232)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20782), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20755)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21404) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12514) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21404) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19213) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20527) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L20933) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20488)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20490)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20491)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20494)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20495)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20496)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20500)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20503)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20506)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20882) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L20873) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L20882), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16857) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21101) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21111)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21180) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10910) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12590) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L12599) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20975) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10704)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20964) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21002) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10704)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20991) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21197) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21220) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10704)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21248) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10704)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10213) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17803)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17905)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10245) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20150) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20158)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20174) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20183) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20190)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17653) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20164)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17664) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20196)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17675) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19560)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17687) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19566) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21415) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21446) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21451) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19385)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19386)
