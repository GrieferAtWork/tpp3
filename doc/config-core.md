...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14857) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19604) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9411)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10366))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9482) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11884) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16406) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9736)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L17061) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L17067)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16961) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16966) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16970)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16975)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14860)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14863)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15595) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18881) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18373)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19760)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19688)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19654) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19175)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L19157)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15642)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16328) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16738) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16328) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9712)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14869)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14809)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14815), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14872)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17428) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17428) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14869)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17428) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9736) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14964) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14906) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L15132))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15658)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15671)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19852) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15729)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14831) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15684) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15694) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15684),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9971).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9999).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L19187), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L19175) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18942) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18940)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18954), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18990)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L9794) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L9736)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L9830)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19782) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19796)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18305)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19834), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19807)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20383) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11893) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20383) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18286) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19579) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19985) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19540)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19542)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19543)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19546)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19547)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19548)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19552)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19555)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19558)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19934) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19925) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19934), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15999) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L20077) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L20089)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L20159) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10289) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11969) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11978) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L20027) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10083)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L20016) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L20054) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10083)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L20043) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L20176) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20199) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10083)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20227) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10083)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9696) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16928)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L17030)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9728) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L19202) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L19210)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L19226) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L19235) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L19242)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16778) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L19216)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16789) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L19248)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16800) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18633)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16812) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18639) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20394) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20425) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20430) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18458)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18459)
