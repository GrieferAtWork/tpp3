...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19716) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25901) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12848) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14861))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12934) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16376) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21467)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21488)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21460) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13377), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21376).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6376)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6375)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22207) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22213)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22106) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22111) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22115)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22120)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19719)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19722)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20521) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25164) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24368)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21376) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6374)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26113)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26129)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26041)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26007) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25285)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20568)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21376) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21870) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21376) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26494)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26584)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26623)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26639)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26663)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26594)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26663) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26584)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13357), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13303) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13303)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13324) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13324) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13324):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19614)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19620), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24452)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24453)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13249)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19728)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19731)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22587) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22587) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19728)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22587) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13377) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26303) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26294) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26303), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19823) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19765) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20002))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20595)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20609)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26221) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20667)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19636) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25552) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20622) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20632) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20622),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13662).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13711).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25473), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25285) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13452) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13377)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13491)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26153) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26167)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24300)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26200), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26176)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26870) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16385) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26870) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24281) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25876) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26376) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26400) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26416) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26416) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25837)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25839)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25840)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25843)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25844)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25845)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25849)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25852)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25855)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20937) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20870) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21376) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14003) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26881) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26922) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26927) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16461) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25679) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26584) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25566) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26458) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13797)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25974) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26447) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26485) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13797)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26474) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26681) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26700) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13797)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26722) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13797)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13233) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22073) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22175) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13265) to quantify the
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21910) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25502)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21921) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25534)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21932) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24629)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21943) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24634)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21954) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24640) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25267)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21046) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21060) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25340), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25365) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25367)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13560) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25381) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25393) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25169) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25418) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25430)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25432)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25435)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25488) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25496)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25512) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25521) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25528)
