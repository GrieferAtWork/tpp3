...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L20723)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L20740)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L20716) that allows
...
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L20632).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L21445) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L21451)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21344) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21349) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21353)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21358)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L20632) should have support for a runtime-override
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L20632) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21111) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L20632) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L24797)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24887)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L24926)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L24942)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24966)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L24897)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24966) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24887)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21823) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21823) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19069)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L21823) contains a 4th path-list that is searched after all other paths
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24606) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L24597) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L24606), but is also able to deal with
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L24524) used during macro invocation,
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L24503), a function that is used-
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25178) to
...
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L25178) (and is also used to
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L24679) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L24703) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24719) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24719) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20196) to compare macro definitions.
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L25189) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L25228) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L25233) that causes every
...
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L23980) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L24887) will understand
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L24761) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13176)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24750) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L24788) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13176)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L24777) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L24984) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L25003) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13176)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L25025) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13176)
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21311) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L21413) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21151) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L23803)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21162) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L23835)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21173) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L23163)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21184) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L23168)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21195) +
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20302) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20316) that can be used to easily skip an arbitrary
