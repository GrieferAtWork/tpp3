...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20300) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27827) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13381) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15434))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5030)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13467) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16949) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22164)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22185)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22156) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13904), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22070).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6596)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6595)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22945) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22951)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22844) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22849) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22853)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22858)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20303)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20306)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21105) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26423) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26056)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26153)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26163), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26158)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22070) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6594)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28039)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28055)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27967)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27933) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26544)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21152)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22070) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22597) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22070) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28427)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28517)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28556)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28572)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28596)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28527)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28596) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28517)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13881), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13808) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13808)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13840) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13840) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13840):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20198)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20204), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26140)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26141)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13778)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14287)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20312)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20315)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23326) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11644).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23326) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23326) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20312)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23326) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13904) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28229) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28220) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28229), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20407) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20349) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20586))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21179)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21193)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28147) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21251)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20220) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27478) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21206) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21216) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21206),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14201).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14250).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14266) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L22693), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26544) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13979) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13904)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14018)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28079) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28093)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25982)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28126), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28102)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28807) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16958) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28807) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25963) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27802) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28302) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28326) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28342) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28342) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27763)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27765)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27766)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27769)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27770)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27771)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27775)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27778)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27781)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21522) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21454) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22070) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14575) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28818) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28859) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28864) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17034) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27605) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28517) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27492) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28388) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14370)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27900) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28373) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28417) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14370)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28405) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28614) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28633) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14370)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28655) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14370)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13762) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22811) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22913) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22637) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27427)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22648) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27460)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22659) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26354)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22670) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26359)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22681) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26365) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26526)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21631) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21645) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13823) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13852) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13894) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13795) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26599), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26624) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L26626)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14099) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26640) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L26652) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26428) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L26677) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L26689)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L26691)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L26694)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27408) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27420)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27438) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27447) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27454)
