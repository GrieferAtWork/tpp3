...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20755) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28431) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13500) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15889))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13586) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17404) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22731)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22752)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22723) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14023), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22632).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23515) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23521)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23414) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23419) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23423)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23428)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20758)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20761)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21646) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27031) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26638)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L26750)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L26760), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L26755)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22632) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28643)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28659)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28571)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28537) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27155)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21717)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22632) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23167) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22632) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29026)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29116)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29155)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29171)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29195)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29126)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29195) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29116)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14000), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13927) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13927)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13959) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13959) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13959):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20653)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20659), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26737)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26738)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13897)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14406)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20767)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20770)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23896) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11701).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23896) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23896) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20767)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23896) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14023) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L21784), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21816).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28130) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28833) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28824) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28833), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L28855) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L28849) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28833) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20861) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20804) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21041))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21744)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21758)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28751) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21816)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20675) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28090) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21771) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21781) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21771),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14320).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14369).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14385) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23263), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27155) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14098) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14023)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14137)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28683) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28697)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26558)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28730), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28706)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29404) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17413) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29404) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26539) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28406) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28908) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28932) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28948) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28948) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28367)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28369)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28370)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28373)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28374)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28375)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28379)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28382)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28385)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22087) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22019) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22632) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15058) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29415) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29456) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29461) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17489) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28211) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29116) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28104) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28990) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14846)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28504) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28979) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29017) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14846)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29006) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29213) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29232) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14846)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29253) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14846)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13483) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14493) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13881) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23381) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23483) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23207) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28039)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23218) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28072)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23229) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L26956)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23240) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L26963)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23251) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L26971) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27132)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22196) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22210) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13942) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13971) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14013) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13914) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27211), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27236) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27238)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14218) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27252) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27264) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27038) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27289) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27301)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27303)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27306)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28020) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28032)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28050) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28059) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28066)
