...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20302) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27797) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13336) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15436))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13422) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16951) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L22166)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L22187)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L22158) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13910), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L22072).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6561)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6560)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22938) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22944)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22837) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22842) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22846)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22851)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20305)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20308)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21107) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27043) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L26047)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L22072) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6559)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L28009)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L28025)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27937)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27903) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27164)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21154)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L22072) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22601) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L22072) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28390)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28480)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28519)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28535)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28559)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28490)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28559) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28480)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13878), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13791) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13791)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13824) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13824) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13824):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20200)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20206), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L26131)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L26132)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13737)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14289)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20314)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20317)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23319) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11599).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23319) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23319) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20314)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23319) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13910) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28199) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L28190) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L28199), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20409) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20351) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20588))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21181)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21195)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L28117) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21253)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20222) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27448) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21208) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21218) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21208),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14203).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14252).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14268) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L27352), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27164) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13985) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13910)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14024)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L28049) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L28063)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25973)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L28096), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L28072)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28770) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16960) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28770) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25954) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27772) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28272) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28296) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28312) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28312) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27733)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27735)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27736)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27739)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27740)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27741)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27745)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27748)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27751)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21524) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21456) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L22072) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14578) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28781) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28822) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28827) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17036) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27575) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28480) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27462) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28354) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14372)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27870) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28343) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28381) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14372)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28370) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28577) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28596) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14372)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28618) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14372)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13721) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22804) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22906) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22641) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27397)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22652) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27430)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22663) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26316)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22674) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26321)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22685) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26327) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27146)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21633) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21647) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13806) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13843) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13899) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13753) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27219), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27244) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27246)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14101) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27260) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27272) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27048) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27297) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27309)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27311)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27314)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27378) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27390)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27408) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27417) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27424)
