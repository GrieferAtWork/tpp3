...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L15811) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L20681) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10028) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11097))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4001)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L10099) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12615) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17389)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17395)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17381) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10459), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17303).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L5260)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L5259)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18054) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18060)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L17954) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L17959) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L17963)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L17968)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L15814)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L15817)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16561) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L19943) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19418)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21230)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10439), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10385) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10385)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10406) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10406) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10406):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L20837)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L20765)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L20731) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20241)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20223)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16608)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17303) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L17731) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17303) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10331)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15823)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L15763)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L15769), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L15826)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18427) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18427) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L15823)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18427) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10459) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L15918) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L15860) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16096))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16624)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16637)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L20929) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L16695)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L15785) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20332) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16650) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16660) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16650),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L10702).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L10730).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20253), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20241) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20006) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20004)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20018), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20054)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10517) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10459)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10556)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L20859) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L20873)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19350)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L20911), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L20884)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21533) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12624) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21533) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19331) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20656) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21062) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20617)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20619)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20620)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20623)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20624)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20625)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20629)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20632)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20635)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21011) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21002) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21011), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L16969) to compare macro definitions.
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21140)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21230)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21269)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21285)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21309)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21240)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21309) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11020) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L12700) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20459) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21230) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20346) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21104) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10814)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21093) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21131) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10814)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21120) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21327) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21349) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10814)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21377) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L10814)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10315) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L17921) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18023) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10347) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20268) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20276)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20292) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20301) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20308)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L17771) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20282)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L17782) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20314)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L17793) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L19678)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L17805) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L19684) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21544) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21575) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21580) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19503)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19504)
