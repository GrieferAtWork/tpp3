...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14615) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L19351) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9301)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10252))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9372) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11664) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L16164) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9622)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L16808) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L16814)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16708) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16713) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16717)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16722)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14618)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14621)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15353) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18628) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L18120)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L3429)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L19507)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L19435)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L19401) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18922)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L18904)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15400)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L16086) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16485) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L16086) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9598)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14627)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14567)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14573), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14630)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17175) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17175) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14627)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L17175) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9622) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14722) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14664) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L14890))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15416)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15429)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19597) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15487)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14589) file encoding
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15442) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L15452) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L15442),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9857).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9885).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L18934), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18922) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18689) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18687)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18701), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18737)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L9680) centered around builtin [`tpp_string`](../src/tpp-amalgamation.h#L9622)
...
```c
(TPP_PROFILE == TPP_PROFILE_ALL) || TPP_HAVE_MACRO___TPP_LOAD_FILE || 1
```
</details>

## TPP_HAVE_STRING_BUILDER_TRYALLOC

Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L9716)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L19529) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L19543)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L18052)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19579), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19552)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20193) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11673) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L20193) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L18033) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L19326) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19730) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L19287)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L19289)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L19290)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L19293)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L19294)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L19295)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L19299)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L19302)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L19305)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19679) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19670) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19679), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15757) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L3761) if exactly
that happened.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19887) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L19899)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L19969) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L10175) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11749) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11758) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L19793) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9969)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L19781) to parse an integer
...
```c
TPP_HAVE_TPP_TOK_INT && (TPP_HAVE_LEXER_DECODEINT_EXPR || TPP_HAVE_CPP_LINE || TPP_HAVE_CPP_DIGIT_LINE || TPP_HAVE_MACRO___TPP_STR_PACK || TPP_HAVE_MACRO___TPP_RANDOM || TPP_HAVE_MACRO___TPP_STR_SUBSTR || TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING)
```
</details>
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L19864) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9969)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L19852) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L19986) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L20009) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9969)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L20037) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9969)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9582) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16675)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L16777)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9614) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L18949) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L18957)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L18973) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L18982) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L18989)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L16525) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L18963)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L16536) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L18995)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L16547) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L18380)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L16559) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L18386) that can be used to
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L20204) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L20235) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L20240) that causes every
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L18205)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L18206)
