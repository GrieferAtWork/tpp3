...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L21376) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L29198) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13893) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L16406))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13979) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17942) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L23430)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L23451)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L23422) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14440), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L23331).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6857)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6856)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L24214) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L24220)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24113) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24118) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L24122)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L24127)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L21385)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L21396)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L22335) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27770) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L27337)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L27449)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L27459), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L27454)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L23331) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6855)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29410)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29426)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L29338)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L29304) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27894)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L22406)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L23331) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23866) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L23331) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29830)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29946)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29985)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L30001)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30025)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29956)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30025) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29946)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14393), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L14320) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L14320)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14352) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L14352) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14352):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L21272)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L21278), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L27436)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L27437)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L14290)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14831)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21413)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21422)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L24595) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L12036).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24595) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24595) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21413)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24595) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14440) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L22474), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22506).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28894) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29637) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29628) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29637), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29659) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29653) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29637) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L21542) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L21485) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21726))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L22433)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L22447)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29555) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22506)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L21294) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28850) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22461) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L22471) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22461),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14745).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14794).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14810) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23962), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27894) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14519) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14440)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14559)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29450) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29464)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L27257)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29497), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29473)
...
Enable support for [`tpp_lexer_peek_raw()`](../src/tpp-amalgamation.h#L29534), which is a convenience wrapper
around [`tpp_lexer_seek_backup`](../src/tpp-amalgamation.h#L29009) and [`tpp_lexer_manualpopfile_start(self)`](../src/tpp-amalgamation.h#L29134) to
get a peek at the next upcoming token, as returned by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28976)

With this in mind, this function behaves very similar to [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29497),
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30234) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17951) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L30234) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L27238) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29173) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29712) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29736) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29752) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29752) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L29134)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L29136)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L29137)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L29140)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L29141)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L29142)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L29146)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L29149)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L29152)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22783) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22715) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L23331) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15556) to construct the result
...
Provide a function [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15566) to construct what
...
Provide a function [`tpp_intvalue_printrepr()`](../src/tpp-amalgamation.h#L15244) used to implement:

- [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15556) (see [`TPP_HAVE_EXPR_VALUE_PRINTREPR`](#tpp_have_expr_value_printrepr))
- [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15566) (see [`TPP_HAVE_EXPR_VALUE_PRINTSTR`](#tpp_have_expr_value_printstr))
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L30245) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L30286) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L30291) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L18031) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28976) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29946) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28864) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29794) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L29271) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29783) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29821) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29810) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L30043) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L30062) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L30083) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15344)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13876) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14918) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L14274) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L24080) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L24182) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23906) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28799)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23917) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28832)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23928) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27693)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23939) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27700)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23950) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27708) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27871)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22892) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22906) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L14335) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L14364) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14406) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L14307) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27953), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27983) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27981)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14640) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L28011) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L28023) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27777) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L28048) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L28060)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L28062)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L28065)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28780) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28792)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28810) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28819) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28826)
...
[`tpp_string_newempty()`](../src/tpp-amalgamation.h#L14506) is implemented in terms of a single, global "empty" string object.
...
- When this (and [`TPP_HAVE_KEYWORD_ASSTRING`](#tpp_have_keyword_asstring)) is disabled, then [`tpp_refcnt`](../src/tpp-amalgamation.h#L6117) can be used
  by the implementation of [`tpp_string`](../src/tpp-amalgamation.h#L14440), rather than [`tpp_refcnt_atomic`](../src/tpp-amalgamation.h#L6235).
