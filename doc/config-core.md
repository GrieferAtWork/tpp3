...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20196) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27561) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13241) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15341))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L5022)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13327) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16856) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21956)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21977)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21948) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13815), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21862).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6553)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6552)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22702) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22708)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22601) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22606) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22610)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22615)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20199)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20202)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L21001) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26807) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L25811)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21862) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6551)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27773)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L27789)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27701)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27667) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26928)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L21048)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21862) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22365) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21862) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L28154)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28244)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L28283)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28299)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28323)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L28254)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28323) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28244)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4561)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13783), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13696) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13696)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13729) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13729) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13729):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20094)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20100), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L25895)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L25896)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13642)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14194)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20208)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20211)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L23083) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11509).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23083) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23083) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20208)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L23083) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13815) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27963) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L27954) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27963), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20303) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20245) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20482))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L21075)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L21089)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L27881) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L21147)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20116) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L27212) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21102) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L21112) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L21102),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14108).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14157).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14173) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L27116), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26928) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13890) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13815)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13929)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L27813) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L27827)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25737)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L27860), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L27836)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28534) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16865) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28534) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25718) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27536) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L28036) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L28060) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28076) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L28076) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27497)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27499)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27500)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27503)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27504)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27505)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27509)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27512)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27515)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21418) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4989) if exactly
that happened.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21350) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21862) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14483) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28545) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28586) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28591) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16941) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27339) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28244) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L27226) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L28118) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14277)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27634) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L28107) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L28145) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14277)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L28134) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28341) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28360) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14277)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28382) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14277)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13626) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22568) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22670) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22405) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L27161)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22416) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L27194)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22427) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L26080)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22438) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L26085)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22449) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L26091) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26910)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21527) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21541) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13711) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13748) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13804) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13658) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26983), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27008) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27010)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14006) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27024) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27036) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26812) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27061) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27073)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27075)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27078)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27142) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27154)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27172) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27181) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27188)
