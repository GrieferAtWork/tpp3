...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L17119) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L22062) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11205) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12361))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4695)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11278) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L13879) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L18791)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L18797)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L18783) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L11715), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L18700).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L5962)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L5961)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L19428) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L19434)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L19328) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L19333) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L19337)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L19342)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L17122)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L17125)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L17869) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L21324) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L20797)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L22218)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L22146)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L22112) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21622)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L17916)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L18700) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L19105) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L18700) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L22540)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22630)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L22669)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L22685)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22709)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L22640)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L22709) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22630)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4234)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L11695), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L11641) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L11641)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11662) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L11662) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11662):
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L20882)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L20883)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L11587)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17131)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L17071)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L17077), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L17134)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19806) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19806) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L17131)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L19806) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L11715) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22392) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L22383) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L22392), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L17226) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L17168) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L17404))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L17932)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L17945)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L22310) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L18003)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L17093) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L21713) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17958) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17968) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17958),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11959).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11994).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L21634), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L21622) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L21387) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L21385)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L21399), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L21435)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L11774) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L11715)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L11813)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L22240) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L22254)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L20729)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L22292), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L22265)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22933) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L13888) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L22933) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L20710) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L22037) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L22442) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22458) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L22458) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
for keywords where this property hasn't been explicitly defined by [`TPP_KWD_IS_IDENTIFIER()`](../src/tpp-amalgamation.h#L235),
and also don't have macro expansions as per [`TPP_PREDEFINED_MACRO()`](../src/tpp-amalgamation.h#L268).
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L21998)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L22000)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L22001)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L22004)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L22005)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L22006)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L22010)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L22013)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L22016)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L18277) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4662) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12284) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L22944) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L22980) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L22985) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13964) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L21840) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L22630) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L21727) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L22504) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12078)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L22493) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L22531) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12078)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L22520) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L22727) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L22749) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12078)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L22777) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12078)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L11571) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L19295) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L19397) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L11603) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L21649) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L21657)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L21673) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L21682) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L21689)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L19145) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L21663)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L19156) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L21695)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L19167) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L21059)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L19179) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L21065) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L21604)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L18410) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L18424) that can be used to easily skip an arbitrary
