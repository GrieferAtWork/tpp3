...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16161) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L21062) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10375) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11447))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12965) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17817)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17823)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17809) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10808), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17731).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18435) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18441)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18335) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18340) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18344)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18349)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16164)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16167)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16911) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20324) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19799)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21611)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10788), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10734) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10734)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10755) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10755) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10755):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21218)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21146)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21112) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20622)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16958)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17731) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18112) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17731) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21521)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21611)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21650)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21666)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21690)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21621)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21690) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19884)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19885)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10680)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16173)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16113)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16119), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16176)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18808) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18808) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16173)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18808) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10808) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21392) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21383) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21392), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16268) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16210) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16446))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16974)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16987)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21310) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L17045)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16135) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20713) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17000) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L17010) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L17000),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11052).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11080).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20634), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20622) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20387) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20385)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20399), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20435)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10867) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10808)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10906)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21240) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21254)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19731)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21292), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21265)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21914) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12974) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21914) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19712) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L21037) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21443) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20998)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L21000)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L21001)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L21004)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L21005)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L21006)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L21010)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L21013)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L21016)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17319) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11370) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21925) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21961) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21966) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13050) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20840) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21611) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20727) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21485) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11164)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21474) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21512) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11164)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21501) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21708) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21730) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11164)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21758) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11164)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10664) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18302) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18404) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10696) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20649) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20657)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20673) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20682) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20689)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18152) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20663)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18163) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20695)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18174) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L20059)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18186) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L20065) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20604)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L17452) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L17466) that can be used to easily skip an arbitrary
