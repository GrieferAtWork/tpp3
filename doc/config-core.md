...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19986) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L26203) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13073) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15131))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13159) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16646) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21746)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21767)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21738) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13647), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21652).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22492) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22498)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22391) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22396) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22400)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22405)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19989)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19992)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20791) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25449) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24653)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21652) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L26415)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L26431)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L26343)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L26309) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25570)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20838)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21652) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22155) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21652) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26796)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26886)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26925)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26941)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26965)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26896)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26965) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26886)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13615), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13528) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13528)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13561) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13561) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13561):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19884)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19890), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24737)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24738)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13474)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19998)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20001)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22872) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22872) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19998)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22872) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13647) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26605) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26596) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26605), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20093) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20035) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20272))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20865)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20879)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26523) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20937)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19906) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25854) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20892) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20902) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20892),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13932).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13981).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25758), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25570) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13722) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13647)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13761)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26455) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26469)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24585)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26502), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26478)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27176) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16655) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L27176) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24566) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L26178) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26678) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26702) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26718) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26718) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L26139)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L26141)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L26142)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L26145)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L26146)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L26147)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L26151)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L26154)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L26157)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21208) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21140) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21652) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14273) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L27187) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L27228) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L27233) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16731) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25981) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26886) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25868) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26760) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14067)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L26276) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26749) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26787) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14067)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26776) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26983) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L27002) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14067)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L27024) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14067)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13458) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22358) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22460) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22195) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25803)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22206) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25836)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22217) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24914)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22228) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24919)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22239) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24925) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25552)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21317) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21331) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13543) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13580) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13636) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13490) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25625), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25650) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25652)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13830) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25666) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25678) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25454) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25703) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25715)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25717)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25720)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25784) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25796)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25814) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25823) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25830)
