...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L20028) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L27273) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13115) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L15173))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13201) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16688) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21788)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21809)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21780) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13689), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21694).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22534) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22540)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22433) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22438) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L22442)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L22447)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L20031)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L20034)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20833) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L26519) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L25523)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21694) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L27485)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L27501)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L27413)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L27379) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26640)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20880)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21694) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L22197) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21694) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L27866)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L27956)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L27995)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L28011)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28035)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L27966)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L28035) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L27956)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13657), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13570) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13570)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13603) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13603) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13603):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19926)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19932), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L25607)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L25608)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13516)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20040)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20043)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22914) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22914) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L20040)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22914) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13689) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27675) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L27666) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L27675), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L20135) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L20077) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L20314))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20907)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20921)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L27593) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20979)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19948) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L26924) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20934) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20944) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20934),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13974).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14023).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L26828), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L26640) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13764) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13689)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13803)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L27525) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L27539)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L25455)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L27572), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L27548)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28246) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16697) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L28246) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L25436) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L27248) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L27748) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L27772) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27788) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L27788) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L27209)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L27211)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L27212)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L27215)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L27216)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L27217)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L27221)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L27224)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L27227)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L21250) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L21182) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21694) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L14315) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L28257) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L28298) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L28303) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16773) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L27051) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L27956) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L26938) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L27830) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14109)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L27346) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L27819) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L27857) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14109)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L27846) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L28053) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L28072) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14109)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L28094) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L14109)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13500) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L22400) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22502) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L22237) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L26873)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L22248) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L26906)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L22259) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L25784)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L22270) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L25789)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L22281) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L25795) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L26622)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L21359) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L21373) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L13585) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L13622) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L13678) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13532) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26695), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26720) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L26722)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13872) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26736) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L26748) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L26524) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L26773) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L26785)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L26787)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L26790)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L26854) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L26866)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L26884) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L26893) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L26900)
