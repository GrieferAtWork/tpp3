...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L18200) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L23245) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11469) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13442))
...
- Automatic detection of `utf-8`, `utf-8-bom`, `utf-16[le/be]`, `utf-32[le/be]`
  ...
  byte sequence, at which point it will emit a warning [`TPP_W_ILLEGAL_UTF8_SEQUENCE`](../src/tpp-amalgamation.h#L4751)
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L11542) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L14960) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L19885)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L19902)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L19878) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L11979), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L19794).
...
- [`TPP_CONF_EXT0`](../src/tpp-amalgamation.h#L6024)
- [`TPP_CONF_EXT1`](../src/tpp-amalgamation.h#L6023)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L20606) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L20612)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L20506) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L20511) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L20515)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L20520)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L18203)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L18206)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L18950) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L22507) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L21975)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L19794) should have support for a runtime-override
...
hasn't been hard-disabled (as per [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6022)):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L23401)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L23329)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L23295) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L22805)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L18997)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L19794) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L20273) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L19794) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L23766)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L23856)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L23895)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L23911)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L23935)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L23866)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L23935) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L23856)
...
- When a multi-line string is encountered, emit a
  warning [`TPP_W_STRING_CONTINUED_AFTER_LINEFEED`](../src/tpp-amalgamation.h#L4290)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L11959), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L11905) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L11905)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11926) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L11926) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L11926):
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L22060)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L22061)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L11851)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18212)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L18152)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L18158), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L18215)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L20984) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L20984) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L18212)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L20984) contains a 4th path-list that is searched after all other paths
...
```c
TPP_HAVE_INCLUDE_STACK && (TPP_HAVE_PROFILE_ALL || ((TPP_PROFILE != TPP_PROFILE_MINIMAL) && TPP_HAVE_SEARCH_SYSTEM_INCLUDE_PATH))
```
</details>
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L11979) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L23575) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L23566) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L23575), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L18307) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L18249) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L18485))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L19013)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L19026)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L23493) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L19084)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L18174) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L22896) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19039) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L19049) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L19039),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L12235).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L12270).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L22817), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L22805) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L22570) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L22568)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L22582), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L22618)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L12050) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L11979)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L12089)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L23423) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L23437)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L21907)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L23475), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L23448)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24159) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L14969) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L24159) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L21888) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L23220) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L23648) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L23672) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L23688) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L23688) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L23181)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L23183)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L23184)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L23187)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L23188)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L23189)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L23193)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L23196)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L23199)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L19358) to compare macro definitions.
...
this function is used to only empty [`TPP_W_REDEFINE_MACRO`](../src/tpp-amalgamation.h#L4718) if exactly
that happened.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L12560) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L24170) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L24209) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L24214) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L15045) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L23023) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L23856) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L22910) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L23730) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12354)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L23719) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L23757) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12354)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L23746) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L23953) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L23975) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12354)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L24003) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L12354)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L11835) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L20473) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L20575) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L11867) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L22832) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L22840)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L22856) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L22865) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L22872)
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L20313) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L22846)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L20324) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L22878)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L20335) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L22237)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L20346) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L22242)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L20357) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L22248) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L22787)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L19464) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L19478) that can be used to easily skip an arbitrary
