...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L16120) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L21021) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10336) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L11406))
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L12924) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L17776)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L17782)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L17768) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L10767), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L17690).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L18394) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L18400)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L18294) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L18299) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L18303)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L18308)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L16123)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L16126)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L16870) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L20283) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L19758)
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21570)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L10747), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L10693) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L10693)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10714) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L10714) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L10714):
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L21177)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L21105)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L21071) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20581)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L20563)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L16917)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L17690) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L18071) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L17690) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L21480)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21570)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21609)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L21625)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21649)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L21580)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21649) to speed up decoding of certain kinds
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L19843)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L19844)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L10639)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16132)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L16072)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L16078), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L16135)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18767) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18767) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L16132)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L18767) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L10767) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21351) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L21342) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L21351), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L16227) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L16169) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L16405))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L16933)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L16946)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L21269) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L17004)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L16094) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L20672) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16959) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L16969) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L16959),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L11011).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L11039).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L20593), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L20581) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L20346) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L20344)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L20358), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L20394)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L10826) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L10767)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L10865)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L21199) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L21213)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L19690)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L21251), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L21224)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21873) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L12933) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L21873) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L19671) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20996) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L21402) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L20957)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L20959)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L20960)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L20963)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L20964)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L20965)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L20969)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L20972)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L20975)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L17278) to compare macro definitions.
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L11329) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L21884) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L21920) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L21925) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L13009) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20799) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L21570) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L20686) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L21444) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11123)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21433) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L21471) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11123)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L21460) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L21667) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L21689) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11123)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L21717) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L11123)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L10623) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L18261) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L18363) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L10655) to quantify the
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L20608) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L20616)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L20632) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L20641) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L20648)
...
Provide a function [`tpp_keywords_undefall()`](../src/tpp-amalgamation.h#L18111) + [`tpp_lexer_undefall()`](../src/tpp-amalgamation.h#L20622)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L18122) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L20654)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L18133) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L20018)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L18145) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L20024) that can be used to
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L17411) that can be used to easily skip an arbitrary
