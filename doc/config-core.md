...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L14414) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L18804) & friends can be used to force calls to become
blocking, even when enabled for the current file (s.a. [`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L9114)
and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L10051))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L9185) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L11463) to get the API name of a (non-keyword) token ID
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L15939) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L9435)
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L16511) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L16517)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L16411) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L16416) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L16420)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L16425)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L14417)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L14420)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L15150) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L18153) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L17734)
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L18960)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L18888)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L18854) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18448)
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L18430)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L15197)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L15861) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L16238) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L15861) structure). This is also needed
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L9411)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14426)
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L14366)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L14372), which is
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L14429)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16874) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16874) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L14426)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L16874) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L9435) can be incref'd, whereas `char`
must be hard-copied.
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L14521) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L14463) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L14686))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L15213)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L15226)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L19050) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L15262)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L14388) file encoding
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L9656).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L9684).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L18460), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L18448) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L18214) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L18212)
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L18226), a function that lets you directly
initialize the lexer by passing in a filename that should be opened as input.

When [`TPP_HAVE_INCLUDE_STACK`](#tpp_have_include_stack) is enabled, this also enables support for [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L18262)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L18982) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L18996)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L17656)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L19032), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L19005)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L19627) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L11472) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L19627) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L17648) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L18779) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L19183) to check
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L18740)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L18742)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L18743)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L18746)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L18747)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L18748)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L18752)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L18755)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L18758)
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19132) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L19123) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L19132), but is also able to deal with
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L15532) to compare macro definitions.
...
Provide a function [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19340) to decode the data contained within strings
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L19352)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L19422) to speed up decoding of certain kinds
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L9974) to construct the result
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L11548) to perform `\`-escaping of arbitrary data
...
Provide a function [`tpp_token_require_whitespace()`](../src/tpp-amalgamation.h#L11557) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L19246) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9768)
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L19234) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L19317) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9768)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L19305) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L19439) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L19462) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9768)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L19490) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L9768)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L9395) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L16378)
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L16480)
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L9427) to quantify the
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L19638) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L19669) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L19674) that causes every
