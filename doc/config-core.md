...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L19584) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L25763) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L12772) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L14766))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L12858) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16281) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L21332)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L21353)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L21325) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L13301), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L21241).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L22072) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L22078)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21971) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21976) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L21980)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L21985)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L19587)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L19590)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L20387) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L25026) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L24230)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L21241) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L25975)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L25991)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L25903)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L25869) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25147)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L20434)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L21241) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L21735) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L21241) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L26356)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26446)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L26485)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L26501)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26525)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L26456)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L26525) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26446)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L13281), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L13227) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L13227)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13248) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L13248) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L13248):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L19519)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L19525), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L24314)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L24315)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L13173)
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19596)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19599)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22452) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22452) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L19596)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L22452) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L13301) can be incref'd, whereas `char`
must be hard-copied.
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26165) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L26156) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L26165), but is also able to deal with
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L19691) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L19633) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L19870))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L20461)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L20475)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L26083) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L20533)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L19541) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L25414) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20488) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L20498) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L20488),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L13569).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L13618).
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L25335), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L25147) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Enable support for [`tpp_lexer_initfile_io()`](../src/tpp-amalgamation.h#L25190) and [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25188)
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L13376) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L13301)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L13415)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L26015) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L26029)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L24162)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L26062), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L26038)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26730) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L16290) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L26730) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L24143) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L25738) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L26238) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L26262) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26278) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L26278) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L25699)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L25701)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L25702)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L25705)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L25706)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L25707)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L25711)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L25714)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L25717)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L20802) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L20735) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L21241) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L13908) to construct the result
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L26741) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L26782) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L26787) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16366) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L25541) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26446) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L25428) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L26320) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13702)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L25836) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L26309) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L26347) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13702)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L26336) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L26543) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L26562) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13702)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L26584) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L13702)
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L13157) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L21938) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L22040) that does fuzzy matching to find
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L13189) to quantify the
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L21775) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L25364)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L21786) + [`tpp_lexer_unassertall2()`](../src/tpp-amalgamation.h#L25396)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L21797) + [`tpp_lexer_kwds_resetflags()`](../src/tpp-amalgamation.h#L24491)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L21808) + [`tpp_lexer_kwds_resetfeatures()`](../src/tpp-amalgamation.h#L24496)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L21819) +
[`tpp_lexer_kwds_resetcounters()`](../src/tpp-amalgamation.h#L24502) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L25129)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L20911) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L20925) that can be used to easily skip an arbitrary
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25202), a function that lets you directly
...
```c
(TPP_HAVE_LEXER_OPENFILE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)) || TPP_HAVE_CLI_DASH_INCLUDE
```
</details>

## TPP_HAVE_LEXER_PUSHFILE_IO

Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25227) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L25229)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L13484) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25243) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L25280) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L25292)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L25294)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L25297)
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L25255) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L25031) object onto the lexer's `#include`-stack.
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25350) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25358)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25374) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25383) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25390)
