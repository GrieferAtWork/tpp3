...
by setting the file's [`TPP_FILE_FLAGS_NONBLOCK`](../src/tpp-amalgamation.h#L21057) flag. Also: calls made to
[`tpp_lexer_yield_blocking()`](../src/tpp-amalgamation.h#L28834) & friends can be used to force calls to become
blocking, even when the associated file is confirmed as non-blocking (s.a.
[`TPP_EWOULDBLOCK`](../src/tpp-amalgamation.h#L13683) and [`TPP_TOK_EWOULDBLOCK`](../src/tpp-amalgamation.h#L16091))
...
Provide a function [`tpp_strerror()`](../src/tpp-amalgamation.h#L13769) to get a description of a given `tpp_errno` error code
...
Provide a function [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17627) to get the API name of a (non-keyword) token ID
...
**Getter**: [`tpp_keyword_getuserdata(keyword)`](../src/tpp-amalgamation.h#L23101)<br/>
**Setter**: [`tpp_keyword_setuserdata(keyword, v)`](../src/tpp-amalgamation.h#L23122)
...
Provide support for [`tpp_keyword_asstring()`](../src/tpp-amalgamation.h#L23093) that allows
keywords to be binary-compatible with [`tpp_string`](../src/tpp-amalgamation.h#L14206), at the
expense of adding an (otherwise unused) reference counter
field to [`tpp_keyword`](../src/tpp-amalgamation.h#L23002).
...
Support for: [`tpp_warning_ofnumber()`](../src/tpp-amalgamation.h#L23885) and [`tpp_warning_getnumbers()`](../src/tpp-amalgamation.h#L23891)
...
Support for: [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23784) (else: only [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23789) is available)
...
Support for: [`TPP_WSTATE_SUPPRESS`](../src/tpp-amalgamation.h#L23793)
...
Support for: [`TPP_WSTATE_DEFAULT`](../src/tpp-amalgamation.h#L23798)
...
Enable support for [`TPP_FILE_FLAGS_NOCLOSE`](../src/tpp-amalgamation.h#L21066)
...
Enable support for [`TPP_FILE_FLAGS_NOKWD`](../src/tpp-amalgamation.h#L21077)
...
Speed up calls to [`tpp_file_getlcinfo()`](../src/tpp-amalgamation.h#L22009) by caching the last-read
...
Provide a function [`tpp_lexer_copy()`](../src/tpp-amalgamation.h#L27426) that can be used to duplicate a lexer.
...
actually used for anything, but can be read using [`tpp_lexer_getwarningcount()`](../src/tpp-amalgamation.h#L27008)
...
- **Getter**: [`tpp_lexer_getuserpwd()`](../src/tpp-amalgamation.h#L27120)
- **Setter**: [`tpp_lexer_setuserpwd()`](../src/tpp-amalgamation.h#L27130), [`tpp_lexer_setuserpwd_inherited()`](../src/tpp-amalgamation.h#L27125)
...
Controls if [`tpp_keyword`](../src/tpp-amalgamation.h#L23002) should have support for a runtime-override
...
Provide a function [`tpp_lexer_open_include_string()`](../src/tpp-amalgamation.h#L29046)
...
Provide a function [`tpp_lexer_open_embed_string()`](../src/tpp-amalgamation.h#L29062)
...
Provide a function [`tpp_lexer_decode_include_string()`](../src/tpp-amalgamation.h#L28974)
...
Provide a function [`tpp_lexer_yield_include_string()`](../src/tpp-amalgamation.h#L28940) to
...
Enable support for [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27550)
...
Provide a function [`tpp_file_getrealfilenamekwd()`](../src/tpp-amalgamation.h#L22080)
...
Enable support for TPP generating new [`tpp_keyword`](../src/tpp-amalgamation.h#L23002) definitions
on-the-fly, as keywords are parsed (the first time any unique
keyword is parsed, [`tpp_keywords_newkeyword()`](../src/tpp-amalgamation.h#L23537) is used to give
it a unique ID and [`tpp_keyword`](../src/tpp-amalgamation.h#L23002) structure). This is also needed
...
- [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29429)
- [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29545)
- [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29584)
- [`tpp_lexer_parsestring()`](../src/tpp-amalgamation.h#L29600)
- [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29624)
...
Provide an optional performance-optimization flag [`TPP_LEXER_PARSESTRING_FLAG_ALLOWTEMPS`](../src/tpp-amalgamation.h#L29555)
that may be passed to [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L29624) to speed up decoding of certain kinds
...
Enable support for large (> 1 byte) character constants in [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29545)
...
Enable API support for [`tpp_decode_named_escape()`](../src/tpp-amalgamation.h#L14183), which can be used to
...
Provide a function [`tpp_xml_entity_lookup()`](../src/tpp-amalgamation.h#L14110) that can be used to lookup
a XML entity given its name. e.g. [`tpp_xml_entity_lookup("Agrave", true)`](../src/tpp-amalgamation.h#L14110)
will return `0x00C0`.
...
Provide a function [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14142) that can
be used to lookup a unicode character given its name. e.g.
[`tpp_unicode_byname_lookup("NO-BREAK SPACE")`](../src/tpp-amalgamation.h#L14142) will return
`0x00A0`.
...
Other extensions that affect the behavior of [`tpp_unicode_byname_lookup()`](../src/tpp-amalgamation.h#L14142):
...
Enable support for [`TPP_FILE_KIND_SUBTEXT`](../src/tpp-amalgamation.h#L20953)
...
Enable support for [`TPP_FILE_KIND_DUMMY`](../src/tpp-amalgamation.h#L20959), which is
...
**Getter**: [`tpp_lexer_getfileandlineformat(lexer)`](../src/tpp-amalgamation.h#L27107)<br/>
**Setter**: [`tpp_lexer_setfileandlineformat(lexer, format)`](../src/tpp-amalgamation.h#L27108)
...
Provide an API function [`tpp_unicode_writeutf8()`](../src/tpp-amalgamation.h#L14080)
...
defined will the *actual* current time (~ala [`tpp_time_now()`](../src/tpp-amalgamation.h#L14589)) be queried and
...
Enable support for [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21094)
...
Enable support for [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21103)
...
Ensure support for [`tpp_include_paths`](../src/tpp-amalgamation.h#L24266) containing an extra (hidden) path-list that
is lazily populated the first time paths are searched, using a set of environment
variables configured by [`TPP_CONFIG_INCLUDE_PATH_ENVIRON`](../src/tpp-amalgamation.h#L11858).
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24266) contains a 2nd path-list that is only searched during `"`-strings
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24266) contains a 3rd path-list whose files are treated as [`TPP_FILE_FLAGS_SYSHDR`](../src/tpp-amalgamation.h#L21094)
...
[`tpp_include_paths`](../src/tpp-amalgamation.h#L24266) contains a 4th path-list that is searched after all other paths
...
pushed/popped, since [`tpp_string`](../src/tpp-amalgamation.h#L14206) can be incref'd, whereas `char`
must be hard-copied.
...
in [`tpp_lcinfo_ex`](../src/tpp-amalgamation.h#L22147), as returned by [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22179).
...
Provide a function [`tpp_lexer_readunichar()`](../src/tpp-amalgamation.h#L28530) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29236) that can be used
...
Provide a function [`tpp_lexer_seekpp_rparen_ex()`](../src/tpp-amalgamation.h#L29227) that is pretty much
the same as [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29236), but is also able to deal with
...
Provide a function [`tpp_lexer_seekpp_rparen_exact()`](../src/tpp-amalgamation.h#L29258) (and
[`tpp_lexer_seekpp_rparen_exact_ex()`](../src/tpp-amalgamation.h#L29252) if [`TPP_HAVE_LEXER_SEEKPP_RPAREN_EX`](#tpp_have_lexer_seekpp_rparen_ex)
is also enabled) that wraps [`tpp_lexer_seekpp_rparen()`](../src/tpp-amalgamation.h#L29236) whilst ensuring that
...
Enable support for [`tpp_file`](../src/tpp-amalgamation.h#L21223) keeping track of the state of active `#ifdef` directives
via an embedded [`tpp_ifdef_stack`](../src/tpp-amalgamation.h#L21166) strcture (accessible via [`tpp_file_getifdef()`](../src/tpp-amalgamation.h#L21403))
...
Enable support for [`tpp_file_setfilename()`](../src/tpp-amalgamation.h#L22107)
...
Enable support for [`tpp_file_setline()`](../src/tpp-amalgamation.h#L22121)
...
Keep track of the original [`tpp_lexer_arginfo`](../src/tpp-amalgamation.h#L29154) used during macro invocation,
in order to improve [`tpp_file_getlcinfo_ex()`](../src/tpp-amalgamation.h#L22179)'s `tlcix_proj*` return values,
...
Provide a special [`TPP_FILE_ENCODING_EMBED`](../src/tpp-amalgamation.h#L20975) file encoding
...
Provide an API [`tpp_lexer_nextrand()`](../src/tpp-amalgamation.h#L28486) that can be used to generate random
...
Provide an API [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22134) that can be used to calculate a hash
...
Provide an API [`tpp_file_getfullhash()`](../src/tpp-amalgamation.h#L22144) that behaves similar to [`tpp_file_gethash()`](../src/tpp-amalgamation.h#L22134),
...
Enable support for [`tpp_io_compare_mtime()`](../src/tpp-amalgamation.h#L14503).
...
Enable support for [`tpp_io_normalize_filename()`](../src/tpp-amalgamation.h#L14552).
...
Provide a function [`tpp_io_withenv()`](../src/tpp-amalgamation.h#L14568) that can be used to
...
Enable support for [`tpp_joinpath()`](../src/tpp-amalgamation.h#L23633), a wrapper around another internal function
used to implement [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27550) (see [`TPP_HAVE_LEXER_OPENFILE`](#tpp_have_lexer_openfile)) and is also
...
Provide an API [`tpp_string_builder`](../src/tpp-amalgamation.h#L14281) centered around building [`tpp_string`](../src/tpp-amalgamation.h#L14206)
...
Provide a function [`tpp_string_builder_tryalloc()`](../src/tpp-amalgamation.h#L14320)
...
Enable support for [`tpp_lexer_skip()`](../src/tpp-amalgamation.h#L29086) and [`tpp_lexer_require()`](../src/tpp-amalgamation.h#L29100)
...
Enable support for storing a time value in [`tpp_lexer`](../src/tpp-amalgamation.h#L26928)
...
Enable support for [`tpp_lexer_tryskip_raw()`](../src/tpp-amalgamation.h#L29133), a function that is used-
...
as expected). It also offers a flag [`TPP_LEXER_TRYSKIP_RAW_FLAG_INCLPREV`](../src/tpp-amalgamation.h#L29109)
...
Provide a function [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29833) to
...
Provide a function [`tpp_reprtokenid()`](../src/tpp-amalgamation.h#L17636) that does the
same as [`tpp_lexer_reprtokenid()`](../src/tpp-amalgamation.h#L29833) (and is also used to
...
Provide a lexer state flag [`TPP_LEXER_STATE_FLAG_ALLTOKENS`](../src/tpp-amalgamation.h#L26909) that forces
[`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L28809) to always re-emit *all* tokens (rather than skip
...
Provide a function [`tpp_lexer_getkeywordfeature()`](../src/tpp-amalgamation.h#L29311) to determine
...
Provide a function [`tpp_lexer_getkeyworddefined()`](../src/tpp-amalgamation.h#L29335) to check
...
Provide a function [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29351) to check if
...
Default return value for [`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29351) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](#tpp_have_lexer_isidentifier))
...
- [`tpp_lexer_manualpopfile_start()`](../src/tpp-amalgamation.h#L28770)
- [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L28772)
- [`tpp_lexer_manualpopfile_canpopfile()`](../src/tpp-amalgamation.h#L28773)
- [`tpp_lexer_manualpopfile_break_rollback()`](../src/tpp-amalgamation.h#L28776)
- [`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L28777)
- [`tpp_lexer_manualpopfile_break()`](../src/tpp-amalgamation.h#L28778)
- [`tpp_lexer_manualpopfile_end_rollback()`](../src/tpp-amalgamation.h#L28782)
- [`tpp_lexer_manualpopfile_end_commit()`](../src/tpp-amalgamation.h#L28785)
- [`tpp_lexer_manualpopfile_end()`](../src/tpp-amalgamation.h#L28788)
...
Provide a function [`tpp_macro_equals()`](../src/tpp-amalgamation.h#L22454) to compare macro definitions.
...
Add an extra field to [`tpp_macro`](../src/tpp-amalgamation.h#L22386) for the [`tpp_keyword`](../src/tpp-amalgamation.h#L23002) describing
...
Provide a function [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15241) to construct the result
...
Provide a function [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15251) to construct what
...
Provide a function [`tpp_intvalue_printrepr()`](../src/tpp-amalgamation.h#L15002) used to implement:

- [`tpp_expr_value_printrepr()`](../src/tpp-amalgamation.h#L15241) (see [`TPP_HAVE_EXPR_VALUE_PRINTREPR`](#tpp_have_expr_value_printrepr))
- [`tpp_expr_value_printstr()`](../src/tpp-amalgamation.h#L15251) (see [`TPP_HAVE_EXPR_VALUE_PRINTSTR`](#tpp_have_expr_value_printstr))
...
Provide a function [`tpp_lexer_dump_definitions()`](../src/tpp-amalgamation.h#L29844) that can be
...
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_SORTED`](../src/tpp-amalgamation.h#L29885) that causes
...
Extension to [`TPP_HAVE_LEXER_DUMP_DEFINITIONS`](#tpp_have_lexer_dump_definitions): provide an
additional flag [`TPP_LEXER_DUMP_DEFINITIONS_EXTRAINFO`](../src/tpp-amalgamation.h#L29890) that causes every
...
Provide a function [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17712) to perform `\`-escaping of arbitrary
data, such that [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28612) and [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29545) will understand
...
Provide a function [`tpp_lexer_require_whitespace()`](../src/tpp-amalgamation.h#L28500) to check if 2 tokens,
...
Provide a function [`tpp_lexer_decodeint_expr()`](../src/tpp-amalgamation.h#L29393) to parse an integer into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15029)
...
Provide a function [`tpp_lexer_parseembed()`](../src/tpp-amalgamation.h#L28907) to quickly parse ,-separated sequences
...
Provide a function [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29382) to parse an integer
...
Provide a function [`tpp_lexer_decodefloat_expr()`](../src/tpp-amalgamation.h#L29420) to parse a float into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15029)
...
Provide a function [`tpp_lexer_decodefloat()`](../src/tpp-amalgamation.h#L29409) to parse a float
...
Provide a function [`tpp_lexer_parsecharacter_literal()`](../src/tpp-amalgamation.h#L29642) to parse character literals
...
Provide a function [`tpp_lexer_parsestring_expr()`](../src/tpp-amalgamation.h#L29661) to parse a string into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15029)
...
Provide a function [`tpp_lexer_parsecharacter_expr()`](../src/tpp-amalgamation.h#L29682) to parse a character literal into a [`tpp_expr_value`](../src/tpp-amalgamation.h#L15029)
...
[`TPP_ENOENT`](../src/tpp-amalgamation.h#L13666) to indicate integer overflow/underflow.
...
Define to `1` if [`tpp_intvalue_asintmax`](../src/tpp-amalgamation.h#L14676) can overflow/underflow.
...
Provide a function [`tpp_ftoa()`](../src/tpp-amalgamation.h#L14064) to convert a float into a string
...
Provide a function [`tpp_extension_nearest()`](../src/tpp-amalgamation.h#L23751) that does fuzzy matching to find
...
Provide a function [`tpp_warning_group_nearest()`](../src/tpp-amalgamation.h#L23853) that does fuzzy matching to find
...
Provide a function [`tpp_keywords_undefalluser()`](../src/tpp-amalgamation.h#L23577) + [`tpp_lexer_undefalluser()`](../src/tpp-amalgamation.h#L28435)
...
Provide a function [`tpp_keywords_unassertall()`](../src/tpp-amalgamation.h#L23588) + [`tpp_lexer_unassertallkwds()`](../src/tpp-amalgamation.h#L28468)
...
Provide a function [`tpp_keywords_resetflags()`](../src/tpp-amalgamation.h#L23599) + [`tpp_lexer_resetallkwdflags()`](../src/tpp-amalgamation.h#L27351)
...
Provide a function [`tpp_keywords_resetfeatures()`](../src/tpp-amalgamation.h#L23610) + [`tpp_lexer_resetallkwdfeatures()`](../src/tpp-amalgamation.h#L27358)
...
Provide a function [`tpp_keywords_resetcounters()`](../src/tpp-amalgamation.h#L23621) +
[`tpp_lexer_resetallkwdcounters()`](../src/tpp-amalgamation.h#L27366) that can be used to
...
Enable support for [`tpp_lexer_openfile_ex()`](../src/tpp-amalgamation.h#L27527)
...
Provide an API [`tpp_preparse_skipspace_fwd()`](../src/tpp-amalgamation.h#L22563) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_preparse_skipspace_bck()`](../src/tpp-amalgamation.h#L22577) that can be used to easily skip an arbitrary
...
Provide an API [`tpp_xml_entity_printnearest()`](../src/tpp-amalgamation.h#L14125) that can be used to
...
Provide an API [`tpp_unicode_byname_printnearest()`](../src/tpp-amalgamation.h#L14154) that can be used to
...
Provide an API [`tpp_decode_named_printnearest()`](../src/tpp-amalgamation.h#L14196) that can be used to
...
Provide a function [`tpp_fuzzy_memcmp()`](../src/tpp-amalgamation.h#L14097) to quantify the
...
Enable support for [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27606), a function that lets you directly
...
Provide an API [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27631) and [`tpp_lexer_pushfile_io()`](../src/tpp-amalgamation.h#L27633)
that can be used to push [`tpp_io_handle`](../src/tpp-amalgamation.h#L14401) onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27647) that can be used to quickly open
...
Provide an API [`tpp_lexer_pushfile_ofr()`](../src/tpp-amalgamation.h#L27659) that can be used to quickly push
a [`tpp_lexer_openfile_result`](../src/tpp-amalgamation.h#L27433) object onto the lexer's `#include`-stack.
...
Provide an API [`tpp_lexer_pushfile_text_ex()`](../src/tpp-amalgamation.h#L27684) that can be used to
quickly push pre-loaded text files onto the lexer's `#include`-stack:

- [`tpp_lexer_pushfile_text()`](../src/tpp-amalgamation.h#L27696)
- [`tpp_lexer_pushfile_text_ascii()`](../src/tpp-amalgamation.h#L27698)
- [`tpp_lexer_pushfile_text_utf8()`](../src/tpp-amalgamation.h#L27701)
...
Provide a function [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28416) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28428)
...
Provide a function [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28446) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28455) + [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28462)
