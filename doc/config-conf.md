...
[`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L29752) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](config-core.md#tpp_have_lexer_isidentifier))
...
affect the behavior of [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L28976)
...
Configures if line-feed tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29173)
...
Configures if whitespace tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29173)
...
Configures if comment tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L29173)
...
Whenenver [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27894) is called and this feature is enabled,
...
- [`tpp_lexer_openfile()`](../src/tpp-amalgamation.h#L27894) will open file `f"{headof(relative_to)}/foo/real/fum.h"`,
...
This affects the behavior of [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L29985) and its
companion [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L30025), such that they will only yield
...
expression handler is specified in [`tpp_lexer_decodestring_config`](../src/tpp-amalgamation.h#L29830),
and one ends up being needed (for one reason or another), use
[`tpp_lexer_callhook_parseexpr()`](../src/tpp-amalgamation.h#L28234) (s.a. [`TPP_HAVE_PARSEEXPR_HOOK`](config-hook.md#tpp_have_parseexpr_hook))
...
When enabled, [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24111) is treated as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L24114) instead
...
Enable support for `0x` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29783) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L16540) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0b` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29783) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L16540) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0o` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L29783) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L16540) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
