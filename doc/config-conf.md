...
[`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L24719) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](config-core.md#tpp_have_lexer_isidentifier))
...
This affects the behavior of [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L24926) and its
companion [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L24966), such that they will only yield
...
When enabled, [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21342) is treated as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L21345) instead
...
Enable support for `0x` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24750) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14377) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0b` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24750) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14377) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0o` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L24750) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14377) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
