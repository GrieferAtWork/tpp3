...
[`tpp_lexer_isidentifier()`](../src/tpp-amalgamation.h#L25417) (see [`TPP_HAVE_LEXER_ISIDENTIFIER`](config-core.md#tpp_have_lexer_isidentifier))
...
affect the behavior of [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24678)
...
Configures if line-feed tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24875)
...
Configures if whitespace tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24875)
...
Configures if comment tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24875)
...
This affects the behavior of [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L25624) and its
companion [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L25664), such that they will only yield
...
Enable support for `0x` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25448) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14638) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0b` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25448) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14638) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0o` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L25448) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L14638) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
