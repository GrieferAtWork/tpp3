...
affect the behavior of [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L20401)
...
Configures if line-feed tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20598)
...
Configures if whitespace tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20598)
...
Configures if comment tokens should be forwarded, or filtered by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L20598)
...
This affects the behavior of [`tpp_lexer_parsestring_ex()`](../src/tpp-amalgamation.h#L21211) and its
companion [`tpp_lexer_parsestring_cb()`](../src/tpp-amalgamation.h#L21251), such that they will only yield
...
Enable support for `0x` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21035) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L11186) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0b` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21035) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L11186) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
...
Enable support for `0o` literals in [`tpp_lexer_decodeint()`](../src/tpp-amalgamation.h#L21035) when parsing [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L11186) (see [`TPP_HAVE_TOK_C_INT`](#tpp_have_tok_c_int))
