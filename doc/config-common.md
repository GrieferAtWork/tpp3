...
of as no-ops should be emitted by [`tpp_lexer_yieldpp()`](../src/tpp-amalgamation.h#L24926)
...
APIs [`tpp_keyword_getfeature()`](../src/tpp-amalgamation.h#L21193) and [`tpp_keyword_setfeature()`](../src/tpp-amalgamation.h#L21203).
