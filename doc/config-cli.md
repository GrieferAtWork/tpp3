...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L29933), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L27417)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28442) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28454)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28472) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28481) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28488)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L27017) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23807). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23807) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23808)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23808) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23810) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23815) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23815)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5991) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L23811), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23808)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30119), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27632)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27673)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27616)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27657)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30119) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30119) (as enabled by
