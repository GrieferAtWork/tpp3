...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L28840), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L27000)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27367) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27379)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27397) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27406) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27413)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26024) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22821). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22821) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22822)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22822) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22824) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22829) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22829)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5877) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22825), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22822)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29026), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27208)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27249)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27193)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27233)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29026) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29026) (as enabled by
