...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L26884), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L25074)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25430) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25438)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25454) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25463) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25470)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L24298) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22048). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22048) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22049)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22049) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22051) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22056) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22056)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22052), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22049)
...
- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25282)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25323)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25268)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25307)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27041) supports a special case when the given
