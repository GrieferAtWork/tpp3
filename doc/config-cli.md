...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L29216), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26732)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27752) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27764)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27782) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27791) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27798)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26388) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23185). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23185) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23186)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23186) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23188) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23193) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23193)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5899) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L23189), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23186)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29402), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26943)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26984)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L26928)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26968)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29402) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29402) (as enabled by
