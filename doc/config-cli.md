...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L27250), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L25417)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25784) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25796)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25814) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25823) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25830)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L24641) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22388). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22388) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22389)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22389) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22391) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22396) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22396)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22392), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22389)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27436), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25625)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25666)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25610)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25650)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27436) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27436) (as enabled by
