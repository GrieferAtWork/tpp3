...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L29456), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26974)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27998) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28010)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28028) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28037) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28044)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29642), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27189)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27230)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27173)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27214)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29642) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29642) (as enabled by
