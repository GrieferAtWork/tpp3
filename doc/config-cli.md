...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L23470) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21604). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21604) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21605)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21605) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21607) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21612) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21612)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L21608), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21605)
