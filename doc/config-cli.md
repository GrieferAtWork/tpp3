...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L29363), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26887)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27907) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27919)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27937) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27946) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27953)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26521) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23311). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23311) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23312)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23312) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23314) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23319) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23319)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5911) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L23315), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23312)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29549), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27098)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27139)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27083)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27123)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29549) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29549) (as enabled by
