...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L25073), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L23244)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L23615) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L23623)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L23639) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L23648) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L23655)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L22732) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21272). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21272) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21273)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21273) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21275) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21280) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21280)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L21276), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21273)
