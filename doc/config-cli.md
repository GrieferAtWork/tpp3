...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L30221), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L27705)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28730) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28742)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28760) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28769) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28776)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L27299) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24089). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24089) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24090)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24090) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24092) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24097) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24097)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5999) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L24093), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24090)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30407), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27920)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27961)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27904)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27945)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30407) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30407) (as enabled by
