...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L29205), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26721)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27741) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27753)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27771) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27780) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27787)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26377) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23174). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L23174) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23175)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23175) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L23177) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23182) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L23182)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5882) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L23178), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L23175)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29391), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26932)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26973)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L26917)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26957)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29391) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29391) (as enabled by
