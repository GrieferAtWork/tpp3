...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L28839), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26999)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27366) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27378)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27396) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27405) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27412)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26023) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22820). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22820) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22821)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22821) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22823) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22828) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22828)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5876) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22824), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22821)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29025), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27207)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27248)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27192)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27232)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29025) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29025) (as enabled by
