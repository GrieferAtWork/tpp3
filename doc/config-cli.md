...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L27320) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24110). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24110) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24111)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24111) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24113) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24118) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24118)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5999) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L24114), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24111)
