...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L24946), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L23117)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L23488) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L23496)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L23512) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L23521) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L23528)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L22605) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21145). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L21145) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21146)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21146) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L21148) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21153) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L21153)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L21149), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L21146)
