...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L30273), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L27720)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L28745) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L28757)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L28775) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L28784) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L28791)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L27314) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24104). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L24104) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24105)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24105) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L24107) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24112) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L24112)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5999) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L24108), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L24105)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30459), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L27935)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27976)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L27919)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27960)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30459) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L30459) (as enabled by
