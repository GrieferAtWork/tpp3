...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L28881), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26388)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27408) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27420)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27438) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27447) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27454)
...
## TPP_HAVE_CLI_DASH_REMAP

`-remap`: Turn on [`TPP_HAVE_INCLUDE_REMAP`](config-conf.md#tpp_have_include_remap) (enable processing of `header.gcc` files...)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L26044) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22841). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22841) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22842)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22842) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22844) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22849) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22849)
...
`-Werror=NAME`:
Configure the specified warning [`NAME`](../src/tpp-amalgamation.h#L5876) as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22845), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22842)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29067), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26599)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L26640)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L26584)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L26624)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29067) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L29067) (as enabled by
