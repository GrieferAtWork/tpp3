...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L28608), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L26775)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L27142) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L27154)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L27172) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L27181) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L27188)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L25799) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22598). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22598) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22599)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22599) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22601) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22606) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22606)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22602), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22599)
...
Enable support for [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L28794), which can be used
to easily implement a high-level wrapper around the different APIs
that exist to load files into the lexer:

- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L26983)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L27024)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L26968)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L27008)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L28794) supports a special case when the given
...
When specified, enable some extra behavior in [`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L28794) (as enabled by
