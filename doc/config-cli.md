...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L26944), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L25132)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25488) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25496)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25512) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25521) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25528)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L24356) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22103). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22103) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22104)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22104) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22106) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22111) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22111)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22107), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22104)
...
- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25340)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25381)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25325)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25365)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27101) supports a special case when the given
