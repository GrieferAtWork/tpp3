...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L26922), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L25112)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25468) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25476)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25492) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25501) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25508)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L24336) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22083). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22083) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22084)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22084) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22086) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22091) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22091)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22087), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22084)
...
- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25320)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25361)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25305)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25345)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27079) supports a special case when the given
