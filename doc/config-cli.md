...
Provide an API surrounding [`tpp_cli_loader`](../src/tpp-amalgamation.h#L26871), which can be used to configure a lexer
...
itself (as per [`tpp_lexer_init()`](../src/tpp-amalgamation.h#L25061)), though whether or not the its initial
...
Implementation makes use of: [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L25417) + [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L25425)
...
Implementation makes use of: [`tpp_lexer_assert()`](../src/tpp-amalgamation.h#L25441) + [`tpp_lexer_unassert()`](../src/tpp-amalgamation.h#L25450) +
                             [`tpp_lexer_unassertall()`](../src/tpp-amalgamation.h#L25457)
...
Requires that [`tpp_lexer_seterrorlimit()`](../src/tpp-amalgamation.h#L24285) be available.
...
When turned off, the warning state is set to [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22035). When turned on,
the warning state is gradually increased from what it's previous state was:

- [`TPP_WSTATE_DISABLED`](../src/tpp-amalgamation.h#L22035) is changed to [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22036)
- [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22036) is changed to [`TPP_WSTATE_ERROR`](../src/tpp-amalgamation.h#L22038) (if [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error)
  is available; else, changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22043) instead)
- [`TPP_HAVE_WARNING_ERROR`](config-core.md#tpp_have_warning_error) is changed to [`TPP_WSTATE_FATAL`](../src/tpp-amalgamation.h#L22043)
...
`-Werror=NAME`:
Configure the specified warning `NAME` as [`TPP_WSTATE_ERROR_OR_FATAL`](../src/tpp-amalgamation.h#L22039), or [`TPP_WSTATE_WARN`](../src/tpp-amalgamation.h#L22036)
...
- [`tpp_lexer_initfile_open()`](../src/tpp-amalgamation.h#L25269)
- [`tpp_lexer_pushfile_open()`](../src/tpp-amalgamation.h#L25310)
- [`tpp_lexer_initfile_io_ex()`](../src/tpp-amalgamation.h#L25254)
- [`tpp_lexer_pushfile_io_ex()`](../src/tpp-amalgamation.h#L25294)
...
[`tpp_cli_loader_setinputs()`](../src/tpp-amalgamation.h#L27028) supports a special case when the given
