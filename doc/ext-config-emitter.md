...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16986) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L15547)-token
...
- [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6592), `0`: Disabled
- [`TPP_CONF_1`](../src/tpp-amalgamation.h#L6591), `1`: Enabled
- [`TPP_CONF_FEAT0`](../src/tpp-amalgamation.h#L6596): Available (disabled by default)
- [`TPP_CONF_FEAT1`](../src/tpp-amalgamation.h#L6595): Available (enabled by default)
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L15546)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L16007)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L15809) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L15887), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28521) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17071), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L15621)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L15605) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20352) flag.
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L16974)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1392)
...
- In order to remember the *most-recently-dumped* macro definition
  ...
  a reference to the [`tpp_macro`](../src/tpp-amalgamation.h#L21491) that was most-recently dumped
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L26481)
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L28822)
