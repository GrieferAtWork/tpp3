...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17659) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L16199)-token
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L16198)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L16680)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L16461) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L16551), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29579) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17744), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L16273)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L16257) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21135) flag.
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L17647)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1400)
...
- In order to remember the *most-recently-dumped* macro definition
  ...
  a reference to the [`tpp_macro`](../src/tpp-amalgamation.h#L22420) that was most-recently dumped
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L27867)
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L29878)
