...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L17942) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L16482)-token
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L16481)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L16963)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L16744) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L16834), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29957) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L18031), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L16556)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L16540) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L21422) flag.
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L17930)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1400)
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L28208)
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L30256)
