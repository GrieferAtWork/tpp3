...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16688) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L15249)-token
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L15248)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L15709)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L15511) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L15589), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L27956) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16773), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L15323)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L15307) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20043) flag.
...
- [`tpp_emitter_get_reemit_unknown_pragma()`](../src/tpp-emitter-amalgamation.h#L1407)
- [`tpp_emitter_set_reemit_unknown_pragma()`](../src/tpp-emitter-amalgamation.h#L1413)
- [`tpp_emitter_enable_reemit_unknown_pragma()`](../src/tpp-emitter-amalgamation.h#L1405)
- [`tpp_emitter_disable_reemit_unknown_pragma()`](../src/tpp-emitter-amalgamation.h#L1406)
...
- [`tpp_emitter_set_reemit_macro_definitions()`](../src/tpp-emitter-amalgamation.h#L1449)
- [`tpp_emitter_enable_reemit_macro_definitions()`](../src/tpp-emitter-amalgamation.h#L1435)
- [`tpp_emitter_disable_reemit_macro_definitions()`](../src/tpp-emitter-amalgamation.h#L1437)
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L16676)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1399)
...
- In order to remember the *most-recently-dumped* macro definition
  ...
  a reference to the [`tpp_macro`](../src/tpp-amalgamation.h#L21182) that was most-recently dumped
...
- [`tpp_emitter_get_reemit_macro_definitions_lazy()`](../src/tpp-emitter-amalgamation.h#L1575)
- [`tpp_emitter_set_reemit_macro_definitions_lazy()`](../src/tpp-emitter-amalgamation.h#L1577)
- [`tpp_emitter_enable_reemit_macro_definitions_lazy()`](../src/tpp-emitter-amalgamation.h#L1571)
- [`tpp_emitter_disable_reemit_macro_definitions_lazy()`](../src/tpp-emitter-amalgamation.h#L1572)
...
- [`tpp_emitter_get_reemit_include_directives()`](../src/tpp-emitter-amalgamation.h#L1463)
- [`tpp_emitter_set_reemit_include_directives()`](../src/tpp-emitter-amalgamation.h#L1469)
- [`tpp_emitter_enable_reemit_include_directives()`](../src/tpp-emitter-amalgamation.h#L1461)
- [`tpp_emitter_disable_reemit_include_directives()`](../src/tpp-emitter-amalgamation.h#L1462)
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L25916)
...
- [`tpp_emitter_get_trace_includes()`](../src/tpp-emitter-amalgamation.h#L1590)
- [`tpp_emitter_set_trace_includes()`](../src/tpp-emitter-amalgamation.h#L1592)
- [`tpp_emitter_enable_trace_includes()`](../src/tpp-emitter-amalgamation.h#L1586)
- [`tpp_emitter_disable_trace_includes()`](../src/tpp-emitter-amalgamation.h#L1587)
...
Enable support for [`tpp_emitter_cli_loader`](../src/tpp-emitter-amalgamation.h#L1621)
...
CLI flush phase (i.e.: when [`tpp_emitter_cli_loader_flush()`](../src/tpp-emitter-amalgamation.h#L1729) is called):
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L28257)
