...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16940) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L15501)-token
...
- [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6595), `0`: Disabled
- [`TPP_CONF_1`](../src/tpp-amalgamation.h#L6594), `1`: Enabled
- [`TPP_CONF_FEAT0`](../src/tpp-amalgamation.h#L6599): Available (disabled by default)
- [`TPP_CONF_FEAT1`](../src/tpp-amalgamation.h#L6598): Available (enabled by default)
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L15500)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L15961)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L15763) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L15841), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L28476) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L17025), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L15575)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L15559) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L20306) flag.
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L16928)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1392)
...
- In order to remember the *most-recently-dumped* macro definition
  ...
  a reference to the [`tpp_macro`](../src/tpp-amalgamation.h#L21445) that was most-recently dumped
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L26433)
...
process's current working directory to a given [`tpp_formatprinter`](../src/tpp-amalgamation.h#L5868).
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L28777)
