...
result of [`tpp_strtokenid()`](../src/tpp-amalgamation.h#L16502) and the canonical keyword name.
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_SPACE`](../src/tpp-amalgamation.h#L15063)-token
...
- [`TPP_CONF_0`](../src/tpp-amalgamation.h#L6405), `0`: Disabled
- [`TPP_CONF_1`](../src/tpp-amalgamation.h#L6404), `1`: Enabled
- [`TPP_CONF_FEAT0`](../src/tpp-amalgamation.h#L6409): Available (disabled by default)
- [`TPP_CONF_FEAT1`](../src/tpp-amalgamation.h#L6408): Available (enabled by default)
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_LF`](../src/tpp-amalgamation.h#L15062)-token is
...
When enabled and in `TPP_EMITTER_MODE_EMIT`-mode, any [`TPP_TOK_ISSTRING`](../src/tpp-amalgamation.h#L15523)-token
is emitted as a [`TPP_TOK_C_STRING`](../src/tpp-amalgamation.h#L15325) (or [`TPP_TOK_C_CHAR`](../src/tpp-amalgamation.h#L15403), when
...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L26710) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L16587), thereby
...
[`TPP_TOK_ISINT`](../src/tpp-amalgamation.h#L15137)-token is emitted as a [`TPP_TOK_C_INT`](../src/tpp-amalgamation.h#L15121) token.
...
- `4`: Same as flag `3`, except for the [`TPP_FILE_FLAGS_EXTERN_C`](../src/tpp-amalgamation.h#L19857) flag.
...
- Whenever a [`TPP_TOK_ISKEYWORD()`](../src/tpp-amalgamation.h#L16490)-token is emitted ([`tpp_emitter_emitcurrent()`](../src/tpp-emitter-amalgamation.h#L1388)
...
- In order to remember the *most-recently-dumped* macro definition
  ...
  a reference to the [`tpp_macro`](../src/tpp-amalgamation.h#L20996) that was most-recently dumped
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L24843)
...
process's current working directory to a given [`tpp_formatprinter`](../src/tpp-amalgamation.h#L5726).
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L27007)
