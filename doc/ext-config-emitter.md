...
use of [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L29911) and [`tpp_token_encodestring()`](../src/tpp-amalgamation.h#L18031), thereby
...
by emitting a line like the following to [`tpp_lexer_gethook_mesgprinter()`](../src/tpp-amalgamation.h#L28162)
...
[`tpp_lexer_dump_definitions(TPP_LEXER_DUMP_DEFINITIONS_BUILTIN_MACROS)`](../src/tpp-amalgamation.h#L30210)
