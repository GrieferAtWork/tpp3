...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L19672) to print warning messages
...
Extra callback invoked by [`tpp_lexer_foreach_include_path()`](../src/tpp-amalgamation.h#L19020) at diffrent
...
Called by [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19432) when an unknown `\`-escape sequence is encountered
...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L19672) just before it's about to return [`TPP_ELEXERROR`](../src/tpp-amalgamation.h#L9190)
This hook can be used to do additional state changes that may be necessary by the
hosting application in order to handle the resulting [`TPP_ELEXERROR`](../src/tpp-amalgamation.h#L9190)
