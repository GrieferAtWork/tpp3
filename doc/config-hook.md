...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L25828) to print warning messages
...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L25828) to handle warning notifications. Can be
...
Information about the just-pushed file can be retrieved by examining [`tpp_lexer_getfile(self)`](../src/tpp-amalgamation.h#L23590)
...
by examining [`tpp_lexer_getfile(self)`](../src/tpp-amalgamation.h#L23590). Note that this hook is called
during the file-pop *commit* phase ([`tpp_lexer_manualpopfile_break_commit()`](../src/tpp-amalgamation.h#L24842))
but is *NOT* called by [`tpp_lexer_manualpopfile_popfile()`](../src/tpp-amalgamation.h#L24837).
...
been populated by [`tpp_lexer_yieldraw_at_include_string_blocking()`](../src/tpp-amalgamation.h#L25013) (and macros
were also already expanded), and the current token is [`TPP_TOK_INCPATH_DQUOTE`](../src/tpp-amalgamation.h#L24982) or
[`TPP_TOK_INCPATH_LANGLE`](../src/tpp-amalgamation.h#L24983).
...
To gain access to the `#include`-string, you must use [`tpp_lexer_decode_include_string_cb()`](../src/tpp-amalgamation.h#L25048)
...
to know what that string says, you can use [`tpp_lexer_decode_include_string_cb()`](../src/tpp-amalgamation.h#L25048) to decode it.
...
Calls to [`tpp_lexer_define()`](../src/tpp-amalgamation.h#L24486) or other related functions will
...
Calls to [`tpp_lexer_undef()`](../src/tpp-amalgamation.h#L24494), [`tpp_keyword_undef()`](../src/tpp-amalgamation.h#L21036), or other
...
Extra callback invoked by [`tpp_lexer_foreach_include_path()`](../src/tpp-amalgamation.h#L25079) at diffrent
...
Extra callback invoked by [`tpp_lexer_foreach_embed_path()`](../src/tpp-amalgamation.h#L25121) at diffrent points
...
Called by [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L25584) when an unknown `\`-escape sequence is encountered
...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L25828) just before it's about to return [`TPP_ELEXERROR`](../src/tpp-amalgamation.h#L12569)
...
Called by [`tpp_lexer_yieldraw()`](../src/tpp-amalgamation.h#L24677) when [`TPP_HAVE_SMART_FLOAT_TOKENS`](config-conf.md#tpp_have_smart_float_tokens) is enabled and
...
loaded yet, though can be loaded using [`tpp_lexer_readchar()`](../src/tpp-amalgamation.h#L24581))
