...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L20239) to print warning messages
...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L20239) to handle warning notifications. Can be
...
Called by [`tpp_lexer_decodestring()`](../src/tpp-amalgamation.h#L19980) when an unknown `\`-escape sequence is encountered
...
Called by [`tpp_lexer_warnf()`](../src/tpp-amalgamation.h#L20239) just before it's about to return [`TPP_ELEXERROR`](../src/tpp-amalgamation.h#L9389)
