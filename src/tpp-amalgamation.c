...
#endif /* !TPP_HAVE_INTEGER_SUFFIX_KIND */
{
	...
	*result = 0;
#if TPP_HAVE_INTEGER_SUFFIX_KIND
	*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_INT;
#endif /* TPP_HAVE_INTEGER_SUFFIX_KIND */
	if (start >= end)
		goto handle_invalid;
	ch = *start++;
	...
	case 'I':
		...
		if (ch == '8') {
			if (start < end)
				goto handle_invalid;
			*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_INT8;
		} else if (ch == '1') {
			if (start >= end)
				goto handle_invalid;
			ch    = *start++;
			...
			if (start < end)
				goto handle_invalid;
			*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_INT16;
		} else if (ch == '3') {
			if (start >= end)
				goto handle_invalid;
			ch    = *start++;
			...
			if (start < end)
				goto handle_invalid;
			*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_INT32;
		} else if (ch == '6') {
			if (start >= end)
				goto handle_invalid;
			ch    = *start++;
			...
			if (start < end)
				goto handle_invalid;
			*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_INT64;
		} else {
			goto handle_invalid;
		}
		return TPP_EOK;
	...
	case 'U': {
		if (start < end && (*start == 'i' || *start == 'I') &&
			...
			if (ch == '8') {
				if (start < end)
					goto handle_invalid;
				*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_UINT8;
			} else if (ch == '1') {
				if (start >= end)
					goto handle_invalid;
				ch    = *start++;
				...
				if (start < end)
					goto handle_invalid;
				*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_UINT16;
			} else if (ch == '3') {
				if (start >= end)
					goto handle_invalid;
				ch    = *start++;
				...
				if (start < end)
					goto handle_invalid;
				*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_UINT32;
			} else if (ch == '6') {
				if (start >= end)
					goto handle_invalid;
				ch    = *start++;
				...
				if (start < end)
					goto handle_invalid;
				*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_UINT64;
			} else {
				goto handle_invalid;
			}
			return TPP_EOK;
	...
	case 'L': {
		...
		case 0:
			tpp_assert(has_u == 1);
			*p_suffix_kind = TPP_INTEGER_SUFFIX_KIND_UNSIGNED;
			break;
		case 1:
			*p_suffix_kind = has_u ? TPP_INTEGER_SUFFIX_KIND_UNSIGNED_LONG
			                       : TPP_INTEGER_SUFFIX_KIND_LONG;
			break;
		case 2:
			*p_suffix_kind = has_u ? TPP_INTEGER_SUFFIX_KIND_UNSIGNED_LONG_LONG
