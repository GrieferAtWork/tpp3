...
#define tpp_seek_rparen_state_curarg_append(self, data, size) \
	(tpp_string_builder_doprint(&(self)->tsrps_curarg_prefix, data, size) >= 0)
...
splitTokens.sort();
local cond = " || ".join(for (local tok: splitTokens) f"TPP_HAVE_TOK_{tokenName(tok)}");
print("#if ", cond);
for (local tok: splitTokens) {
	local name = tokenName(tok);
	print("#if TPP_HAVE_TOK_", tokenName(tok));
...
#if TPP_HAVE_TOK_STAR_LANGLE_MINUS || TPP_HAVE_TOK_MINUS_LANGLE || TPP_HAVE_TOK_MINUS_LANGLE_LANGLE || TPP_HAVE_TOK_MINUS_LANGLE_LANGLE_LANGLE || TPP_HAVE_TOK_MINUS_RANGLE || TPP_HAVE_TOK_MINUS_RANGLE_STAR || TPP_HAVE_TOK_MINUS_RANGLE_RANGLE || TPP_HAVE_TOK_MINUS_RANGLE_RANGLE_RANGLE || TPP_HAVE_TOK_EQUAL_LANGLE || TPP_HAVE_TOK_EQUAL_LANGLE_LANGLE || TPP_HAVE_TOK_EQUAL_LANGLE_LANGLE_LANGLE || TPP_HAVE_TOK_EQUAL_RANGLE || TPP_HAVE_TOK_EQUAL_RANGLE_RANGLE || TPP_HAVE_TOK_EQUAL_RANGLE_RANGLE_RANGLE
