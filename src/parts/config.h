...
local HOOKS = {
...

	{
		...
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_lexer_printf_info *tpp_restrict info, tpp_warning_invokeinfo const *tpp_restrict invokeinfo, tpp_warning_id id, va_list args)", { "cookie", "info", "invokeinfo", "id", "args" },
		"TPP_EOK"
	},
...

	{
		...
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_expr_value *tpp_restrict result)", { "cookie", "result" },
...

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie)", { "cookie" },
		"TPP_ENOENT"
	},

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_keyword *filename_kwd)", { "cookie", "filename_kwd" },
		"TPP_EOK"
	},
...

	{
		...
		"(TPP_HAVE_PROFILE_ALL && TPP_HAVE_INCLUDE_STACK)",
		"", // No builtin default
		"void (TPPCALL *", ")(COOKIE cookie)", { "cookie" },
		"(void)0"
	},

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_hook_include_kind include_kind)", { "cookie", "include_kind" },
		"TPP_EOK"
	},
...

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_keyword *tpp_restrict name, tpp_macro *tpp_restrict macro)", { "cookie", "name", "macro" },
		"TPP_EOK"
	},

	{
		...
		"(TPP_HAVE_PROFILE_ALL && TPP_HAVE_CPP_DEFINE)",
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_keyword *tpp_restrict name)", { "cookie", "name" },
		"TPP_EOK"
	},

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_token_id mode, tpp_string *chunk, tpp_char const *comment_str, tpp_size comment_len)", { "cookie", "mode", "chunk", "comment_str", "comment_len" },
		"TPP_EOK"
	},

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_token_id mode, tpp_hook_system_include_path_when when, tpp_errno (TPPCALL *cb)(void *arg, char const *relative_to tpp_lexer_foreach_include_path_flags__PARAM), void *arg)", { "cookie", "mode", "when", "cb", "arg" },
		"TPP_ENOENT"
	},

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_token_id mode, tpp_hook_system_embed_path_when when, tpp_errno (TPPCALL *cb)(void *arg, char const *relative_to), void *arg)", { "cookie", "mode", "when", "cb", "arg" },
		"TPP_ENOENT"
	},

	{
		...
		"", // No builtin default
		"tpp_ssize (TPPCALL *", ")(COOKIE cookie, tpp_char const **tpp_restrict p_pos, tpp_char const *end, tpp_lexer_decodestring_config const *tpp_restrict config)", { "cookie", "p_pos", "end", "config" },
...

	{
		...
		"", // No builtin default
		"tpp_errno (TPPCALL *", ")(COOKIE cookie, tpp_char const *pos)", { "cookie", "pos" },
		"TPP_ENOENT"
	},
};
