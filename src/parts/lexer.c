...
TPP_STATIC_ASSERT(!TPP_CONF_ISFEAT(TPP_CONF_1));
TPP_STATIC_ASSERT(!TPP_CONF_ISFEAT(TPP_CONF_0));
#if TPP_HAVE_EXTENSIONS
TPP_STATIC_ASSERT(!TPP_CONF_ISFEAT(TPP_CONF_EXT1));
TPP_STATIC_ASSERT(!TPP_CONF_ISFEAT(TPP_CONF_EXT0));
#endif /* TPP_HAVE_EXTENSIONS */
TPP_STATIC_ASSERT(TPP_CONF_ISFEAT(TPP_CONF_FEAT1));
TPP_STATIC_ASSERT(TPP_CONF_ISFEAT(TPP_CONF_FEAT0));

#if TPP_HAVE_EXTENSIONS
TPP_STATIC_ASSERT(!TPP_CONF_ISEXT(TPP_CONF_1));
TPP_STATIC_ASSERT(!TPP_CONF_ISEXT(TPP_CONF_0));
TPP_STATIC_ASSERT(TPP_CONF_ISEXT(TPP_CONF_EXT1));
TPP_STATIC_ASSERT(TPP_CONF_ISEXT(TPP_CONF_EXT0));
TPP_STATIC_ASSERT(!TPP_CONF_ISEXT(TPP_CONF_FEAT1));
TPP_STATIC_ASSERT(!TPP_CONF_ISEXT(TPP_CONF_FEAT0));
#endif /* TPP_HAVE_EXTENSIONS */

TPP_STATIC_ASSERT(TPP_CONF_ISCONST(TPP_CONF_1));
TPP_STATIC_ASSERT(TPP_CONF_ISCONST(TPP_CONF_0));
TPP_STATIC_ASSERT(!TPP_CONF_ISCONST(TPP_CONF_EXT1));
TPP_STATIC_ASSERT(!TPP_CONF_ISCONST(TPP_CONF_EXT0));
TPP_STATIC_ASSERT(!TPP_CONF_ISCONST(TPP_CONF_FEAT1));
TPP_STATIC_ASSERT(!TPP_CONF_ISCONST(TPP_CONF_FEAT0));

TPP_STATIC_ASSERT(!TPP_CONF_ISRT(TPP_CONF_1));
TPP_STATIC_ASSERT(!TPP_CONF_ISRT(TPP_CONF_0));
TPP_STATIC_ASSERT(TPP_CONF_ISRT(TPP_CONF_EXT1));
TPP_STATIC_ASSERT(TPP_CONF_ISRT(TPP_CONF_EXT0));
TPP_STATIC_ASSERT(TPP_CONF_ISRT(TPP_CONF_FEAT1));
TPP_STATIC_ASSERT(TPP_CONF_ISRT(TPP_CONF_FEAT0));
...
#if TPP_HAVE_EUSER
TPP_STATIC_ASSERT(TPP_TOK_ISERR(TPP_TOK_EUSER(0)));
TPP_STATIC_ASSERT(TPP_TOK_ISERR(TPP_TOK_EUSER(999)));
TPP_STATIC_ASSERT(TPP_TOK_ASERR(TPP_TOK_EUSER(0)) == TPP_EUSER(0));
TPP_STATIC_ASSERT(TPP_TOK_ASERR(TPP_TOK_EUSER(999)) == TPP_EUSER(999));
TPP_STATIC_ASSERT(TPP_TOK_ASERR_OR_EOK(TPP_TOK_EUSER(0)) == TPP_EUSER(0));
TPP_STATIC_ASSERT(TPP_TOK_ASERR_OR_EOK(TPP_TOK_EUSER(999)) == TPP_EUSER(999));
TPP_STATIC_ASSERT(TPP_TOK_OFERR(TPP_EUSER(0)) == TPP_TOK_EUSER(0));
TPP_STATIC_ASSERT(TPP_TOK_OFERR(TPP_EUSER(999)) == TPP_TOK_EUSER(999));
TPP_STATIC_ASSERT(TPP_TOK_OFERR_OR_EOF(TPP_EUSER(0)) == TPP_TOK_EUSER(0));
TPP_STATIC_ASSERT(TPP_TOK_OFERR_OR_EOF(TPP_EUSER(999)) == TPP_TOK_EUSER(999));
