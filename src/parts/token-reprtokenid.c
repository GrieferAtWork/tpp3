...
#if (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_SLASH_STAR_COMMENT_STAR_SLASH) || (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_LPAREN_STAR_COMMENT_STAR_RPAREN) || (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_SLASH_SLASH_COMMENT) || (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_POUND_COMMENT) || (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_SLASH_COMMENT) || (TPP_HAVE_TPP_TOK_COMMENTLIKE && TPP_HAVE_TPP_TOK_MINUS_MINUS_COMMENT)
