...
#if (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_C_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_PASCAL_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_HTML_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_CXX_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_SHELL_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_ASM_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_SQL_COMMENT) || (TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_AT_AT_COMMENT)
...
#if TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_ASM_COMMENT
	/* [TPP_TOK_ASM_COMMENT] = */ tpp_offsetof(struct tpp_token_repr_strings_struct, ttr_TPP_TOK_C_COMMENT),
#endif /* TPP_HAVE_TOK_COMMENTLIKE && TPP_HAVE_TOK_ASM_COMMENT */
