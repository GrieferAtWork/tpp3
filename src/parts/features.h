...
#undef TPP_HAVE_FEATURES
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_MACRO_CXX_OPERATOR_NAMES) ||               \
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_RAW_STRING_BSE) ||                         \
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE) ||            \
     TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE) ||           \
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH) ||            \
     TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE) ||       \
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_CPP_FEATURE_MACROS))
...
#if TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE)
	TPP_FEAT_UNICODE_BYNAME_LOOKUP_ICASE,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE)
	TPP_FEAT_UNICODE_BYNAME_LOOKUP_ISPACE,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE) */
...
#if TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH)
	TPP_FEAT_INCLUDE_SYSTEM_INCLUDE_PATH,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE)
	TPP_FEAT_INCLUDE_RELATIVE_TO_CURRENT_FILE,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE) */
...
#if TPP_CONF_IS_FEAT(TPP_HAVE_LEXER_DECODEINT_BINARY_LITERALS)
	TPP_FEAT_LEXER_DECODEINT_BINARY_LITERALS,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_LEXER_DECODEINT_BINARY_LITERALS) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_MACRO_CXX_OPERATOR_NAMES)
#define _tpp_lexer_has_MACRO_CXX_OPERATOR_NAMES(self) TPP_CONF_DEFAULT(TPP_HAVE_MACRO_CXX_OPERATOR_NAMES)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_MACRO_CXX_OPERATOR_NAMES) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_RAW_STRING_BSE)
#define _tpp_lexer_has_RAW_STRING_BSE(self) TPP_CONF_DEFAULT(TPP_HAVE_RAW_STRING_BSE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_RAW_STRING_BSE) */
#if TPP_CONF_IS_CONST(TPP_HAVE_STRING_ESCAPE_E)
#define _tpp_lexer_has_STRING_ESCAPE_E(self) TPP_CONF_DEFAULT(TPP_HAVE_STRING_ESCAPE_E)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_STRING_ESCAPE_E) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_STRING_ESCAPE_UNI_BRACE)
#define _tpp_lexer_has_STRING_ESCAPE_UNI_BRACE(self) TPP_CONF_DEFAULT(TPP_HAVE_STRING_ESCAPE_UNI_BRACE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_STRING_ESCAPE_UNI_BRACE) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE)
#define _tpp_lexer_has_UNICODE_BYNAME_LOOKUP_ICASE(self) TPP_CONF_DEFAULT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ICASE) */
#if TPP_CONF_IS_CONST(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE)
#define _tpp_lexer_has_UNICODE_BYNAME_LOOKUP_ISPACE(self) TPP_CONF_DEFAULT(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_UNICODE_BYNAME_LOOKUP_ISPACE) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH)
#define _tpp_lexer_has_INCLUDE_SYSTEM_INCLUDE_PATH(self) TPP_CONF_DEFAULT(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_INCLUDE_SYSTEM_INCLUDE_PATH) */
#if TPP_CONF_IS_CONST(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE)
#define _tpp_lexer_has_INCLUDE_RELATIVE_TO_CURRENT_FILE(self) TPP_CONF_DEFAULT(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_INCLUDE_RELATIVE_TO_CURRENT_FILE) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_LEXER_DECODEINT_BINARY_LITERALS)
#define _tpp_lexer_has_LEXER_DECODEINT_BINARY_LITERALS(self) TPP_CONF_DEFAULT(TPP_HAVE_LEXER_DECODEINT_BINARY_LITERALS)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_LEXER_DECODEINT_BINARY_LITERALS) */
#if TPP_CONF_IS_CONST(TPP_HAVE_LEXER_DECODEINT_OCTAL_LITERALS)
#define _tpp_lexer_has_LEXER_DECODEINT_OCTAL_LITERALS(self) TPP_CONF_DEFAULT(TPP_HAVE_LEXER_DECODEINT_OCTAL_LITERALS)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_LEXER_DECODEINT_OCTAL_LITERALS) */
#if TPP_CONF_IS_CONST(TPP_HAVE_CPP_FEATURE_MACROS)
#define _tpp_lexer_has_CPP_FEATURE_MACROS(self) TPP_CONF_DEFAULT(TPP_HAVE_CPP_FEATURE_MACROS)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_CPP_FEATURE_MACROS) */
/*[[[end]]]*/
