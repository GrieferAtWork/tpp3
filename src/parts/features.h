...
#undef TPP_HAVE_FEATURES
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE) || \
     ...
     TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_INT) ||                                                 \
     TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_FLOAT) ||                                               \
     TPP_CONF_IS_FEAT(TPP_HAVE_SMART_FLOAT_TOKENS) ||                                            \
     TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_CHAR) ||                                                \
     TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_STRING) ||                                              \
...
typedef enum tpp_feature_id {
	...
	TPP_FEAT_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE,
...
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_INT)
	TPP_FEAT_TPP_TOK_C_INT,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_INT) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_FLOAT)
	TPP_FEAT_TPP_TOK_C_FLOAT,
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_FLOAT) */
...
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_LPAREN_STAR_COMMENT_STAR_RPAREN) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
		unsigned int TPP_INTERNAL(tff_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE): 1;
#define _tpp_lexer_has_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE(self) (self)->TPP_INTERNAL(tl_feat).TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_POUND_COMMENT)
...
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_THOUSANDS_SEPARATOR_SINGLETICK) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_INT)
		unsigned int TPP_INTERNAL(tff_TPP_TOK_C_INT): 1;
#define _tpp_lexer_has_TPP_TOK_C_INT(self) (self)->TPP_INTERNAL(tl_feat).TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_TOK_C_INT)
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_INT) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_FLOAT)
		unsigned int TPP_INTERNAL(tff_TPP_TOK_C_FLOAT): 1;
#define _tpp_lexer_has_TPP_TOK_C_FLOAT(self) (self)->TPP_INTERNAL(tl_feat).TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_TOK_C_FLOAT)
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_FLOAT) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_SMART_FLOAT_TOKENS)
...
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_SMART_FLOAT_TOKENS) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_CHAR)
		unsigned int TPP_INTERNAL(tff_TPP_TOK_C_CHAR): 1;
#define _tpp_lexer_has_TPP_TOK_C_CHAR(self) (self)->TPP_INTERNAL(tl_feat).TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_TOK_C_CHAR)
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_CHAR) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_STRING)
		unsigned int TPP_INTERNAL(tff_TPP_TOK_C_STRING): 1;
#define _tpp_lexer_has_TPP_TOK_C_STRING(self) (self)->TPP_INTERNAL(tl_feat).TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_TOK_C_STRING)
#endif /* TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_C_STRING) */
#if TPP_CONF_IS_FEAT(TPP_HAVE_TPP_TOK_CXX_RAW_STRING_LITERAL)
...
#if TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
#define _tpp_lexer_has_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE(self) TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_INT)
#define _tpp_lexer_has_TPP_TOK_C_INT(self) TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_INT)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_INT) */
#if TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_FLOAT)
#define _tpp_lexer_has_TPP_TOK_C_FLOAT(self) TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_FLOAT)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_FLOAT) */
...
#if TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_CHAR)
#define _tpp_lexer_has_TPP_TOK_C_CHAR(self) TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_CHAR)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_CHAR) */
#if TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_STRING)
#define _tpp_lexer_has_TPP_TOK_C_STRING(self) TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_STRING)
#endif /* TPP_CONF_IS_CONST(TPP_HAVE_TPP_TOK_C_STRING) */
