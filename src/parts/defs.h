 ...
 *    to the following pre-defined functions:
 *       >> tpp_lexer *tpp_current_lexer(void);            // The current lexer
 *       >> tpp_keyword const *tpp_current_keyword(void);  // The current keyword
 *       >> tpp_token_id tpp_current_keyword_id(void);     // The current keyword ID
 *    Example:
...
local BUILTIN_KEYWORDS: {string: string} = {
	...
	"default": "((TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING) && TPP_HAVE_WARNING_DEFAULT) || (TPP_HAVE_PRAGMA_TPP_INCLUDE_PATH && TPP_HAVE_INCLUDE_PATH_AFTER)",
...
@@Stuff declared by `TPP_BUILTIN_MACRO`
...
#if ((TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING) && TPP_HAVE_WARNING_DEFAULT) || (TPP_HAVE_PRAGMA_TPP_INCLUDE_PATH && TPP_HAVE_INCLUDE_PATH_AFTER)
...
#endif /* ((TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING) && TPP_HAVE_WARNING_DEFAULT) || (TPP_HAVE_PRAGMA_TPP_INCLUDE_PATH && TPP_HAVE_INCLUDE_PATH_AFTER) */
#if TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING
...
#endif /* TPP_HAVE_MACRO___TPP_EVAL */
#if TPP_HAVE_MACRO___TPP_EXEC
TPP_MACRO(TPP_KWD___TPP_EXEC, tpp_lexer_has(tpp_current_lexer(), MACRO___TPP_EXEC))
#endif /* TPP_HAVE_MACRO___TPP_EXEC */
#if TPP_HAVE_MACRO___TPP_UNIQUE
