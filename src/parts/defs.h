...
#if TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
#ifndef TPP_EXTNAME_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE
...
#endif /* !TPP_EXTNAME_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE */
#define TPP_EXT_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE TPP_EXT_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE
TPP_EXTENSION(TPP_EXT_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE, TPP_EXTNAME_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE, TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE))
#define _tpp_lexer_has_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE(self) (self)->TPP_INTERNAL(tl_exts).TPP_INTERNAL(te_state).TPP_INTERNAL(tes_flags).TPP_INTERNAL(tef_TPP_EXT_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE)
#endif /* TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_LANGLE_EXCLAIM_MINUS_MINUS_COMMENT_MINUS_MINUS_RANGLE) */
...
#if TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_INT)
#ifndef TPP_EXTNAME_TPP_TOK_C_INT
#define TPP_EXTNAME_TPP_TOK_C_INT "tok-c-int"
#endif /* !TPP_EXTNAME_TPP_TOK_C_INT */
#define TPP_EXT_TPP_TOK_C_INT TPP_EXT_TPP_TOK_C_INT
TPP_EXTENSION(TPP_EXT_TPP_TOK_C_INT, TPP_EXTNAME_TPP_TOK_C_INT, TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_INT))
#define _tpp_lexer_has_TPP_TOK_C_INT(self) (self)->TPP_INTERNAL(tl_exts).TPP_INTERNAL(te_state).TPP_INTERNAL(tes_flags).TPP_INTERNAL(tef_TPP_EXT_TPP_TOK_C_INT)
#endif /* TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_INT) */
#if TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_FLOAT)
#ifndef TPP_EXTNAME_TPP_TOK_C_FLOAT
#define TPP_EXTNAME_TPP_TOK_C_FLOAT "tok-c-float"
#endif /* !TPP_EXTNAME_TPP_TOK_C_FLOAT */
#define TPP_EXT_TPP_TOK_C_FLOAT TPP_EXT_TPP_TOK_C_FLOAT
TPP_EXTENSION(TPP_EXT_TPP_TOK_C_FLOAT, TPP_EXTNAME_TPP_TOK_C_FLOAT, TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_FLOAT))
#define _tpp_lexer_has_TPP_TOK_C_FLOAT(self) (self)->TPP_INTERNAL(tl_exts).TPP_INTERNAL(te_state).TPP_INTERNAL(tes_flags).TPP_INTERNAL(tef_TPP_EXT_TPP_TOK_C_FLOAT)
#endif /* TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_FLOAT) */
...
#if TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_CHAR)
#ifndef TPP_EXTNAME_TPP_TOK_C_CHAR
#define TPP_EXTNAME_TPP_TOK_C_CHAR "tok-char"
#endif /* !TPP_EXTNAME_TPP_TOK_C_CHAR */
#define TPP_EXT_TPP_TOK_C_CHAR TPP_EXT_TPP_TOK_C_CHAR
TPP_EXTENSION(TPP_EXT_TPP_TOK_C_CHAR, TPP_EXTNAME_TPP_TOK_C_CHAR, TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_CHAR))
#define _tpp_lexer_has_TPP_TOK_C_CHAR(self) (self)->TPP_INTERNAL(tl_exts).TPP_INTERNAL(te_state).TPP_INTERNAL(tes_flags).TPP_INTERNAL(tef_TPP_EXT_TPP_TOK_C_CHAR)
#endif /* TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_CHAR) */
#if TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_STRING)
#ifndef TPP_EXTNAME_TPP_TOK_C_STRING
#define TPP_EXTNAME_TPP_TOK_C_STRING "tok-string"
#endif /* !TPP_EXTNAME_TPP_TOK_C_STRING */
#define TPP_EXT_TPP_TOK_C_STRING TPP_EXT_TPP_TOK_C_STRING
TPP_EXTENSION(TPP_EXT_TPP_TOK_C_STRING, TPP_EXTNAME_TPP_TOK_C_STRING, TPP_CONF_DEFAULT(TPP_HAVE_TPP_TOK_C_STRING))
#define _tpp_lexer_has_TPP_TOK_C_STRING(self) (self)->TPP_INTERNAL(tl_exts).TPP_INTERNAL(te_state).TPP_INTERNAL(tes_flags).TPP_INTERNAL(tef_TPP_EXT_TPP_TOK_C_STRING)
#endif /* TPP_CONF_IS_EXT(TPP_HAVE_TPP_TOK_C_STRING) */
