...
Default: `(TPP_PROFILE != TPP_PROFILE_MINIMAL) && (TPP_OS_WINDOWS || TPP_OS_UNIX)`
...
Default: `TPP_HAVE_UNICODE && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_PROFILE != TPP_PROFILE_MINIMAL`
...
Default: `TPP_PROFILE == TPP_PROFILE_ALL`
...
Default: `(TPP_PROFILE != TPP_PROFILE_MINIMAL) && TPP_MAX_INCLUDE_DEPTH != 0`
...
Default: `TPP_HAVE_WARNINGS && TPP_ERROR_LIMIT != 0`
...
Default: `TPP_HAVE_WARNINGS && (TPP_PROFILE == TPP_PROFILE_ALL)`
...
Default: `TPP_HAVE_PRAGMA_WARNING`
...
Default: `TPP_HAVE_PRAGMA_EXTENSION`
...
Default: `TPP_HAVE_PRAGMA_TPP_EXEC`
...
Default: `TPP_HAVE_PRAGMA_TPP_SET_KEYWORD_FLAGS`
...
Default: `TPP_HAVE_PRAGMA && TPP_HAVE_INCLUDE_PATH`
...
Default: `TPP_HAVE_STRING_ALLOW_MULTILINE && TPP_HAVE_WARNINGS`
...
Default: `TPP_HAVE_CPP_INCLUDE || TPP_HAVE_CPP_INCLUDE_NEXT || TPP_HAVE_CPP_IMPORT || TPP_HAVE_CPP_EMBED || TPP_HAVE_MACRO___has_include || TPP_HAVE_MACRO___has_include_next || TPP_HAVE_MACRO___has_embed || TPP_HAVE_PRAGMA_GCC_DEPENDENCY`
...
Default: `TPP_HAVE_LEXER_OPEN_INCLUDE_STRING`
...
Default: `TPP_HAVE_LEXER_OPEN_INCLUDE_STRING || TPP_HAVE_CPP_INCLUDE || TPP_HAVE_CPP_INCLUDE_NEXT || TPP_HAVE_CPP_IMPORT || TPP_HAVE_CPP_EMBED || 1`
...
Default: `TPP_HAVE_LEXER_OPENFILE && (TPP_HAVE_CPP_IMPORT || (TPP_HAVE_CPP_INCLUDE_NEXT || TPP_HAVE_MACRO___has_include_next) || (TPP_HAVE_CPP_INCLUDE && TPP_HAVE_PRAGMA_ONCE))`
...
Default: `(TPP_HAVE_CPP_IMPORT || TPP_HAVE_CPP_INCLUDE || TPP_HAVE_CPP_INCLUDE_NEXT) && TPP_HAVE_CPP_IF_ELSE_ENDIF && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_MACRO___TIME__ || TPP_HAVE_MACRO___DATE__ || TPP_HAVE_MACRO___TIMESTAMP__ || TPP_HAVE_NUMERIC_DATE_MACROS || TPP_HAVE_NUMERIC_TIME_MACROS`
...
Default: `TPP_HAVE_PRAGMA_GCC_SYSTEM_HEADER != 0`
...
Default: `TPP_HAVE_CPP_MACROS || TPP_HAVE_CPP_EMBED || TPP_HAVE_MACRO__Pragma || TPP_HAVE_MACRO___pragma || TPP_HAVE_MACRO___TPP_IDENTIFIER || TPP_HAVE_MACRO___TPP_STR_DECOMPILE || TPP_HAVE_MACRO___TPP_STR_PACK || TPP_HAVE_MACRO___TPP_COUNT_TOKENS || TPP_HAVE_PRAGMA_TPP_EXEC || TPP_HAVE_PRAGMA_TPP_TPP_EXEC`
...
Default: `TPP_HAVE_CPP_DIGIT_LINE`
...
Default: `TPP_PROFILE == TPP_PROFILE_ALL && TPP_HAVE_CPP_DIGIT_LINE`
...
Default: `TPP_HAVE_CPP_MACROS || TPP_HAVE_CPP_INCLUDE || TPP_HAVE_CPP_INCLUDE_NEXT || TPP_HAVE_CPP_IMPORT || TPP_HAVE_CPP_EMBED || TPP_HAVE_FILE_SUBTEXT || TPP_HAVE_FILE_DUMMY`
...
Default: `TPP_HAVE_INCLUDE_STACK`
...
Default: `TPP_HAVE_INCLUDE_STACK && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_INCLUDE_STACK && TPP_HAVE_FILE_SYSHDR && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_INCLUDE_STACK && ((TPP_PROFILE == TPP_PROFILE_ALL) || ((TPP_PROFILE != TPP_PROFILE_MINIMAL) && TPP_HAVE_SEARCH_SYSTEM_INCLUDE_PATH))`
...
Default: `TPP_HAVE_INCLUDE_PATH_PUSH_POP`
...
Default: `TPP_HAVE_CPP_IF_ELSE_ENDIF`
...
Default: `TPP_HAVE_CPP_DIGIT_LINE || TPP_HAVE_CPP_LINE`
...
Default: `TPP_HAVE_CPP_MACROS && TPP_HAVE_LEXER_SEEKPP_RPAREN && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_UNICODE && TPP_HAVE_CPP_EMBED && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_BSE || TPP_HAVE_ESCAPE_IN_IDENTIFIERS`
...
Default: `TPP_PROFILE == TPP_PROFILE_ALL || TPP_HAVE_PRAGMA_GCC_DEPENDENCY`
...
Default: `TPP_OS_WINDOWS && (TPP_HAVE_USER_KEYWORDS || (TPP_PROFILE != TPP_PROFILE_MINIMAL))`
...
Default: `TPP_HAVE_LEXER_OPENFILE`
...
Default: `TPP_HAVE_PRAGMA_PUSH_MACRO || 1`
...
Default: `TPP_HAVE_LEXER_REPRTOKENID`
...
Default: `TPP_HAVE_CPP_MACROS && (TPP_CONF_MAYBE_0(TPP_HAVE_TPP_TOK_SPACE) || TPP_CONF_MAYBE_0(TPP_HAVE_TPP_TOK_LF) || TPP_CONF_MAYBE_0(TPP_HAVE_TPP_TOK_COMMENT))`
...
Default: `TPP_HAVE_CPP_IF_ELSE_ENDIF || TPP_HAVE_CPP_MACROS || TPP_HAVE_BUILTIN_EXPR_DEFINED`
...
Default: `TPP_HAVE_LEXER_SEEKPP_RPAREN && TPP_HAVE_ALTERNATIVE_MACRO_PARENTHESIS`
...
Default: `TPP_HAVE_TPP_W_REDEFINE_MACRO`
...
Default: `TPP_HAVE_TPP_TOK_STRINGLIKE`
...
Default: `TPP_HAVE_LEXER_DECODESTRING && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_MACRO___TPP_EVAL`
...
Default: `TPP_HAVE_BUILTIN_PARSEEXPR_HOOK && TPP_HAVE_TPP_TOK_INT`
...
Default: `TPP_HAVE_TPP_TOK_INT && (TPP_HAVE_LEXER_DECODEINT_EXPR || TPP_HAVE_CPP_LINE || TPP_HAVE_CPP_DIGIT_LINE || TPP_HAVE_MACRO___TPP_STR_PACK || TPP_HAVE_PRAGMA_WARNING || TPP_HAVE_PRAGMA_TPP_WARNING)`
...
Default: `TPP_HAVE_LEXER_DECODEINT_FIXED_TYPE_SUFFIX || TPP_HAVE_LEXER_DECODEINT_SIZE_TYPE_SUFFIX || TPP_HAVE_LEXER_DECODEINT_FIXED_LENGTH_SUFFIX`
...
Default: `TPP_HAVE_BUILTIN_PARSEEXPR_HOOK && TPP_HAVE_BUILTIN_EXPR_FLOATS && TPP_HAVE_TPP_TOK_FLOAT`
...
Default: `TPP_HAVE_LEXER_DECODEFLOAT_EXPR`
...
Default: `TPP_HAVE_LEXER_DECODEFLOAT_FIXED_TYPE_SUFFIX || TPP_HAVE_LEXER_DECODEFLOAT_DOUBLE_TYPE_SUFFIX || TPP_HAVE_LEXER_DECODEFLOAT_DECIMAL_TYPE_SUFFIX`
...
Default: `TPP_HAVE_BUILTIN_EXPR_CHARACTER_LITERALS`
...
Default: `TPP_HAVE_BUILTIN_PARSEEXPR_HOOK && TPP_HAVE_BUILTIN_EXPR_STRINGS && TPP_HAVE_LEXER_DECODESTRING`
...
Default: `TPP_HAVE_BUILTIN_PARSEEXPR_HOOK && TPP_HAVE_BUILTIN_EXPR_CHARACTER_LITERALS && TPP_HAVE_LEXER_DECODESTRING`
...
Default: `TPP_HAVE_EXPR_VALUE_PRINTREPR`
...
Default: `TPP_HAVE_TPP_W_UNKNOWN_EXTENSION && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_TPP_W_UNKNOWN_WARNING && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
...
Default: `TPP_HAVE_TPP_EXTENSION_NEAREST || TPP_HAVE_TPP_WARNING_GROUP_NEAREST`
...
Default: `TPP_HAVE_LEXER_DUMP_DEFINITIONS`
...
Default: `TPP_HAVE_WARNINGS && (TPP_PROFILE != TPP_PROFILE_MINIMAL)`
