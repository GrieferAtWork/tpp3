...
#if TPP_HAVE_BUILTIN_EXPR_FLOATS < 0
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_FLOATS, TPP_EXTNAME_BUILTIN_EXPR_FLOATS, TPP_HAVE_BUILTIN_EXPR_FLOATS == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FLOATS(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_FLOATS
#else /* TPP_HAVE_BUILTIN_EXPR_FLOATS < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FLOATS(self) TPP_HAVE_BUILTIN_EXPR_FLOATS
#endif /* TPP_HAVE_BUILTIN_EXPR_FLOATS >= 0 */
...
#if TPP_HAVE_BUILTIN_EXPR_LOGICAL_XOR < 0
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_LOGICAL_XOR, TPP_EXTNAME_BUILTIN_EXPR_LOGICAL_XOR, TPP_HAVE_BUILTIN_EXPR_LOGICAL_XOR == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_LOGICAL_XOR(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_LOGICAL_XOR
#else /* TPP_HAVE_BUILTIN_EXPR_LOGICAL_XOR < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_LOGICAL_XOR(self) TPP_HAVE_BUILTIN_EXPR_LOGICAL_XOR
#endif /* TPP_HAVE_BUILTIN_EXPR_LOGICAL_XOR >= 0 */
#if TPP_HAVE_BUILTIN_EXPR_BINARY_LITERALS < 0
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_BINARY_LITERALS, TPP_EXTNAME_BUILTIN_EXPR_BINARY_LITERALS, TPP_HAVE_BUILTIN_EXPR_BINARY_LITERALS == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_BINARY_LITERALS(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_BINARY_LITERALS
#else /* TPP_HAVE_BUILTIN_EXPR_BINARY_LITERALS < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_BINARY_LITERALS(self) TPP_HAVE_BUILTIN_EXPR_BINARY_LITERALS
#endif /* TPP_HAVE_BUILTIN_EXPR_BINARY_LITERALS >= 0 */
#if TPP_HAVE_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS < 0
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS, TPP_EXTNAME_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS, TPP_HAVE_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS
#else /* TPP_HAVE_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS(self) TPP_HAVE_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS
#endif /* TPP_HAVE_BUILTIN_EXPR_FIXED_TYPE_INTEGRALS >= 0 */
#if TPP_HAVE_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS < 0
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS, TPP_EXTNAME_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS, TPP_HAVE_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS
#else /* TPP_HAVE_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS(self) TPP_HAVE_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS
#endif /* TPP_HAVE_BUILTIN_EXPR_FIXED_LENGTH_INTEGRALS >= 0 */
...
TPP_EXTENSION(TPP_EXT_BUILTIN_EXPR_CHARACTER_LITERALS, TPP_EXTNAME_BUILTIN_EXPR_CHARACTER_LITERALS, TPP_HAVE_BUILTIN_EXPR_CHARACTER_LITERALS == -1)
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_CHARACTER_LITERALS(self) (self)->tes_flags.tef_TPP_EXT_BUILTIN_EXPR_CHARACTER_LITERALS
#else /* TPP_HAVE_BUILTIN_EXPR_CHARACTER_LITERALS < 0 */
#define _tpp_extensions_state_get_TPP_EXT_BUILTIN_EXPR_CHARACTER_LITERALS(self) TPP_HAVE_BUILTIN_EXPR_CHARACTER_LITERALS
...
#define TPP_HAVE_TPP_TOK_STRING_ALLOW_MULTILINE (-2) /* "TPP_FEAT_TPP_TOK_STRING_ALLOW_MULTILINE" */
...
#define TPP_HAVE_TPP_TOK_MINUS_LANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_MINUS_LANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_MINUS_LANGLE */

/* ">-"
 * @detect: #if __TPP_COUNT_TOKENS(">-") == 1 */
#ifndef TPP_HAVE_TPP_TOK_RANGLE_MINUS
#define TPP_HAVE_TPP_TOK_RANGLE_MINUS TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_RANGLE_MINUS" */
#endif /* !TPP_HAVE_TPP_TOK_RANGLE_MINUS */

/* "<=>"
 * @detect: #if __TPP_COUNT_TOKENS("<=>") == 1 */
#ifndef TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE
#define TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_LANGLE_EQUAL_RANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE */

/* "<->"
 * @detect: #if __TPP_COUNT_TOKENS("<->") == 1 */
#ifndef TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE
#define TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_LANGLE_MINUS_RANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE */

/* ">=<"
 * @detect: #if __TPP_COUNT_TOKENS(">=<") == 1 */
#ifndef TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE
#define TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_RANGLE_EQUAL_LANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE */

/* ">-<"
 * @detect: #if __TPP_COUNT_TOKENS(">-<") == 1 */
#ifndef TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE
#define TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_RANGLE_MINUS_LANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE */

/* "<=<"
 * @detect: #if __TPP_COUNT_TOKENS("<=<") == 1 */
#ifndef TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE
#define TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_LANGLE_EQUAL_LANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE */

/* "<-<"
 * @detect: #if __TPP_COUNT_TOKENS("<-<") == 1 */
#ifndef TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE
#define TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_LANGLE_MINUS_LANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE */

/* ">=>"
 * @detect: #if __TPP_COUNT_TOKENS(">=>") == 1 */
#ifndef TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE
#define TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_RANGLE_EQUAL_RANGLE" */
#endif /* !TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE */

/* ">->"
 * @detect: #if __TPP_COUNT_TOKENS(">->") == 1 */
#ifndef TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE
#define TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE TPP_COMMON_HAVE_TPP_TOK_MISC_TOKENS /* "TPP_FEAT_TPP_TOK_RANGLE_MINUS_RANGLE" */
...
#define TPP_HAVE_CPP_BUILTIN_MACROS (TPP_HAVE_CPP_MACROS != 0) /* "TPP_FEAT_CPP_BUILTIN_MACROS" */
...
#define TPP_HAVE_CLANG_MACRO___has_attribute (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_attribute" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_attribute */

/* Support for clang __has_builtin
 * @detect: #ifdef __has_builtin */
#ifndef TPP_HAVE_CLANG_MACRO___has_builtin
#define TPP_HAVE_CLANG_MACRO___has_builtin (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_builtin" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_builtin */

/* Support for clang __has_cpp_attribute
 * @detect: #ifdef __has_cpp_attribute */
#ifndef TPP_HAVE_CLANG_MACRO___has_cpp_attribute
#define TPP_HAVE_CLANG_MACRO___has_cpp_attribute (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_cpp_attribute" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_cpp_attribute */
...
#define TPP_HAVE_CLANG_MACRO___has_declspec_attribute (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_declspec_attribute" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_declspec_attribute */

/* Support for clang __has_extension
 * @detect: #ifdef __has_extension */
#ifndef TPP_HAVE_CLANG_MACRO___has_extension
#define TPP_HAVE_CLANG_MACRO___has_extension (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_extension" */
...
#define TPP_HAVE_CLANG_MACRO___has_feature (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_feature" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_feature */

/* Support for clang __has_c_attribute
 * @detect: #ifdef __has_c_attribute */
#ifndef TPP_HAVE_CLANG_MACRO___has_c_attribute
#define TPP_HAVE_CLANG_MACRO___has_c_attribute (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fclang-__has_c_attribute" */
#endif /* !TPP_HAVE_CLANG_MACRO___has_c_attribute */
...
#define TPP_HAVE_MACRO___is_identifier (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__is_identifier" */
#endif /* !TPP_HAVE_MACRO___is_identifier */

/* Support for TPP's __is_deprecated
 * @detect: #ifdef __is_deprecated */
#ifndef TPP_HAVE_MACRO___is_deprecated
#define TPP_HAVE_MACRO___is_deprecated (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__is_deprecated" */
#endif /* !TPP_HAVE_MACRO___is_deprecated */

/* Support for TPP's __is_poisoned
 * @detect: #ifdef __is_poisoned */
#ifndef TPP_HAVE_MACRO___is_poisoned
#define TPP_HAVE_MACRO___is_poisoned (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__is_poisoned" */
#endif /* !TPP_HAVE_MACRO___is_poisoned */

/* Support for TPP's __has_extension
 * @detect: #ifdef __has_extension */
#ifndef TPP_HAVE_MACRO___has_extension
#define TPP_HAVE_MACRO___has_extension ((TPP_HAVE_EXTENSIONS && TPP_HAVE_CPP_BUILTIN_MACROS) ? -1 : 0) /* "-f__has_extension" */
...
#define TPP_HAVE_MACRO___has_known_extension ((TPP_HAVE_EXTENSIONS && TPP_HAVE_CPP_BUILTIN_MACROS) ? -1 : 0) /* "-f__has_known_extension" */
#endif /* !TPP_HAVE_MACRO___has_known_extension */

/* Support for TPP's __has_warning
 * @detect: #ifdef __has_warning */
#ifndef TPP_HAVE_MACRO___has_warning
#define TPP_HAVE_MACRO___has_warning ((TPP_HAVE_WARNINGS && TPP_HAVE_CPP_BUILTIN_MACROS) ? -1 : 0) /* "-f__has_warning" */
#endif /* !TPP_HAVE_MACRO___has_warning */

/* Support for TPP's __has_known_warning
 * @detect: #ifdef __has_known_warning */
#ifndef TPP_HAVE_MACRO___has_known_warning
#define TPP_HAVE_MACRO___has_known_warning ((TPP_HAVE_WARNINGS && TPP_HAVE_CPP_BUILTIN_MACROS) ? -1 : 0) /* "-f__has_known_warning" */
#endif /* !TPP_HAVE_MACRO___has_known_warning */

/* Support for clang __has_include
 * @detect: #ifdef __has_include */
#ifndef TPP_HAVE_MACRO___has_include
#define TPP_HAVE_MACRO___has_include ((TPP_HAVE_CPP_BUILTIN_MACROS && (TPP_HAVE_CPP_INCLUDE || TPP_HAVE_CPP_IMPORT)) ? -1 : 0) /* "-f__has_include" */
#endif /* !TPP_HAVE_MACRO___has_include */

/* Support for clang __has_include_next
 * @detect: #ifdef __has_include_next */
#ifndef TPP_HAVE_MACRO___has_include_next
#define TPP_HAVE_MACRO___has_include_next ((TPP_HAVE_CPP_BUILTIN_MACROS && TPP_HAVE_CPP_INCLUDE_NEXT) ? -1 : 0) /* "-f__has_include_next" */
#endif /* !TPP_HAVE_MACRO___has_include_next */

/* Support for clang __has_embed
 * @detect: #ifdef __has_embed */
#ifndef TPP_HAVE_MACRO___has_embed
#define TPP_HAVE_MACRO___has_embed ((TPP_HAVE_CPP_BUILTIN_MACROS && TPP_HAVE_CPP_EMBED) ? -1 : 0) /* "-f__has_embed" */
#endif /* !TPP_HAVE_MACRO___has_embed */

/* __FILE__
 * @detect: #ifdef __FILE__ */
#ifndef TPP_HAVE_MACRO___FILE__
#define TPP_HAVE_MACRO___FILE__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__FILE__" */
#endif /* !TPP_HAVE_MACRO___FILE__ */

/* __LINE__
 * @detect: #ifdef __LINE__ */
#ifndef TPP_HAVE_MACRO___LINE__
#define TPP_HAVE_MACRO___LINE__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__LINE__" */
#endif /* !TPP_HAVE_MACRO___LINE__ */

/* __TIME__
 * @detect: #ifdef __TIME__ */
#ifndef TPP_HAVE_MACRO___TIME__
#define TPP_HAVE_MACRO___TIME__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__TIME__" */
#endif /* !TPP_HAVE_MACRO___TIME__ */

/* __DATE__
 * @detect: #ifdef __DATE__ */
#ifndef TPP_HAVE_MACRO___DATE__
#define TPP_HAVE_MACRO___DATE__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-f__DATE__" */
#endif /* !TPP_HAVE_MACRO___DATE__ */

/* __COLUMN__
 * @detect: #ifdef __COLUMN__ */
#ifndef TPP_HAVE_MACRO___COLUMN__
#define TPP_HAVE_MACRO___COLUMN__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fcolumn-macro" */
#endif /* !TPP_HAVE_MACRO___COLUMN__ */

/* __BASE_FILE__
 * @detect: #ifdef __BASE_FILE__ */
#ifndef TPP_HAVE_MACRO___BASE_FILE__
#define TPP_HAVE_MACRO___BASE_FILE__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fbasefile-macro" */
#endif /* !TPP_HAVE_MACRO___BASE_FILE__ */

/* __INCLUDE_LEVEL__
 * @detect: #ifdef __INCLUDE_LEVEL__ */
#ifndef TPP_HAVE_MACRO___INCLUDE_LEVEL__
#define TPP_HAVE_MACRO___INCLUDE_LEVEL__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-finclude-level-macro" */
#endif /* !TPP_HAVE_MACRO___INCLUDE_LEVEL__ */

/* __INCLUDE_DEPTH__
 * @detect: #ifdef __INCLUDE_DEPTH__ */
#ifndef TPP_HAVE_MACRO___INCLUDE_DEPTH__
#define TPP_HAVE_MACRO___INCLUDE_DEPTH__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-finclude-depth-macro" */
#endif /* !TPP_HAVE_MACRO___INCLUDE_DEPTH__ */

/* __COUNTER__
 * @detect: #ifdef __COUNTER__ */
#ifndef TPP_HAVE_MACRO___COUNTER__
#define TPP_HAVE_MACRO___COUNTER__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fcounter-macro" */
#endif /* !TPP_HAVE_MACRO___COUNTER__ */

/* __TIMESTAMP__
 * @detect: #ifdef __TIMESTAMP__ */
#ifndef TPP_HAVE_MACRO___TIMESTAMP__
#define TPP_HAVE_MACRO___TIMESTAMP__ (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftimestamp-macro" */
#endif /* !TPP_HAVE_MACRO___TIMESTAMP__ */
...
#define TPP_HAVE_NUMERIC_DATE_MACROS (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fnumeric-date-macros" */
#endif /* !TPP_HAVE_NUMERIC_DATE_MACROS */

/* __TIME_SEC__, __TIME_MIN__, __TIME_HOUR__
 * @detect: #ifdef __TIME_SEC__, ... */
#ifndef TPP_HAVE_NUMERIC_TIME_MACROS
#define TPP_HAVE_NUMERIC_TIME_MACROS (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-fnumeric-time-macros" */
#endif /* !TPP_HAVE_NUMERIC_TIME_MACROS */

/* __TPP_EVAL
 * @detect: #ifdef __TPP_EVAL */
#ifndef TPP_HAVE_MACRO___TPP_EVAL
#define TPP_HAVE_MACRO___TPP_EVAL (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-eval-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_EVAL */

/* __TPP_UNIQUE
 * @detect: #ifdef __TPP_UNIQUE */
#ifndef TPP_HAVE_MACRO___TPP_UNIQUE
#define TPP_HAVE_MACRO___TPP_UNIQUE (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-unique-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_UNIQUE */

/* __TPP_LOAD_FILE
 * @detect: #ifdef __TPP_LOAD_FILE */
#ifndef TPP_HAVE_MACRO___TPP_LOAD_FILE
#define TPP_HAVE_MACRO___TPP_LOAD_FILE (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-load-file-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_LOAD_FILE */

/* __TPP_COUNTER
 * @detect: #ifdef __TPP_COUNTER */
#ifndef TPP_HAVE_MACRO___TPP_COUNTER
#define TPP_HAVE_MACRO___TPP_COUNTER (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-counter-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_COUNTER */

/* __TPP_RANDOM
 * @detect: #ifdef __TPP_RANDOM */
#ifndef TPP_HAVE_MACRO___TPP_RANDOM
#define TPP_HAVE_MACRO___TPP_RANDOM (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-random-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_RANDOM */

/* __TPP_STR_DECOMPILE
 * @detect: #ifdef __TPP_STR_DECOMPILE */
#ifndef TPP_HAVE_MACRO___TPP_STR_DECOMPILE
#define TPP_HAVE_MACRO___TPP_STR_DECOMPILE (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-str-decompile-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_STR_DECOMPILE */

/* __TPP_STR_SUBSTR
 * @detect: #ifdef __TPP_STR_SUBSTR */
#ifndef TPP_HAVE_MACRO___TPP_STR_SUBSTR
#define TPP_HAVE_MACRO___TPP_STR_SUBSTR (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-str-substr-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_STR_SUBSTR */

/* __TPP_STR_PACK
 * @detect: #ifdef __TPP_STR_PACK */
#ifndef TPP_HAVE_MACRO___TPP_STR_PACK
#define TPP_HAVE_MACRO___TPP_STR_PACK (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-str-pack-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_STR_PACK */

/* __TPP_STR_SIZE
 * @detect: #ifdef __TPP_STR_SIZE */
#ifndef TPP_HAVE_MACRO___TPP_STR_SIZE
#define TPP_HAVE_MACRO___TPP_STR_SIZE (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-str-size-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_STR_SIZE */

/* __TPP_COUNT_TOKENS
 * @detect: #ifdef __TPP_COUNT_TOKENS */
#ifndef TPP_HAVE_MACRO___TPP_COUNT_TOKENS
#define TPP_HAVE_MACRO___TPP_COUNT_TOKENS (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-count-tokens-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_COUNT_TOKENS */

/* __TPP_IDENTIFIER
 * @detect: #ifdef __TPP_IDENTIFIER */
#ifndef TPP_HAVE_MACRO___TPP_IDENTIFIER
#define TPP_HAVE_MACRO___TPP_IDENTIFIER (TPP_HAVE_CPP_BUILTIN_MACROS ? -1 : 0) /* "-ftpp-identifier-macro" */
#endif /* !TPP_HAVE_MACRO___TPP_IDENTIFIER */
...
#undef TPP_HAVE_FEATURES
     ...
     (TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL < 0) ||       \
     (TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL < 0) ||      \
     (TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL < 0) ||      \
     (TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL < 0) ||     \
     (TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL < 0) ||     \
     ...
     (TPP_HAVE_TPP_TOK_MINUS_LANGLE < 0) ||               \
     (TPP_HAVE_TPP_TOK_RANGLE_MINUS < 0) ||               \
     (TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE < 0) ||        \
     (TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE < 0) ||        \
...
#endif /* TPP_HAVE_TPP_TOK_CXX_UTF32_STRING_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_RAW_CHAR_LITERAL): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_RAW_CHAR_LITERAL(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_RAW_CHAR_LITERAL), TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL == -1)
#else /* TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_RAW_CHAR_LITERAL(self) TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL
#endif /* TPP_HAVE_TPP_TOK_CXX_RAW_CHAR_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_WIDE_CHAR_LITERAL): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_WIDE_CHAR_LITERAL(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_WIDE_CHAR_LITERAL), TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL == -1)
#else /* TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_WIDE_CHAR_LITERAL(self) TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL
#endif /* TPP_HAVE_TPP_TOK_CXX_WIDE_CHAR_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF8_CHAR_LITERAL): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF8_CHAR_LITERAL(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF8_CHAR_LITERAL), TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL == -1)
#else /* TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF8_CHAR_LITERAL(self) TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL
#endif /* TPP_HAVE_TPP_TOK_CXX_UTF8_CHAR_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF16_CHAR_LITERAL): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF16_CHAR_LITERAL(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF16_CHAR_LITERAL), TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL == -1)
#else /* TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF16_CHAR_LITERAL(self) TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL
#endif /* TPP_HAVE_TPP_TOK_CXX_UTF16_CHAR_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF32_CHAR_LITERAL): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF32_CHAR_LITERAL(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_CXX_UTF32_CHAR_LITERAL), TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL == -1)
#else /* TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_CXX_UTF32_CHAR_LITERAL(self) TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL
#endif /* TPP_HAVE_TPP_TOK_CXX_UTF32_CHAR_LITERAL >= 0 */
#if TPP_HAVE_TPP_TOK_RAW_STRING_LITERAL < 0
...
#endif /* TPP_HAVE_TPP_TOK_STAR_DOT >= 0 */
#if TPP_HAVE_TPP_TOK_MINUS_LANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_MINUS_LANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_MINUS_LANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_MINUS_LANGLE), TPP_HAVE_TPP_TOK_MINUS_LANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_MINUS_LANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_MINUS_LANGLE(self) TPP_HAVE_TPP_TOK_MINUS_LANGLE
#endif /* TPP_HAVE_TPP_TOK_MINUS_LANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_RANGLE_MINUS < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS), TPP_HAVE_TPP_TOK_RANGLE_MINUS == -1)
#else /* TPP_HAVE_TPP_TOK_RANGLE_MINUS < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS(self) TPP_HAVE_TPP_TOK_RANGLE_MINUS
#endif /* TPP_HAVE_TPP_TOK_RANGLE_MINUS >= 0 */
#if TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_RANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_RANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_RANGLE), TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_RANGLE(self) TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE
#endif /* TPP_HAVE_TPP_TOK_LANGLE_EQUAL_RANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_MINUS_RANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_MINUS_RANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_MINUS_RANGLE), TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_MINUS_RANGLE(self) TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE
#endif /* TPP_HAVE_TPP_TOK_LANGLE_MINUS_RANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_LANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_LANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_LANGLE), TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_LANGLE(self) TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE
#endif /* TPP_HAVE_TPP_TOK_RANGLE_EQUAL_LANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS_LANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS_LANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS_LANGLE), TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS_LANGLE(self) TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE
#endif /* TPP_HAVE_TPP_TOK_RANGLE_MINUS_LANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_LANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_LANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_LANGLE), TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_EQUAL_LANGLE(self) TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE
#endif /* TPP_HAVE_TPP_TOK_LANGLE_EQUAL_LANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_MINUS_LANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_MINUS_LANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_LANGLE_MINUS_LANGLE), TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_LANGLE_MINUS_LANGLE(self) TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE
#endif /* TPP_HAVE_TPP_TOK_LANGLE_MINUS_LANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_RANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_RANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_RANGLE), TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_EQUAL_RANGLE(self) TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE
#endif /* TPP_HAVE_TPP_TOK_RANGLE_EQUAL_RANGLE >= 0 */
#if TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE < 0
		unsigned int TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS_RANGLE): 1;
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS_RANGLE(self) tpp_expect((self)->TPP_INTERNAL(tf_flags).TPP_INTERNAL(tff_TPP_FEAT_TPP_TOK_RANGLE_MINUS_RANGLE), TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE == -1)
#else /* TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE < 0 */
#define _tpp_features_get_TPP_FEAT_TPP_TOK_RANGLE_MINUS_RANGLE(self) TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE
#endif /* TPP_HAVE_TPP_TOK_RANGLE_MINUS_RANGLE >= 0 */
#if TPP_HAVE_CPP_DIRECTIVES < 0
