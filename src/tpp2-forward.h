...
rename("W_INVALID_INTEGER", "TPP_W_INVALID_INTEGER");
]]]*/
...
#define TPP_W_INVALID_INTEGER TPP_FORWARD_COMPAT(W_INVALID_INTEGER)
/*[[[end]]]*/
...
#define tpp_lexer_getkeyword(self, kwd, len)              ((tpp_keyword const *)TPPLexer_LookupKeyword_(self, (char const *)(kwd), len, 0))
#define tpp_lexer_getkeyword_ex(self, kwd, len, hash)     ((tpp_keyword const *)TPPLexer_LookupKeyword_(self, (char const *)(kwd), len, 0))
#define tpp_lexer_newkeyword(self, kwd, len)              ((tpp_keyword const *)TPPLexer_LookupKeyword_(self, (char const *)(kwd), len, 1))
#define tpp_lexer_newkeyword_ex(self, kwd, len, hash)     ((tpp_keyword const *)TPPLexer_LookupKeyword_(self, (char const *)(kwd), len, 1))
#define tpp_lexer_getkeyword_esc(self, kwd, len)          ((tpp_keyword const *)TPPLexer_LookupEscapedKeyword_(self, (char const *)(kwd), len, 0))
#define tpp_lexer_getkeyword_esc_ex(self, kwd, len, hash) ((tpp_keyword const *)TPPLexer_LookupEscapedKeyword_(self, (char const *)(kwd), len, 0))
#define tpp_lexer_newkeyword_esc(self, kwd, len)          ((tpp_keyword const *)TPPLexer_LookupEscapedKeyword_(self, (char const *)(kwd), len, 1))
#define tpp_lexer_newkeyword_esc_ex(self, kwd, len, hash) ((tpp_keyword const *)TPPLexer_LookupEscapedKeyword_(self, (char const *)(kwd), len, 1))
...
#define tpp_lexer_getkeyword(self, kwd, len)              ((void)(self), (tpp_keyword const *)TPPLexer_LookupKeyword((char const *)(kwd), len, 0))
#define tpp_lexer_getkeyword_ex(self, kwd, len, hash)     ((void)(self), (tpp_keyword const *)TPPLexer_LookupKeyword((char const *)(kwd), len, 0))
#define tpp_lexer_newkeyword(self, kwd, len)              ((void)(self), (tpp_keyword const *)TPPLexer_LookupKeyword((char const *)(kwd), len, 1))
#define tpp_lexer_newkeyword_ex(self, kwd, len, hash)     ((void)(self), (tpp_keyword const *)TPPLexer_LookupKeyword((char const *)(kwd), len, 1))
#define tpp_lexer_getkeyword_esc(self, kwd, len)          ((void)(self), (tpp_keyword const *)TPPLexer_LookupEscapedKeyword((char const *)(kwd), len, 0))
#define tpp_lexer_getkeyword_esc_ex(self, kwd, len, hash) ((void)(self), (tpp_keyword const *)TPPLexer_LookupEscapedKeyword((char const *)(kwd), len, 0))
#define tpp_lexer_newkeyword_esc(self, kwd, len)          ((void)(self), (tpp_keyword const *)TPPLexer_LookupEscapedKeyword((char const *)(kwd), len, 1))
#define tpp_lexer_newkeyword_esc_ex(self, kwd, len, hash) ((void)(self), (tpp_keyword const *)TPPLexer_LookupEscapedKeyword((char const *)(kwd), len, 1))
