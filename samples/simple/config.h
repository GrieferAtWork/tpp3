...
#define TPP_HAVE_TOK_LF 0
#define TPP_HAVE_TOK_SPACE 0
#define TPP_HAVE_TOK_COMMENT 0
#define TPP_HAVE_TOK_INT 1
#define TPP_HAVE_TOK_FLOAT 1
#define TPP_HAVE_TOK_CHAR 1
#define TPP_HAVE_TOK_STRING 1
#define TPP_HAVE_TOK_CXX_RAW_STRING_LITERAL 1
#define TPP_HAVE_TOK_CXX_WIDE_STRING_LITERAL 1
#define TPP_HAVE_TOK_CXX_UTF8_STRING_LITERAL 1
#define TPP_HAVE_TOK_CXX_UTF16_STRING_LITERAL 1
#define TPP_HAVE_TOK_CXX_UTF32_STRING_LITERAL 1
#define TPP_HAVE_TOK_RAW_STRING_LITERAL 1
#define TPP_HAVE_TOK_RAW_CHAR_LITERAL 1
#define TPP_HAVE_TOK_BLOCK_STRING_LITERAL 1
#define TPP_HAVE_TOK_BLOCK_CHAR_LITERAL 1
...
#define TPP_HAVE_TOK_SLASH_SLASH 1
#define TPP_HAVE_TOK_SLASH_SLASH_EQUAL 1
#define TPP_HAVE_TOK_STAR_STAR_EQUAL 1
#define TPP_HAVE_TOK_AT_EQUAL 1
#define TPP_HAVE_TOK_POUND_POUND 1
#define TPP_HAVE_TOK_AMP_AMP 1
#define TPP_HAVE_TOK_PIPE_PIPE 1
#define TPP_HAVE_TOK_HAT_HAT 1
#define TPP_HAVE_TOK_PLUS_PLUS 1
#define TPP_HAVE_TOK_MINUS_MINUS 1
#define TPP_HAVE_TOK_STAR_STAR 1
#define TPP_HAVE_TOK_TILDE_TILDE 1
#define TPP_HAVE_TOK_TILDE_EQUAL 1
#define TPP_HAVE_TOK_MINUS_RANGLE 1
#define TPP_HAVE_TOK_COLON_EQUAL 1
#define TPP_HAVE_TOK_COLON_COLON 1
#define TPP_HAVE_TOK_MINUS_RANGLE_STAR 1
#define TPP_HAVE_TOK_DOT_STAR 1
#define TPP_HAVE_TOK_DOT_DOT 1
#define TPP_HAVE_TOK_LANGLE_RANGLE 1
